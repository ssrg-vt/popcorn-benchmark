...
.text	: ALIGN(0x100000)
{
	...
	"basic_aarch64.o"(.text.func2); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .text.func1 */
	"basic_aarch64.o"(.text.func1); /* size 0xdc */
	. = ALIGN(0x10); /* align for .text.main */
	"basic_aarch64.o"(.text.main); /* size 0xf4 */
...
.rodata	: ALIGN(0x100000)
{
	...
	"basic_aarch64.o"(.rodata.basic__str___iter__d_); /* size 0x26 */
	. = ALIGN(0x4); /* align for .rodata.basic___func___func2_func2_ */
	"basic_aarch64.o"(.rodata.basic___func___func2_func2_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_1_local_ */
	"basic_aarch64.o"(.rodata.basic__str_1_local_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_2_remote_ */
	"basic_aarch64.o"(.rodata.basic__str_2_remote_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_3__iter__d__ */
	"basic_aarch64.o"(.rodata.basic__str_3__iter__d__); /* size 0x31 */
	. = ALIGN(0x4); /* align for .rodata.basic___func___func1_func1_ */
	"basic_aarch64.o"(.rodata.basic___func___func1_func1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_4_Thread_id_ */
	"basic_aarch64.o"(.rodata.basic__str_4_Thread_id_); /* size 0x60 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_5_Migrated_b */
	"basic_aarch64.o"(.rodata.basic__str_5_Migrated_b); /* size 0x39 */
...
.bss	: ALIGN(0x100000)
{
	...
	"basic_aarch64.o"(.bss.ret); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.tid_main */
	"basic_aarch64.o"(.bss.tid_main); /* size 0x4 */
