...
.text	: ALIGN(0x100000)
{
	...
	. = ALIGN(0x10); /* align for .text.func2 */
	"basic_x86_64.o"(.text.func2); /* size 0xa5 */
	. = . + 0x23; /* padding after .text.func2 */
	. = ALIGN(0x10); /* align for .text.func1 */
	"basic_x86_64.o"(.text.func1); /* size 0xb9 */
	. = . + 0x23; /* padding after .text.func1 */
	. = ALIGN(0x10); /* align for .text.main */
	"basic_x86_64.o"(.text.main); /* size 0xd4 */
	...
	. = . + 0x3; /* padding before .text.array_copy */
...
.rodata	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x4); /* align for .rodata.basic__str___iter__d_ */
	"basic_x86_64.o"(.rodata.basic__str___iter__d_); /* size 0x26 */
	. = ALIGN(0x4); /* align for .rodata.basic___func___func2_func2_ */
	"basic_x86_64.o"(.rodata.basic___func___func2_func2_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_1_local_ */
	"basic_x86_64.o"(.rodata.basic__str_1_local_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_2_remote_ */
	"basic_x86_64.o"(.rodata.basic__str_2_remote_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_3__iter__d__ */
	"basic_x86_64.o"(.rodata.basic__str_3__iter__d__); /* size 0x31 */
	. = ALIGN(0x4); /* align for .rodata.basic___func___func1_func1_ */
	"basic_x86_64.o"(.rodata.basic___func___func1_func1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_4_Thread_id_ */
	"basic_x86_64.o"(.rodata.basic__str_4_Thread_id_); /* size 0x60 */
	. = ALIGN(0x4); /* align for .rodata.basic__str_5_Migrated_b */
	"basic_x86_64.o"(.rodata.basic__str_5_Migrated_b); /* size 0x39 */
...
.bss	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x8); /* align for .bss.ret */
	"basic_x86_64.o"(.bss.ret); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.tid_main */
	"basic_x86_64.o"(.bss.tid_main); /* size 0x4 */
