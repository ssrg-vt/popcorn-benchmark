...
.text	: ALIGN(0x100000)
{
	...
	"adc_aarch64.o"(.text.swap4); /* size 0x90 */
	. = ALIGN(0x10); /* align for .text.swap8 */
	"adc_aarch64.o"(.text.swap8); /* size 0xd8 */
	. = ALIGN(0x10); /* align for .text.initADCpar */
	"adc_aarch64.o"(.text.initADCpar); /* size 0x90 */
	. = ALIGN(0x10); /* align for .text.ShowFactorization */
	"adc_aarch64.o"(.text.ShowFactorization); /* size 0x194 */
	. = ALIGN(0x10); /* align for .text.ListFirstPrimes */
	"adc_aarch64.o"(.text.ListFirstPrimes); /* size 0x18c */
	. = . + 0x25; /* padding after .text.ListFirstPrimes */
	. = ALIGN(0x10); /* align for .text.GetLCM */
	"adc_aarch64.o"(.text.GetLCM); /* size 0x3a0 */
	. = ALIGN(0x10); /* align for .text.ExtendFactors */
	"adc_aarch64.o"(.text.ExtendFactors); /* size 0x258 */
	. = ALIGN(0x10); /* align for .text.GetFactorization */
	"adc_aarch64.o"(.text.GetFactorization); /* size 0x43c */
	. = . + 0x4f; /* padding after .text.GetFactorization */
	. = ALIGN(0x10); /* align for .text.CompareSizesByValue */
	"adc_aarch64.o"(.text.CompareSizesByValue); /* size 0xbc */
	. = ALIGN(0x10); /* align for .text.CompareViewsBySize */
	"adc_aarch64.o"(.text.CompareViewsBySize); /* size 0x110 */
	. = ALIGN(0x10); /* align for .text.CalculateVeiwSizes */
	"adc_aarch64.o"(.text.CalculateVeiwSizes); /* size 0x640 */
	. = . + 0x127; /* padding after .text.CalculateVeiwSizes */
	. = ALIGN(0x10); /* align for .text.ParseParFile */
	"adc_aarch64.o"(.text.ParseParFile); /* size 0x3f8 */
	. = . + 0xf3; /* padding after .text.ParseParFile */
	. = ALIGN(0x10); /* align for .text.WriteADCPar */
	"adc_aarch64.o"(.text.WriteADCPar); /* size 0x1a4 */
	. = ALIGN(0x10); /* align for .text.ShowADCPar */
	"adc_aarch64.o"(.text.ShowADCPar); /* size 0x134 */
	. = ALIGN(0x10); /* align for .text.GetNextTuple */
	"adc_aarch64.o"(.text.GetNextTuple); /* size 0x47c */
	. = ALIGN(0x10); /* align for .text.GenerateADC */
	"adc_aarch64.o"(.text.GenerateADC); /* size 0x348 */
	...
	"dc_aarch64.o"(.text.main); /* size 0x48c */
	. = . + 0x11; /* padding after .text.main */
	. = ALIGN(0x10); /* align for .text.DC */
	"dc_aarch64.o"(.text.DC); /* size 0x568 */
	. = . + 0x1f; /* padding after .text.DC */
	. = ALIGN(0x10); /* align for .text.Verify */
	"dc_aarch64.o"(.text.Verify); /* size 0x168 */
	. = . + 0xa; /* padding after .text.Verify */
	. = ALIGN(0x10); /* align for .text.ReadWholeInputData */
	"extbuild_aarch64.o"(.text.ReadWholeInputData); /* size 0x17c */
	. = ALIGN(0x10); /* align for .text.ComputeMemoryFittedView */
	"extbuild_aarch64.o"(.text.ComputeMemoryFittedView); /* size 0x22c */
	. = . + 0x4f; /* padding after .text.ComputeMemoryFittedView */
	. = ALIGN(0x10); /* align for .text.SelectToView */
	"extbuild_aarch64.o"(.text.SelectToView); /* size 0xfc */
	. = ALIGN(0x10); /* align for .text.SharedSortAggregate */
	"extbuild_aarch64.o"(.text.SharedSortAggregate); /* size 0x93c */
	. = . + 0x19e; /* padding after .text.SharedSortAggregate */
	. = ALIGN(0x10); /* align for .text.MultiWayMerge */
	"extbuild_aarch64.o"(.text.MultiWayMerge); /* size 0x818 */
	. = . + 0x164; /* padding after .text.MultiWayMerge */
	. = ALIGN(0x10); /* align for .text.PrefixedAggregate */
	"extbuild_aarch64.o"(.text.PrefixedAggregate); /* size 0x5bc */
	. = . + 0xb0; /* padding after .text.PrefixedAggregate */
	. = ALIGN(0x10); /* align for .text.RunFormation */
	"extbuild_aarch64.o"(.text.RunFormation); /* size 0x374 */
	. = . + 0x74; /* padding after .text.RunFormation */
	. = ALIGN(0x10); /* align for .text.SeekAndReadNextSubChunk */
	"extbuild_aarch64.o"(.text.SeekAndReadNextSubChunk); /* size 0xf4 */
	. = ALIGN(0x10); /* align for .text.ReadSubChunk */
	"extbuild_aarch64.o"(.text.ReadSubChunk); /* size 0x250 */
	. = ALIGN(0x10); /* align for .text.AdcFileOpen */
	"extbuild_aarch64.o"(.text.AdcFileOpen); /* size 0xa8 */
	. = ALIGN(0x10); /* align for .text.AdcFileName */
	"extbuild_aarch64.o"(.text.AdcFileName); /* size 0x8c */
	. = ALIGN(0x10); /* align for .text.NewAdcViewCntl */
	"extbuild_aarch64.o"(.text.NewAdcViewCntl); /* size 0x900 */
	. = . + 0x141; /* padding after .text.NewAdcViewCntl */
	. = ALIGN(0x10); /* align for .text.InitAdcViewCntl */
	"extbuild_aarch64.o"(.text.InitAdcViewCntl); /* size 0x1c4 */
	. = . + 0x23; /* padding after .text.InitAdcViewCntl */
	. = ALIGN(0x10); /* align for .text.CloseAdcView */
	"extbuild_aarch64.o"(.text.CloseAdcView); /* size 0x274 */
	. = . + 0xad; /* padding after .text.CloseAdcView */
	. = ALIGN(0x10); /* align for .text.AdcCntlLog */
	"extbuild_aarch64.o"(.text.AdcCntlLog); /* size 0x110 */
	. = ALIGN(0x10); /* align for .text.ViewSizesVerification */
	"extbuild_aarch64.o"(.text.ViewSizesVerification); /* size 0x3d0 */
	. = . + 0xb2; /* padding after .text.ViewSizesVerification */
	. = ALIGN(0x10); /* align for .text.ComputeGivenGroupbys */
	"extbuild_aarch64.o"(.text.ComputeGivenGroupbys); /* size 0x3f4 */
	. = . + 0x41; /* padding after .text.ComputeGivenGroupbys */
	. = ALIGN(0x10); /* align for .text.SetOneBit */
	"jobcntl_aarch64.o"(.text.SetOneBit); /* size 0x74 */
	. = ALIGN(0x10); /* align for .text.SetOneBit32 */
	"jobcntl_aarch64.o"(.text.SetOneBit32); /* size 0x74 */
	. = ALIGN(0x10); /* align for .text.Mlo32 */
	"jobcntl_aarch64.o"(.text.Mlo32); /* size 0xb0 */
	. = ALIGN(0x10); /* align for .text.mro32 */
	"jobcntl_aarch64.o"(.text.mro32); /* size 0xb4 */
	. = ALIGN(0x10); /* align for .text.setLeadingOnes32 */
	"jobcntl_aarch64.o"(.text.setLeadingOnes32); /* size 0xa0 */
	. = ALIGN(0x10); /* align for .text.DeleteOneFile */
	"jobcntl_aarch64.o"(.text.DeleteOneFile); /* size 0x54 */
	. = ALIGN(0x10); /* align for .text.WriteOne32Tuple */
	"jobcntl_aarch64.o"(.text.WriteOne32Tuple); /* size 0x104 */
	. = ALIGN(0x10); /* align for .text.NumOfCombsFromNbyK */
	"jobcntl_aarch64.o"(.text.NumOfCombsFromNbyK); /* size 0xd0 */
	. = ALIGN(0x10); /* align for .text.JobPoolUpdate */
	"jobcntl_aarch64.o"(.text.JobPoolUpdate); /* size 0x104 */
	. = ALIGN(0x10); /* align for .text.GetParent */
	"jobcntl_aarch64.o"(.text.GetParent); /* size 0x5e4 */
	. = ALIGN(0x10); /* align for .text.NumberOfOnes */
	"jobcntl_aarch64.o"(.text.NumberOfOnes); /* size 0xb0 */
	. = ALIGN(0x10); /* align for .text.GetSmallestParent */
	"jobcntl_aarch64.o"(.text.GetSmallestParent); /* size 0x274 */
	. = ALIGN(0x10); /* align for .text.GetPrefixedParent */
	"jobcntl_aarch64.o"(.text.GetPrefixedParent); /* size 0x2bc */
	. = ALIGN(0x10); /* align for .text.JobPoolInit */
	"jobcntl_aarch64.o"(.text.JobPoolInit); /* size 0xd8 */
	. = ALIGN(0x10); /* align for .text.WriteOne64Tuple */
	"jobcntl_aarch64.o"(.text.WriteOne64Tuple); /* size 0x104 */
	. = ALIGN(0x10); /* align for .text.GetRegTupleFromBin64 */
	"jobcntl_aarch64.o"(.text.GetRegTupleFromBin64); /* size 0xf4 */
	. = ALIGN(0x10); /* align for .text.getRegTupleFromBin32 */
	"jobcntl_aarch64.o"(.text.getRegTupleFromBin32); /* size 0xf4 */
	. = ALIGN(0x10); /* align for .text.GetRegTupleFromParent */
	"jobcntl_aarch64.o"(.text.GetRegTupleFromParent); /* size 0x13c */
	. = ALIGN(0x10); /* align for .text.CreateBinTuple */
	"jobcntl_aarch64.o"(.text.CreateBinTuple); /* size 0xb0 */
	. = ALIGN(0x10); /* align for .text.d32v */
	"jobcntl_aarch64.o"(.text.d32v); /* size 0xd0 */
	. = ALIGN(0x10); /* align for .text.Comp8gbuf */
	"jobcntl_aarch64.o"(.text.Comp8gbuf); /* size 0x98 */
	. = ALIGN(0x10); /* align for .text.restore */
	"jobcntl_aarch64.o"(.text.restore); /* size 0x1cc */
	. = ALIGN(0x10); /* align for .text.vszsort */
	"jobcntl_aarch64.o"(.text.vszsort); /* size 0x15c */
	. = ALIGN(0x10); /* align for .text.countTupleOnes */
	"jobcntl_aarch64.o"(.text.countTupleOnes); /* size 0xbc */
	. = ALIGN(0x10); /* align for .text.restoreo */
	"jobcntl_aarch64.o"(.text.restoreo); /* size 0x1cc */
	. = ALIGN(0x10); /* align for .text.onessort */
	"jobcntl_aarch64.o"(.text.onessort); /* size 0x15c */
	. = ALIGN(0x10); /* align for .text.MultiFileProcJobs */
	"jobcntl_aarch64.o"(.text.MultiFileProcJobs); /* size 0x4d0 */
	. = . + 0x46; /* padding after .text.MultiFileProcJobs */
	. = ALIGN(0x10); /* align for .text.PartitionCube */
	"jobcntl_aarch64.o"(.text.PartitionCube); /* size 0x310 */
	. = . + 0x5d; /* padding after .text.PartitionCube */
	...
	"rbt_aarch64.o"(.text.KeyComp); /* size 0xfc */
	. = ALIGN(0x10); /* align for .text.TreeInsert */
	"rbt_aarch64.o"(.text.TreeInsert); /* size 0x7f8 */
	. = ALIGN(0x10); /* align for .text.WriteViewToDisk */
	"rbt_aarch64.o"(.text.WriteViewToDisk); /* size 0x180 */
	. = ALIGN(0x10); /* align for .text.WriteViewToDiskCS */
	"rbt_aarch64.o"(.text.WriteViewToDiskCS); /* size 0x1e8 */
	. = ALIGN(0x10); /* align for .text.computeChecksum */
	"rbt_aarch64.o"(.text.computeChecksum); /* size 0x168 */
	. = ALIGN(0x10); /* align for .text.WriteChunkToDisk */
	"rbt_aarch64.o"(.text.WriteChunkToDisk); /* size 0x150 */
	. = ALIGN(0x10); /* align for .text.CreateEmptyTree */
	"rbt_aarch64.o"(.text.CreateEmptyTree); /* size 0x1c0 */
	. = . + 0x9; /* padding after .text.CreateEmptyTree */
	. = ALIGN(0x10); /* align for .text.InitializeTree */
	"rbt_aarch64.o"(.text.InitializeTree); /* size 0x11c */
	. = ALIGN(0x10); /* align for .text.DestroyTree */
	"rbt_aarch64.o"(.text.DestroyTree); /* size 0xe0 */
	. = . + 0x5; /* padding after .text.DestroyTree */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:isdigit.o"(.text.isdigit); /* size 0x10 */
	. = ALIGN(0x4); /* align for .text.__isdigit_l */
	"/usr/local/popcorn/aarch64/lib/libc.a:isdigit.o"(.text.__isdigit_l); /* size 0x10 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:fgets.o"(.text.fgets); /* size 0x194 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:fread.o"(.text.fread); /* size 0x12c */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:ftell.o"(.text.__ftello_unlocked); /* size 0x70 */
	. = ALIGN(0x4); /* align for .text.__ftello */
	"/usr/local/popcorn/aarch64/lib/libc.a:ftell.o"(.text.__ftello); /* size 0x64 */
	. = ALIGN(0x4); /* align for .text.ftell */
	"/usr/local/popcorn/aarch64/lib/libc.a:ftell.o"(.text.ftell); /* size 0x4 */
	. = . + 0x1; /* padding after .text.ftell */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:strstr.o"(.text.strstr); /* size 0x648 */
	...
	. = . + 0x8; /* padding before .text.alloc_rev */
...
.rodata	: ALIGN(0x100000)
{
	...
	"adc_aarch64.o"(.rodata.adc__str_ADC_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_1_prime__ */
	"adc_aarch64.o"(.rodata.adc__str_1_prime__); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_2___ */
	"adc_aarch64.o"(.rodata.adc__str_2___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_3__ld_ */
	"adc_aarch64.o"(.rodata.adc__str_3__ld_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_4__ld__ld_ */
	"adc_aarch64.o"(.rodata.adc__str_4__ld__ld_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_5___ */
	"adc_aarch64.o"(.rodata.adc__str_5___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_6_view_sz_ */
	"adc_aarch64.o"(.rodata.adc__str_6_view_sz_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_7__s__s__d_ */
	"adc_aarch64.o"(.rodata.adc__str_7__s__s__d_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_8_w__ */
	"adc_aarch64.o"(.rodata.adc__str_8_w__); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_9_CalculateV */
	"adc_aarch64.o"(.rodata.adc__str_9_CalculateV); /* size 0x29 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_10_Selection_ */
	"adc_aarch64.o"(.rodata.adc__str_10_Selection_); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.adc__str_11___lld_ */
	"adc_aarch64.o"(.rodata.adc__str_11___lld_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_12__View_Size */
	"adc_aarch64.o"(.rodata.adc__str_12__View_Size); /* size 0x12 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_13__Total_in_ */
	"adc_aarch64.o"(.rodata.adc__str_13__Total_in_); /* size 0x2f */
	. = ALIGN(0x4); /* align for .rodata.adc__str_14_View_sizes */
	"adc_aarch64.o"(.rodata.adc__str_14_View_sizes); /* size 0x20 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_15_r_ */
	"adc_aarch64.o"(.rodata.adc__str_15_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_16_ParseParFi */
	"adc_aarch64.o"(.rodata.adc__str_16_ParseParFi); /* size 0x23 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_17__d_ */
	"adc_aarch64.o"(.rodata.adc__str_17__d_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_18___ */
	"adc_aarch64.o"(.rodata.adc__str_18___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_19__lld_ */
	"adc_aarch64.o"(.rodata.adc__str_19__lld_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_20__s_ */
	"adc_aarch64.o"(.rodata.adc__str_20__s_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_21__c_ */
	"adc_aarch64.o"(.rodata.adc__str_21__c_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_22_w_ */
	"adc_aarch64.o"(.rodata.adc__str_22_w_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_23_WriteADCPa */
	"adc_aarch64.o"(.rodata.adc__str_23_WriteADCPa); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_24_attrNum__d */
	"adc_aarch64.o"(.rodata.adc__str_24_attrNum__d); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.adc__str_25_measuresNu */
	"adc_aarch64.o"(.rodata.adc__str_25_measuresNu); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_26_tuplesNum_ */
	"adc_aarch64.o"(.rodata.adc__str_26_tuplesNum_); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_27_class__c__ */
	"adc_aarch64.o"(.rodata.adc__str_27_class__c__); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.adc__str_28_INVERSE_EN */
	"adc_aarch64.o"(.rodata.adc__str_28_INVERSE_EN); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_29_fileName__ */
	"adc_aarch64.o"(.rodata.adc__str_29_fileName__); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.adc__str_30___________ */
	"adc_aarch64.o"(.rodata.adc__str_30___________); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_31__id___d__ */
	"adc_aarch64.o"(.rodata.adc__str_31__id___d__); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_32__attribute */
	"adc_aarch64.o"(.rodata.adc__str_32__attribute); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_33__measures_ */
	"adc_aarch64.o"(.rodata.adc__str_33__measures_); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_34__tuples___ */
	"adc_aarch64.o"(.rodata.adc__str_34__tuples___); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_35__class___c */
	"adc_aarch64.o"(.rodata.adc__str_35__class___c); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.adc__str_36__filename_ */
	"adc_aarch64.o"(.rodata.adc__str_36__filename_); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_37___________ */
	"adc_aarch64.o"(.rodata.adc__str_37___________); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.adc_c_GetNextTuple_maxdim */
	"adc_aarch64.o"(.rodata.adc_c_GetNextTuple_maxdim); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_38_GetNextTup */
	"adc_aarch64.o"(.rodata.adc__str_38_GetNextTup); /* size 0x2e */
	. = ALIGN(0x4); /* align for .rodata.adc__str_39_GetNextTup */
	"adc_aarch64.o"(.rodata.adc__str_39_GetNextTup); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.adc__str_40_Prime__Gen */
	"adc_aarch64.o"(.rodata.adc__str_40_Prime__Gen); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_41___ld___ld_ */
	"adc_aarch64.o"(.rodata.adc__str_41___ld___ld_); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_42__s_dat__d_ */
	"adc_aarch64.o"(.rodata.adc__str_42__s_dat__d_); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.adc__str_43_wb__ */
	"adc_aarch64.o"(.rodata.adc__str_43_wb__); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_44_GenerateAD */
	"adc_aarch64.o"(.rodata.adc__str_44_GenerateAD); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_45__GenerateA */
	"adc_aarch64.o"(.rodata.adc__str_45__GenerateA); /* size 0x48 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_46_Binary_ADC */
	"adc_aarch64.o"(.rodata.adc__str_46_Binary_ADC); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_47_have_been_ */
	"adc_aarch64.o"(.rodata.adc__str_47_have_been_); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_48_attrNum_ */
	"adc_aarch64.o"(.rodata.adc__str_48_attrNum_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_49_measuresNu */
	"adc_aarch64.o"(.rodata.adc__str_49_measuresNu); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.adc__str_50_tuplesNum_ */
	"adc_aarch64.o"(.rodata.adc__str_50_tuplesNum_); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.adc__str_51_INVERSE_EN */
	"adc_aarch64.o"(.rodata.adc__str_51_INVERSE_EN); /* size 0xf */
	. = ALIGN(0x4); /* align for .rodata.adc__str_52_fileName_ */
	"adc_aarch64.o"(.rodata.adc__str_52_fileName_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_53_class_ */
	"adc_aarch64.o"(.rodata.adc__str_53_class_); /* size 0x6 */
	...
	"dc_aarch64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.dc__str____NAS_Par */
	"dc_aarch64.o"(.rodata.dc__str____NAS_Par); /* size 0x39 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_1__No_Paramt */
	"dc_aarch64.o"(.rodata.dc__str_1__No_Paramt); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_2_Usage___pr */
	"dc_aarch64.o"(.rodata.dc__str_2_Usage___pr); /* size 0x2a */
	. = ALIGN(0x4); /* align for .rodata.dc__str_3_________fi */
	"dc_aarch64.o"(.rodata.dc__str_3_________fi); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.dc__str_4_Example__b */
	"dc_aarch64.o"(.rodata.dc__str_4_Example__b); /* size 0x26 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_5_The_last_a */
	"dc_aarch64.o"(.rodata.dc__str_5_The_last_a); /* size 0x36 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_6___s__errno */
	"dc_aarch64.o"(.rodata.dc__str_6___s__errno); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_7_main__mall */
	"dc_aarch64.o"(.rodata.dc__str_7_main__mall); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_8_main_Parse */
	"dc_aarch64.o"(.rodata.dc__str_8_main_Parse); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_9_main_Gener */
	"dc_aarch64.o"(.rodata.dc__str_9_main_Gener); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_10_Estimated_ */
	"dc_aarch64.o"(.rodata.dc__str_10_Estimated_); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.dc__str_11_main_DC_fa */
	"dc_aarch64.o"(.rodata.dc__str_11_main_DC_fa); /* size 0xf */
	. = ALIGN(0x4); /* align for .rodata.dc__str_12_main_ParRu */
	"dc_aarch64.o"(.rodata.dc__str_12_main_ParRu); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_13_ParRun_New */
	"dc_aarch64.o"(.rodata.dc__str_13_ParRun_New); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_14_DC_NewAdcV */
	"dc_aarch64.o"(.rodata.dc__str_14_DC_NewAdcV); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_15_DC_Partiti */
	"dc_aarch64.o"(.rodata.dc__str_15_DC_Partiti); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_16_goin_to_mi */
	"dc_aarch64.o"(.rodata.dc__str_16_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_17_DC_Compute */
	"dc_aarch64.o"(.rodata.dc__str_17_DC_Compute); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.dc__str_18___migrated */
	"dc_aarch64.o"(.rodata.dc__str_18___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_19_ParRun_Clo */
	"dc_aarch64.o"(.rodata.dc__str_19_ParRun_Clo); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.dc__str_20______DC_Be */
	"dc_aarch64.o"(.rodata.dc__str_20______DC_Be); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_21__Benchmark */
	"dc_aarch64.o"(.rodata.dc__str_21__Benchmark); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_22__Input_Tup */
	"dc_aarch64.o"(.rodata.dc__str_22__Input_Tup); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_23__Number_of */
	"dc_aarch64.o"(.rodata.dc__str_23__Number_of); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_24__Number_of */
	"dc_aarch64.o"(.rodata.dc__str_24__Number_of); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_25__Tuples_Ge */
	"dc_aarch64.o"(.rodata.dc__str_25__Tuples_Ge); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_26__Tuples_s_ */
	"dc_aarch64.o"(.rodata.dc__str_26__Tuples_s_); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_27__Checksum_ */
	"dc_aarch64.o"(.rodata.dc__str_27__Checksum_); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.dc__str_28__Verificat */
	"dc_aarch64.o"(.rodata.dc__str_28__Verificat); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_29_DC_ */
	"dc_aarch64.o"(.rodata.dc__str_29_DC_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_30_Tuples_gen */
	"dc_aarch64.o"(.rodata.dc__str_30_Tuples_gen); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_31_3_3_1_ */
	"dc_aarch64.o"(.rodata.dc__str_31_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_32_03_Nov_201 */
	"dc_aarch64.o"(.rodata.dc__str_32_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.dc__str_33_gcc_ */
	"dc_aarch64.o"(.rodata.dc__str_33_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_34___CC__ */
	"dc_aarch64.o"(.rodata.dc__str_34___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_35__lm_ */
	"dc_aarch64.o"(.rodata.dc__str_35__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_36__I___commo */
	"dc_aarch64.o"(.rodata.dc__str_36__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.dc__str_37__g__Wall__ */
	"dc_aarch64.o"(.rodata.dc__str_37__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.dc__str_38__O3__mcmod */
	"dc_aarch64.o"(.rodata.dc__str_38__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str__ReadWhole */
	"extbuild_aarch64.o"(.rodata.extbuild__str__ReadWhole); /* size 0x32 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_1_ComputeMem */
	"extbuild_aarch64.o"(.rodata.extbuild__str_1_ComputeMem); /* size 0x2f */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_2_SharedSort */
	"extbuild_aarch64.o"(.rodata.extbuild__str_2_SharedSort); /* size 0x2f */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_3_Too_many_c */
	"extbuild_aarch64.o"(.rodata.extbuild__str_3_Too_many_c); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_4_SharedSort */
	"extbuild_aarch64.o"(.rodata.extbuild__str_4_SharedSort); /* size 0x2b */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_5_SharedSort */
	"extbuild_aarch64.o"(.rodata.extbuild__str_5_SharedSort); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_6_SharedSort */
	"extbuild_aarch64.o"(.rodata.extbuild__str_6_SharedSort); /* size 0x2b */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_7_PrefixedAg */
	"extbuild_aarch64.o"(.rodata.extbuild__str_7_PrefixedAg); /* size 0x2d */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_8_PrefixedAg */
	"extbuild_aarch64.o"(.rodata.extbuild__str_8_PrefixedAg); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_9___Write_er */
	"extbuild_aarch64.o"(.rodata.extbuild__str_9___Write_er); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_10_RunFormati */
	"extbuild_aarch64.o"(.rodata.extbuild__str_10_RunFormati); /* size 0x2d */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_11_RunFormati */
	"extbuild_aarch64.o"(.rodata.extbuild__str_11_RunFormati); /* size 0x38 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_12_RunFormati */
	"extbuild_aarch64.o"(.rodata.extbuild__str_12_RunFormati); /* size 0x39 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_13_SeekAndRea */
	"extbuild_aarch64.o"(.rodata.extbuild__str_13_SeekAndRea); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_14_MultiWayMe */
	"extbuild_aarch64.o"(.rodata.extbuild__str_14_MultiWayMe); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_15_AdcFileOpe */
	"extbuild_aarch64.o"(.rodata.extbuild__str_15_AdcFileOpe); /* size 0x31 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_16__s__s__d_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_16__s__s__d_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_17___d_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_17___d_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_18_logf_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_18_logf_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_19_w_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_19_w_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_20_dat_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_20_dat_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_21_rb_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_21_rb_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_22_view_dat_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_22_view_dat_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_23_wb__ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_23_wb__); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_24_chunks_dat */
	"extbuild_aarch64.o"(.rodata.extbuild__str_24_chunks_dat); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_25_groupby_da */
	"extbuild_aarch64.o"(.rodata.extbuild__str_25_groupby_da); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_26_view_sz_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_26_view_sz_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_27_r_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_27_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_28_viewsz_dat */
	"extbuild_aarch64.o"(.rodata.extbuild__str_28_viewsz_dat); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_29_NewAdcView */
	"extbuild_aarch64.o"(.rodata.extbuild__str_29_NewAdcView); /* size 0x30 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_30_NewAdcView */
	"extbuild_aarch64.o"(.rodata.extbuild__str_30_NewAdcView); /* size 0x34 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_31_NewAdcView */
	"extbuild_aarch64.o"(.rodata.extbuild__str_31_NewAdcView); /* size 0x35 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_32__NewAdcVie */
	"extbuild_aarch64.o"(.rodata.extbuild__str_32__NewAdcVie); /* size 0x29 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_33___Not_enou */
	"extbuild_aarch64.o"(.rodata.extbuild__str_33___Not_enou); /* size 0x38 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_34___Not_enou */
	"extbuild_aarch64.o"(.rodata.extbuild__str_34___Not_enou); /* size 0x45 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_35__Meaning_o */
	"extbuild_aarch64.o"(.rodata.extbuild__str_35__Meaning_o); /* size 0x30 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_36_Row_Number */
	"extbuild_aarch64.o"(.rodata.extbuild__str_36_Row_Number); /* size 0x44 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_37_____memory */
	"extbuild_aarch64.o"(.rodata.extbuild__str_37_____memory); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_38_____treeNo */
	"extbuild_aarch64.o"(.rodata.extbuild__str_38_____treeNo); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_39__treeMemor */
	"extbuild_aarch64.o"(.rodata.extbuild__str_39__treeMemor); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_40_____nNodes */
	"extbuild_aarch64.o"(.rodata.extbuild__str_40_____nNodes); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_41_freeNodeCo */
	"extbuild_aarch64.o"(.rodata.extbuild__str_41_freeNodeCo); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_42__nViewRows */
	"extbuild_aarch64.o"(.rodata.extbuild__str_42__nViewRows); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_43__s_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_43__s_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_44_Selection_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_44_Selection_); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_45_View_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_45_View_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_46_Size__ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_46_Size__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_47_A_view_siz */
	"extbuild_aarch64.o"(.rodata.extbuild__str_47_A_view_siz); /* size 0x2a */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_48___Meaning_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_48___Meaning_); /* size 0x31 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_49_Verificati */
	"extbuild_aarch64.o"(.rodata.extbuild__str_49_Verificati); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_50_Verificati */
	"extbuild_aarch64.o"(.rodata.extbuild__str_50_Verificati); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_51_ReadWholeI */
	"extbuild_aarch64.o"(.rodata.extbuild__str_51_ReadWholeI); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_52_ComputeMem */
	"extbuild_aarch64.o"(.rodata.extbuild__str_52_ComputeMem); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_53__7d__ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_53__7d__); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_54______15d__ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_54______15d__); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_55___20lld_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_55___20lld_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_56_____5d_ */
	"extbuild_aarch64.o"(.rodata.extbuild__str_56_____5d_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str____s_ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str____s_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_1_1_ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_1_1_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_2_0_ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_2_0_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_3___s__ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_3___s__); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_4___d_ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_4___d_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_5__Partition */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_5__Partition); /* size 0x2e */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_6__s_ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_6__s_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_7_Selection_ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_7_Selection_); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_8_View_ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_8_View_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_9_Size__ */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_9_Size__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_10_MultiFileP */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_10_MultiFileP); /* size 0x20 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_11_MultiFileP */
	"jobcntl_aarch64.o"(.rodata.jobcntl__str_11_MultiFileP); /* size 0x20 */
	...
	"rbt_aarch64.o"(.rodata.rbt__str___Write_er); /* size 0x22 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = . + 0x50; /* padding after .rodata.cst8 */
	...
	. = . + 0x18; /* padding after .rodata.cst8 */
	...
	. = . + 0x10; /* padding after .rodata.cst16 */
	. = . + 0x20; /* padding after .rodata.cst16 */
	. = ALIGN(0x4); /* align for .rodata.CalculateVeiwSizes */
	"adc_aarch64.o"(.rodata.CalculateVeiwSizes); /* size 0xb8 */
	. = ALIGN(0x4); /* align for .rodata.ParseParFile */
	"adc_aarch64.o"(.rodata.ParseParFile); /* size 0x78 */
	. = ALIGN(0x4); /* align for .rodata.GetNextTuple */
	"adc_aarch64.o"(.rodata.GetNextTuple); /* size 0x5c */
	. = ALIGN(0x4); /* align for .rodata.Verify */
	"dc_aarch64.o"(.rodata.Verify); /* size 0x5c */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
...
.data	: ALIGN(0x100000)
{
	...
	"adc_aarch64.o"(.data.adcprime); /* size 0xa0 */
	. = ALIGN(0x8); /* align for .data.LARGE_NUM */
	"adc_aarch64.o"(.data.LARGE_NUM); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.maxprmfctr */
	"adc_aarch64.o"(.data.maxprmfctr); /* size 0x8 */
	. = ALIGN(0x10); /* align for .data.adcexp */
	"adc_aarch64.o"(.data.adcexp); /* size 0xa0 */
	. = ALIGN(0x10); /* align for .data.adcexpS */
	"adc_aarch64.o"(.data.adcexpS); /* size 0x28 */
	. = ALIGN(0x10); /* align for .data.adcexpW */
	"adc_aarch64.o"(.data.adcexpW); /* size 0x50 */
	. = ALIGN(0x10); /* align for .data.adcexpA */
	"adc_aarch64.o"(.data.adcexpA); /* size 0x78 */
	. = ALIGN(0x10); /* align for .data.adcexpB */
	"adc_aarch64.o"(.data.adcexpB); /* size 0xa0 */
	. = ALIGN(0x8); /* align for .data.UpPrimeLim */
	"adc_aarch64.o"(.data.UpPrimeLim); /* size 0x8 */
	. = ALIGN(0x10); /* align for .data.adc_c_adcKeyword */
	"adc_aarch64.o"(.data.adc_c_adcKeyword); /* size 0x38 */
	. = ALIGN(0x10); /* align for .data.adcgen */
	"adc_aarch64.o"(.data.adcgen); /* size 0xa0 */
	. = ALIGN(0x4); /* align for .data.adc_c_GetNextTuple_measbound */
	"adc_aarch64.o"(.data.adc_c_GetNextTuple_measbound); /* size 0x4 */
	. = ALIGN(0x8); /* align for .data.input_tuples */
	"dc_aarch64.o"(.data.input_tuples); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.attrnum */
	"dc_aarch64.o"(.data.attrnum); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumS */
	"dc_aarch64.o"(.data.checksumS); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumWlo */
	"dc_aarch64.o"(.data.checksumWlo); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumWhi */
	"dc_aarch64.o"(.data.checksumWhi); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumAlo */
	"dc_aarch64.o"(.data.checksumAlo); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumAhi */
	"dc_aarch64.o"(.data.checksumAhi); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumBlo */
	"dc_aarch64.o"(.data.checksumBlo); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumBhi */
	"dc_aarch64.o"(.data.checksumBhi); /* size 0x8 */
	. = ALIGN(0x4); /* align for .data.extbuild_c_measbound */
	"extbuild_aarch64.o"(.data.extbuild_c_measbound); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.rbt_c_measbound */
	"rbt_aarch64.o"(.data.rbt_c_measbound); /* size 0x4 */
...
.bss	: ALIGN(0x100000)
{
	...
	"adc_aarch64.o"(.bss.adc_c_GetNextTuple_tuplenum); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.adc_c_GetNextTuple_seed */
	"adc_aarch64.o"(.bss.adc_c_GetNextTuple_seed); /* size 0xa0 */
