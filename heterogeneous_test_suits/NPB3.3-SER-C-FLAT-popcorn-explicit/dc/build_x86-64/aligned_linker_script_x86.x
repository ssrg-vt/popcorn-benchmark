...
.text	: ALIGN(0x100000)
{
	...
	. = ALIGN(0x10); /* align for .text.swap4 */
	"adc_x86_64.o"(.text.swap4); /* size 0x6b */
	. = . + 0x25; /* padding after .text.swap4 */
	. = ALIGN(0x10); /* align for .text.swap8 */
	"adc_x86_64.o"(.text.swap8); /* size 0xa7 */
	. = . + 0x31; /* padding after .text.swap8 */
	. = ALIGN(0x10); /* align for .text.initADCpar */
	"adc_x86_64.o"(.text.initADCpar); /* size 0x71 */
	. = . + 0x1f; /* padding after .text.initADCpar */
	. = ALIGN(0x10); /* align for .text.ShowFactorization */
	"adc_x86_64.o"(.text.ShowFactorization); /* size 0x17d */
	. = . + 0x17; /* padding after .text.ShowFactorization */
	. = ALIGN(0x10); /* align for .text.ListFirstPrimes */
	"adc_x86_64.o"(.text.ListFirstPrimes); /* size 0x1b1 */
	. = ALIGN(0x10); /* align for .text.GetLCM */
	"adc_x86_64.o"(.text.GetLCM); /* size 0x39c */
	. = . + 0x4; /* padding after .text.GetLCM */
	. = ALIGN(0x10); /* align for .text.ExtendFactors */
	"adc_x86_64.o"(.text.ExtendFactors); /* size 0x241 */
	. = . + 0x17; /* padding after .text.ExtendFactors */
	. = ALIGN(0x10); /* align for .text.GetFactorization */
	"adc_x86_64.o"(.text.GetFactorization); /* size 0x48b */
	. = ALIGN(0x10); /* align for .text.CompareSizesByValue */
	"adc_x86_64.o"(.text.CompareSizesByValue); /* size 0xa5 */
	. = . + 0x17; /* padding after .text.CompareSizesByValue */
	. = ALIGN(0x10); /* align for .text.CompareViewsBySize */
	"adc_x86_64.o"(.text.CompareViewsBySize); /* size 0x103 */
	. = . + 0xd; /* padding after .text.CompareViewsBySize */
	. = ALIGN(0x10); /* align for .text.CalculateVeiwSizes */
	"adc_x86_64.o"(.text.CalculateVeiwSizes); /* size 0x767 */
	. = ALIGN(0x10); /* align for .text.ParseParFile */
	"adc_x86_64.o"(.text.ParseParFile); /* size 0x4eb */
	. = ALIGN(0x10); /* align for .text.WriteADCPar */
	"adc_x86_64.o"(.text.WriteADCPar); /* size 0x183 */
	. = . + 0x21; /* padding after .text.WriteADCPar */
	. = ALIGN(0x10); /* align for .text.ShowADCPar */
	"adc_x86_64.o"(.text.ShowADCPar); /* size 0x117 */
	. = . + 0x1d; /* padding after .text.ShowADCPar */
	. = ALIGN(0x10); /* align for .text.GetNextTuple */
	"adc_x86_64.o"(.text.GetNextTuple); /* size 0x43b */
	. = . + 0x41; /* padding after .text.GetNextTuple */
	. = ALIGN(0x10); /* align for .text.GenerateADC */
	"adc_x86_64.o"(.text.GenerateADC); /* size 0x343 */
	. = . + 0x5; /* padding after .text.GenerateADC */
	...
	"dc_x86_64.o"(.text.main); /* size 0x49d */
	. = ALIGN(0x10); /* align for .text.DC */
	"dc_x86_64.o"(.text.DC); /* size 0x587 */
	. = ALIGN(0x10); /* align for .text.Verify */
	"dc_x86_64.o"(.text.Verify); /* size 0x172 */
	. = ALIGN(0x10); /* align for .text.ReadWholeInputData */
	"extbuild_x86_64.o"(.text.ReadWholeInputData); /* size 0x15f */
	. = . + 0x1d; /* padding after .text.ReadWholeInputData */
	. = ALIGN(0x10); /* align for .text.ComputeMemoryFittedView */
	"extbuild_x86_64.o"(.text.ComputeMemoryFittedView); /* size 0x27b */
	. = ALIGN(0x10); /* align for .text.SelectToView */
	"extbuild_x86_64.o"(.text.SelectToView); /* size 0xd8 */
	. = . + 0x24; /* padding after .text.SelectToView */
	. = ALIGN(0x10); /* align for .text.SharedSortAggregate */
	"extbuild_x86_64.o"(.text.SharedSortAggregate); /* size 0xada */
	. = ALIGN(0x10); /* align for .text.MultiWayMerge */
	"extbuild_x86_64.o"(.text.MultiWayMerge); /* size 0x97c */
	. = ALIGN(0x10); /* align for .text.PrefixedAggregate */
	"extbuild_x86_64.o"(.text.PrefixedAggregate); /* size 0x66c */
	. = ALIGN(0x10); /* align for .text.RunFormation */
	"extbuild_x86_64.o"(.text.RunFormation); /* size 0x3e8 */
	. = ALIGN(0x10); /* align for .text.SeekAndReadNextSubChunk */
	"extbuild_x86_64.o"(.text.SeekAndReadNextSubChunk); /* size 0xd5 */
	. = . + 0x1f; /* padding after .text.SeekAndReadNextSubChunk */
	. = ALIGN(0x10); /* align for .text.ReadSubChunk */
	"extbuild_x86_64.o"(.text.ReadSubChunk); /* size 0x1e9 */
	. = . + 0x67; /* padding after .text.ReadSubChunk */
	. = ALIGN(0x10); /* align for .text.AdcFileOpen */
	"extbuild_x86_64.o"(.text.AdcFileOpen); /* size 0x91 */
	. = . + 0x17; /* padding after .text.AdcFileOpen */
	. = ALIGN(0x10); /* align for .text.AdcFileName */
	"extbuild_x86_64.o"(.text.AdcFileName); /* size 0x71 */
	. = . + 0x1b; /* padding after .text.AdcFileName */
	. = ALIGN(0x10); /* align for .text.NewAdcViewCntl */
	"extbuild_x86_64.o"(.text.NewAdcViewCntl); /* size 0xa41 */
	. = ALIGN(0x10); /* align for .text.InitAdcViewCntl */
	"extbuild_x86_64.o"(.text.InitAdcViewCntl); /* size 0x1e7 */
	. = ALIGN(0x10); /* align for .text.CloseAdcView */
	"extbuild_x86_64.o"(.text.CloseAdcView); /* size 0x321 */
	. = ALIGN(0x10); /* align for .text.AdcCntlLog */
	"extbuild_x86_64.o"(.text.AdcCntlLog); /* size 0x109 */
	. = . + 0x7; /* padding after .text.AdcCntlLog */
	. = ALIGN(0x10); /* align for .text.ViewSizesVerification */
	"extbuild_x86_64.o"(.text.ViewSizesVerification); /* size 0x482 */
	. = ALIGN(0x10); /* align for .text.ComputeGivenGroupbys */
	"extbuild_x86_64.o"(.text.ComputeGivenGroupbys); /* size 0x435 */
	. = ALIGN(0x10); /* align for .text.SetOneBit */
	"jobcntl_x86_64.o"(.text.SetOneBit); /* size 0x61 */
	. = . + 0x13; /* padding after .text.SetOneBit */
	. = ALIGN(0x10); /* align for .text.SetOneBit32 */
	"jobcntl_x86_64.o"(.text.SetOneBit32); /* size 0x53 */
	. = . + 0x21; /* padding after .text.SetOneBit32 */
	. = ALIGN(0x10); /* align for .text.Mlo32 */
	"jobcntl_x86_64.o"(.text.Mlo32); /* size 0x95 */
	. = . + 0x1b; /* padding after .text.Mlo32 */
	. = ALIGN(0x10); /* align for .text.mro32 */
	"jobcntl_x86_64.o"(.text.mro32); /* size 0x95 */
	. = . + 0x1f; /* padding after .text.mro32 */
	. = ALIGN(0x10); /* align for .text.setLeadingOnes32 */
	"jobcntl_x86_64.o"(.text.setLeadingOnes32); /* size 0x7f */
	. = . + 0x21; /* padding after .text.setLeadingOnes32 */
	. = ALIGN(0x10); /* align for .text.DeleteOneFile */
	"jobcntl_x86_64.o"(.text.DeleteOneFile); /* size 0x36 */
	. = . + 0x1e; /* padding after .text.DeleteOneFile */
	. = ALIGN(0x10); /* align for .text.WriteOne32Tuple */
	"jobcntl_x86_64.o"(.text.WriteOne32Tuple); /* size 0xef */
	. = . + 0x15; /* padding after .text.WriteOne32Tuple */
	. = ALIGN(0x10); /* align for .text.NumOfCombsFromNbyK */
	"jobcntl_x86_64.o"(.text.NumOfCombsFromNbyK); /* size 0xb2 */
	. = . + 0x1e; /* padding after .text.NumOfCombsFromNbyK */
	. = ALIGN(0x10); /* align for .text.JobPoolUpdate */
	"jobcntl_x86_64.o"(.text.JobPoolUpdate); /* size 0xdf */
	. = . + 0x25; /* padding after .text.JobPoolUpdate */
	. = ALIGN(0x10); /* align for .text.GetParent */
	"jobcntl_x86_64.o"(.text.GetParent); /* size 0x5cd */
	. = . + 0x17; /* padding after .text.GetParent */
	. = ALIGN(0x10); /* align for .text.NumberOfOnes */
	"jobcntl_x86_64.o"(.text.NumberOfOnes); /* size 0xa5 */
	. = . + 0xb; /* padding after .text.NumberOfOnes */
	. = ALIGN(0x10); /* align for .text.GetSmallestParent */
	"jobcntl_x86_64.o"(.text.GetSmallestParent); /* size 0x251 */
	. = . + 0x23; /* padding after .text.GetSmallestParent */
	. = ALIGN(0x10); /* align for .text.GetPrefixedParent */
	"jobcntl_x86_64.o"(.text.GetPrefixedParent); /* size 0x291 */
	. = . + 0x2b; /* padding after .text.GetPrefixedParent */
	. = ALIGN(0x10); /* align for .text.JobPoolInit */
	"jobcntl_x86_64.o"(.text.JobPoolInit); /* size 0xbd */
	. = . + 0x1b; /* padding after .text.JobPoolInit */
	. = ALIGN(0x10); /* align for .text.WriteOne64Tuple */
	"jobcntl_x86_64.o"(.text.WriteOne64Tuple); /* size 0xf8 */
	. = . + 0xc; /* padding after .text.WriteOne64Tuple */
	. = ALIGN(0x10); /* align for .text.GetRegTupleFromBin64 */
	"jobcntl_x86_64.o"(.text.GetRegTupleFromBin64); /* size 0xe7 */
	. = . + 0xd; /* padding after .text.GetRegTupleFromBin64 */
	. = ALIGN(0x10); /* align for .text.getRegTupleFromBin32 */
	"jobcntl_x86_64.o"(.text.getRegTupleFromBin32); /* size 0xd7 */
	. = . + 0x1d; /* padding after .text.getRegTupleFromBin32 */
	. = ALIGN(0x10); /* align for .text.GetRegTupleFromParent */
	"jobcntl_x86_64.o"(.text.GetRegTupleFromParent); /* size 0x11c */
	. = . + 0x20; /* padding after .text.GetRegTupleFromParent */
	. = ALIGN(0x10); /* align for .text.CreateBinTuple */
	"jobcntl_x86_64.o"(.text.CreateBinTuple); /* size 0x97 */
	. = . + 0x19; /* padding after .text.CreateBinTuple */
	. = ALIGN(0x10); /* align for .text.d32v */
	"jobcntl_x86_64.o"(.text.d32v); /* size 0xb0 */
	. = . + 0x20; /* padding after .text.d32v */
	. = ALIGN(0x10); /* align for .text.Comp8gbuf */
	"jobcntl_x86_64.o"(.text.Comp8gbuf); /* size 0x89 */
	. = . + 0xf; /* padding after .text.Comp8gbuf */
	. = ALIGN(0x10); /* align for .text.restore */
	"jobcntl_x86_64.o"(.text.restore); /* size 0x19c */
	. = . + 0x30; /* padding after .text.restore */
	. = ALIGN(0x10); /* align for .text.vszsort */
	"jobcntl_x86_64.o"(.text.vszsort); /* size 0x136 */
	. = . + 0x26; /* padding after .text.vszsort */
	. = ALIGN(0x10); /* align for .text.countTupleOnes */
	"jobcntl_x86_64.o"(.text.countTupleOnes); /* size 0xac */
	. = . + 0x10; /* padding after .text.countTupleOnes */
	. = ALIGN(0x10); /* align for .text.restoreo */
	"jobcntl_x86_64.o"(.text.restoreo); /* size 0x190 */
	. = . + 0x3c; /* padding after .text.restoreo */
	. = ALIGN(0x10); /* align for .text.onessort */
	"jobcntl_x86_64.o"(.text.onessort); /* size 0x130 */
	. = . + 0x2c; /* padding after .text.onessort */
	. = ALIGN(0x10); /* align for .text.MultiFileProcJobs */
	"jobcntl_x86_64.o"(.text.MultiFileProcJobs); /* size 0x516 */
	. = ALIGN(0x10); /* align for .text.PartitionCube */
	"jobcntl_x86_64.o"(.text.PartitionCube); /* size 0x36d */
	...
	. = ALIGN(0x10); /* align for .text.KeyComp */
	"rbt_x86_64.o"(.text.KeyComp); /* size 0xdb */
	. = . + 0x21; /* padding after .text.KeyComp */
	. = ALIGN(0x10); /* align for .text.TreeInsert */
	"rbt_x86_64.o"(.text.TreeInsert); /* size 0x7f0 */
	. = . + 0x8; /* padding after .text.TreeInsert */
	. = ALIGN(0x10); /* align for .text.WriteViewToDisk */
	"rbt_x86_64.o"(.text.WriteViewToDisk); /* size 0x180 */
	. = ALIGN(0x10); /* align for .text.WriteViewToDiskCS */
	"rbt_x86_64.o"(.text.WriteViewToDiskCS); /* size 0x1d6 */
	. = . + 0x12; /* padding after .text.WriteViewToDiskCS */
	. = ALIGN(0x10); /* align for .text.computeChecksum */
	"rbt_x86_64.o"(.text.computeChecksum); /* size 0x155 */
	. = . + 0x13; /* padding after .text.computeChecksum */
	. = ALIGN(0x10); /* align for .text.WriteChunkToDisk */
	"rbt_x86_64.o"(.text.WriteChunkToDisk); /* size 0x146 */
	. = . + 0xa; /* padding after .text.WriteChunkToDisk */
	. = ALIGN(0x10); /* align for .text.CreateEmptyTree */
	"rbt_x86_64.o"(.text.CreateEmptyTree); /* size 0x1c9 */
	. = ALIGN(0x10); /* align for .text.InitializeTree */
	"rbt_x86_64.o"(.text.InitializeTree); /* size 0xff */
	. = . + 0x1d; /* padding after .text.InitializeTree */
	. = ALIGN(0x10); /* align for .text.DestroyTree */
	"rbt_x86_64.o"(.text.DestroyTree); /* size 0xe5 */
	...
	. = ALIGN(0x4); /* align for .text.isdigit */
	"/usr/local/popcorn/x86_64/lib/libc.a:isdigit.o"(.text.isdigit); /* size 0xc */
	. = . + 0x4; /* padding after .text.isdigit */
	. = ALIGN(0x4); /* align for .text.__isdigit_l */
	"/usr/local/popcorn/x86_64/lib/libc.a:isdigit.o"(.text.__isdigit_l); /* size 0xc */
	. = . + 0x4; /* padding after .text.__isdigit_l */
	...
	"/usr/local/popcorn/x86_64/lib/libc.a:fgets.o"(.text.fgets); /* size 0x16a */
	. = . + 0x2a; /* padding after .text.fgets */
	...
	"/usr/local/popcorn/x86_64/lib/libc.a:fread.o"(.text.fread); /* size 0x115 */
	. = . + 0x17; /* padding after .text.fread */
	...
	. = ALIGN(0x4); /* align for .text.__ftello_unlocked */
	"/usr/local/popcorn/x86_64/lib/libc.a:ftell.o"(.text.__ftello_unlocked); /* size 0x43 */
	. = . + 0x2d; /* padding after .text.__ftello_unlocked */
	. = ALIGN(0x4); /* align for .text.__ftello */
	"/usr/local/popcorn/x86_64/lib/libc.a:ftell.o"(.text.__ftello); /* size 0x46 */
	. = . + 0x1e; /* padding after .text.__ftello */
	. = ALIGN(0x4); /* align for .text.ftell */
	"/usr/local/popcorn/x86_64/lib/libc.a:ftell.o"(.text.ftell); /* size 0x5 */
	...
	"/usr/local/popcorn/x86_64/lib/libc.a:strstr.o"(.text.strstr); /* size 0x60c */
	. = . + 0x3c; /* padding after .text.strstr */
...
.rodata	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x4); /* align for .rodata.adc__str_ADC_ */
	"adc_x86_64.o"(.rodata.adc__str_ADC_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_1_prime__ */
	"adc_x86_64.o"(.rodata.adc__str_1_prime__); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_2___ */
	"adc_x86_64.o"(.rodata.adc__str_2___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_3__ld_ */
	"adc_x86_64.o"(.rodata.adc__str_3__ld_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_4__ld__ld_ */
	"adc_x86_64.o"(.rodata.adc__str_4__ld__ld_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_5___ */
	"adc_x86_64.o"(.rodata.adc__str_5___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_6_view_sz_ */
	"adc_x86_64.o"(.rodata.adc__str_6_view_sz_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_7__s__s__d_ */
	"adc_x86_64.o"(.rodata.adc__str_7__s__s__d_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_8_w__ */
	"adc_x86_64.o"(.rodata.adc__str_8_w__); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_9_CalculateV */
	"adc_x86_64.o"(.rodata.adc__str_9_CalculateV); /* size 0x29 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_10_Selection_ */
	"adc_x86_64.o"(.rodata.adc__str_10_Selection_); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.adc__str_11___lld_ */
	"adc_x86_64.o"(.rodata.adc__str_11___lld_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_12__View_Size */
	"adc_x86_64.o"(.rodata.adc__str_12__View_Size); /* size 0x12 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_13__Total_in_ */
	"adc_x86_64.o"(.rodata.adc__str_13__Total_in_); /* size 0x2f */
	. = ALIGN(0x4); /* align for .rodata.adc__str_14_View_sizes */
	"adc_x86_64.o"(.rodata.adc__str_14_View_sizes); /* size 0x20 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_15_r_ */
	"adc_x86_64.o"(.rodata.adc__str_15_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_16_ParseParFi */
	"adc_x86_64.o"(.rodata.adc__str_16_ParseParFi); /* size 0x23 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_17__d_ */
	"adc_x86_64.o"(.rodata.adc__str_17__d_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_18___ */
	"adc_x86_64.o"(.rodata.adc__str_18___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_19__lld_ */
	"adc_x86_64.o"(.rodata.adc__str_19__lld_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_20__s_ */
	"adc_x86_64.o"(.rodata.adc__str_20__s_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_21__c_ */
	"adc_x86_64.o"(.rodata.adc__str_21__c_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_22_w_ */
	"adc_x86_64.o"(.rodata.adc__str_22_w_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_23_WriteADCPa */
	"adc_x86_64.o"(.rodata.adc__str_23_WriteADCPa); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_24_attrNum__d */
	"adc_x86_64.o"(.rodata.adc__str_24_attrNum__d); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.adc__str_25_measuresNu */
	"adc_x86_64.o"(.rodata.adc__str_25_measuresNu); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_26_tuplesNum_ */
	"adc_x86_64.o"(.rodata.adc__str_26_tuplesNum_); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_27_class__c__ */
	"adc_x86_64.o"(.rodata.adc__str_27_class__c__); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.adc__str_28_INVERSE_EN */
	"adc_x86_64.o"(.rodata.adc__str_28_INVERSE_EN); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_29_fileName__ */
	"adc_x86_64.o"(.rodata.adc__str_29_fileName__); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.adc__str_30___________ */
	"adc_x86_64.o"(.rodata.adc__str_30___________); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_31__id___d__ */
	"adc_x86_64.o"(.rodata.adc__str_31__id___d__); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_32__attribute */
	"adc_x86_64.o"(.rodata.adc__str_32__attribute); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_33__measures_ */
	"adc_x86_64.o"(.rodata.adc__str_33__measures_); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_34__tuples___ */
	"adc_x86_64.o"(.rodata.adc__str_34__tuples___); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_35__class___c */
	"adc_x86_64.o"(.rodata.adc__str_35__class___c); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.adc__str_36__filename_ */
	"adc_x86_64.o"(.rodata.adc__str_36__filename_); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_37___________ */
	"adc_x86_64.o"(.rodata.adc__str_37___________); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.adc_c_GetNextTuple_maxdim */
	"adc_x86_64.o"(.rodata.adc_c_GetNextTuple_maxdim); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_38_GetNextTup */
	"adc_x86_64.o"(.rodata.adc__str_38_GetNextTup); /* size 0x2e */
	. = ALIGN(0x4); /* align for .rodata.adc__str_39_GetNextTup */
	"adc_x86_64.o"(.rodata.adc__str_39_GetNextTup); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.adc__str_40_Prime__Gen */
	"adc_x86_64.o"(.rodata.adc__str_40_Prime__Gen); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_41___ld___ld_ */
	"adc_x86_64.o"(.rodata.adc__str_41___ld___ld_); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_42__s_dat__d_ */
	"adc_x86_64.o"(.rodata.adc__str_42__s_dat__d_); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.adc__str_43_wb__ */
	"adc_x86_64.o"(.rodata.adc__str_43_wb__); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_44_GenerateAD */
	"adc_x86_64.o"(.rodata.adc__str_44_GenerateAD); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_45__GenerateA */
	"adc_x86_64.o"(.rodata.adc__str_45__GenerateA); /* size 0x48 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_46_Binary_ADC */
	"adc_x86_64.o"(.rodata.adc__str_46_Binary_ADC); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_47_have_been_ */
	"adc_x86_64.o"(.rodata.adc__str_47_have_been_); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_48_attrNum_ */
	"adc_x86_64.o"(.rodata.adc__str_48_attrNum_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_49_measuresNu */
	"adc_x86_64.o"(.rodata.adc__str_49_measuresNu); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.adc__str_50_tuplesNum_ */
	"adc_x86_64.o"(.rodata.adc__str_50_tuplesNum_); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.adc__str_51_INVERSE_EN */
	"adc_x86_64.o"(.rodata.adc__str_51_INVERSE_EN); /* size 0xf */
	. = ALIGN(0x4); /* align for .rodata.adc__str_52_fileName_ */
	"adc_x86_64.o"(.rodata.adc__str_52_fileName_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.adc__str_53_class_ */
	"adc_x86_64.o"(.rodata.adc__str_53_class_); /* size 0x6 */
	...
	"dc_x86_64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.dc__str____NAS_Par */
	"dc_x86_64.o"(.rodata.dc__str____NAS_Par); /* size 0x39 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_1__No_Paramt */
	"dc_x86_64.o"(.rodata.dc__str_1__No_Paramt); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_2_Usage___pr */
	"dc_x86_64.o"(.rodata.dc__str_2_Usage___pr); /* size 0x2a */
	. = ALIGN(0x4); /* align for .rodata.dc__str_3_________fi */
	"dc_x86_64.o"(.rodata.dc__str_3_________fi); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.dc__str_4_Example__b */
	"dc_x86_64.o"(.rodata.dc__str_4_Example__b); /* size 0x26 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_5_The_last_a */
	"dc_x86_64.o"(.rodata.dc__str_5_The_last_a); /* size 0x36 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_6___s__errno */
	"dc_x86_64.o"(.rodata.dc__str_6___s__errno); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_7_main__mall */
	"dc_x86_64.o"(.rodata.dc__str_7_main__mall); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_8_main_Parse */
	"dc_x86_64.o"(.rodata.dc__str_8_main_Parse); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_9_main_Gener */
	"dc_x86_64.o"(.rodata.dc__str_9_main_Gener); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_10_Estimated_ */
	"dc_x86_64.o"(.rodata.dc__str_10_Estimated_); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.dc__str_11_main_DC_fa */
	"dc_x86_64.o"(.rodata.dc__str_11_main_DC_fa); /* size 0xf */
	. = ALIGN(0x4); /* align for .rodata.dc__str_12_main_ParRu */
	"dc_x86_64.o"(.rodata.dc__str_12_main_ParRu); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_13_ParRun_New */
	"dc_x86_64.o"(.rodata.dc__str_13_ParRun_New); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_14_DC_NewAdcV */
	"dc_x86_64.o"(.rodata.dc__str_14_DC_NewAdcV); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_15_DC_Partiti */
	"dc_x86_64.o"(.rodata.dc__str_15_DC_Partiti); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_16_goin_to_mi */
	"dc_x86_64.o"(.rodata.dc__str_16_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_17_DC_Compute */
	"dc_x86_64.o"(.rodata.dc__str_17_DC_Compute); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.dc__str_18___migrated */
	"dc_x86_64.o"(.rodata.dc__str_18___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_19_ParRun_Clo */
	"dc_x86_64.o"(.rodata.dc__str_19_ParRun_Clo); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.dc__str_20______DC_Be */
	"dc_x86_64.o"(.rodata.dc__str_20______DC_Be); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_21__Benchmark */
	"dc_x86_64.o"(.rodata.dc__str_21__Benchmark); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_22__Input_Tup */
	"dc_x86_64.o"(.rodata.dc__str_22__Input_Tup); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_23__Number_of */
	"dc_x86_64.o"(.rodata.dc__str_23__Number_of); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_24__Number_of */
	"dc_x86_64.o"(.rodata.dc__str_24__Number_of); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_25__Tuples_Ge */
	"dc_x86_64.o"(.rodata.dc__str_25__Tuples_Ge); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_26__Tuples_s_ */
	"dc_x86_64.o"(.rodata.dc__str_26__Tuples_s_); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.dc__str_27__Checksum_ */
	"dc_x86_64.o"(.rodata.dc__str_27__Checksum_); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.dc__str_28__Verificat */
	"dc_x86_64.o"(.rodata.dc__str_28__Verificat); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_29_DC_ */
	"dc_x86_64.o"(.rodata.dc__str_29_DC_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_30_Tuples_gen */
	"dc_x86_64.o"(.rodata.dc__str_30_Tuples_gen); /* size 0x11 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_31_3_3_1_ */
	"dc_x86_64.o"(.rodata.dc__str_31_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_32_03_Nov_201 */
	"dc_x86_64.o"(.rodata.dc__str_32_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.dc__str_33_gcc_ */
	"dc_x86_64.o"(.rodata.dc__str_33_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_34___CC__ */
	"dc_x86_64.o"(.rodata.dc__str_34___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_35__lm_ */
	"dc_x86_64.o"(.rodata.dc__str_35__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.dc__str_36__I___commo */
	"dc_x86_64.o"(.rodata.dc__str_36__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.dc__str_37__g__Wall__ */
	"dc_x86_64.o"(.rodata.dc__str_37__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.dc__str_38__O3__mcmod */
	"dc_x86_64.o"(.rodata.dc__str_38__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str__ReadWhole */
	"extbuild_x86_64.o"(.rodata.extbuild__str__ReadWhole); /* size 0x32 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_1_ComputeMem */
	"extbuild_x86_64.o"(.rodata.extbuild__str_1_ComputeMem); /* size 0x2f */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_2_SharedSort */
	"extbuild_x86_64.o"(.rodata.extbuild__str_2_SharedSort); /* size 0x2f */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_3_Too_many_c */
	"extbuild_x86_64.o"(.rodata.extbuild__str_3_Too_many_c); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_4_SharedSort */
	"extbuild_x86_64.o"(.rodata.extbuild__str_4_SharedSort); /* size 0x2b */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_5_SharedSort */
	"extbuild_x86_64.o"(.rodata.extbuild__str_5_SharedSort); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_6_SharedSort */
	"extbuild_x86_64.o"(.rodata.extbuild__str_6_SharedSort); /* size 0x2b */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_7_PrefixedAg */
	"extbuild_x86_64.o"(.rodata.extbuild__str_7_PrefixedAg); /* size 0x2d */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_8_PrefixedAg */
	"extbuild_x86_64.o"(.rodata.extbuild__str_8_PrefixedAg); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_9___Write_er */
	"extbuild_x86_64.o"(.rodata.extbuild__str_9___Write_er); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_10_RunFormati */
	"extbuild_x86_64.o"(.rodata.extbuild__str_10_RunFormati); /* size 0x2d */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_11_RunFormati */
	"extbuild_x86_64.o"(.rodata.extbuild__str_11_RunFormati); /* size 0x38 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_12_RunFormati */
	"extbuild_x86_64.o"(.rodata.extbuild__str_12_RunFormati); /* size 0x39 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_13_SeekAndRea */
	"extbuild_x86_64.o"(.rodata.extbuild__str_13_SeekAndRea); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_14_MultiWayMe */
	"extbuild_x86_64.o"(.rodata.extbuild__str_14_MultiWayMe); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_15_AdcFileOpe */
	"extbuild_x86_64.o"(.rodata.extbuild__str_15_AdcFileOpe); /* size 0x31 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_16__s__s__d_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_16__s__s__d_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_17___d_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_17___d_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_18_logf_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_18_logf_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_19_w_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_19_w_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_20_dat_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_20_dat_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_21_rb_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_21_rb_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_22_view_dat_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_22_view_dat_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_23_wb__ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_23_wb__); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_24_chunks_dat */
	"extbuild_x86_64.o"(.rodata.extbuild__str_24_chunks_dat); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_25_groupby_da */
	"extbuild_x86_64.o"(.rodata.extbuild__str_25_groupby_da); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_26_view_sz_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_26_view_sz_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_27_r_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_27_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_28_viewsz_dat */
	"extbuild_x86_64.o"(.rodata.extbuild__str_28_viewsz_dat); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_29_NewAdcView */
	"extbuild_x86_64.o"(.rodata.extbuild__str_29_NewAdcView); /* size 0x30 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_30_NewAdcView */
	"extbuild_x86_64.o"(.rodata.extbuild__str_30_NewAdcView); /* size 0x34 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_31_NewAdcView */
	"extbuild_x86_64.o"(.rodata.extbuild__str_31_NewAdcView); /* size 0x35 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_32__NewAdcVie */
	"extbuild_x86_64.o"(.rodata.extbuild__str_32__NewAdcVie); /* size 0x29 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_33___Not_enou */
	"extbuild_x86_64.o"(.rodata.extbuild__str_33___Not_enou); /* size 0x38 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_34___Not_enou */
	"extbuild_x86_64.o"(.rodata.extbuild__str_34___Not_enou); /* size 0x45 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_35__Meaning_o */
	"extbuild_x86_64.o"(.rodata.extbuild__str_35__Meaning_o); /* size 0x30 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_36_Row_Number */
	"extbuild_x86_64.o"(.rodata.extbuild__str_36_Row_Number); /* size 0x44 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_37_____memory */
	"extbuild_x86_64.o"(.rodata.extbuild__str_37_____memory); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_38_____treeNo */
	"extbuild_x86_64.o"(.rodata.extbuild__str_38_____treeNo); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_39__treeMemor */
	"extbuild_x86_64.o"(.rodata.extbuild__str_39__treeMemor); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_40_____nNodes */
	"extbuild_x86_64.o"(.rodata.extbuild__str_40_____nNodes); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_41_freeNodeCo */
	"extbuild_x86_64.o"(.rodata.extbuild__str_41_freeNodeCo); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_42__nViewRows */
	"extbuild_x86_64.o"(.rodata.extbuild__str_42__nViewRows); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_43__s_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_43__s_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_44_Selection_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_44_Selection_); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_45_View_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_45_View_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_46_Size__ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_46_Size__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_47_A_view_siz */
	"extbuild_x86_64.o"(.rodata.extbuild__str_47_A_view_siz); /* size 0x2a */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_48___Meaning_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_48___Meaning_); /* size 0x31 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_49_Verificati */
	"extbuild_x86_64.o"(.rodata.extbuild__str_49_Verificati); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_50_Verificati */
	"extbuild_x86_64.o"(.rodata.extbuild__str_50_Verificati); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_51_ReadWholeI */
	"extbuild_x86_64.o"(.rodata.extbuild__str_51_ReadWholeI); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_52_ComputeMem */
	"extbuild_x86_64.o"(.rodata.extbuild__str_52_ComputeMem); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_53__7d__ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_53__7d__); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_54______15d__ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_54______15d__); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_55___20lld_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_55___20lld_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.extbuild__str_56_____5d_ */
	"extbuild_x86_64.o"(.rodata.extbuild__str_56_____5d_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str____s_ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str____s_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_1_1_ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_1_1_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_2_0_ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_2_0_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_3___s__ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_3___s__); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_4___d_ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_4___d_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_5__Partition */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_5__Partition); /* size 0x2e */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_6__s_ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_6__s_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_7_Selection_ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_7_Selection_); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_8_View_ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_8_View_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_9_Size__ */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_9_Size__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_10_MultiFileP */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_10_MultiFileP); /* size 0x20 */
	. = ALIGN(0x4); /* align for .rodata.jobcntl__str_11_MultiFileP */
	"jobcntl_x86_64.o"(.rodata.jobcntl__str_11_MultiFileP); /* size 0x20 */
	...
	. = ALIGN(0x4); /* align for .rodata.rbt__str___Write_er */
	"rbt_x86_64.o"(.rodata.rbt__str___Write_er); /* size 0x22 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:pow.o"(.rodata.cst8); /* size 0x110 */
	...
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"dc_x86_64.o"(.rodata.cst16); /* size 0x20 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = . + 0xb8; /* padding after .rodata.CalculateVeiwSizes */
	. = . + 0x78; /* padding after .rodata.ParseParFile */
	. = . + 0x5c; /* padding after .rodata.GetNextTuple */
	. = . + 0x5c; /* padding after .rodata.Verify */
...
.data	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x10); /* align for .data.adcprime */
	"adc_x86_64.o"(.data.adcprime); /* size 0xa0 */
	. = ALIGN(0x8); /* align for .data.LARGE_NUM */
	"adc_x86_64.o"(.data.LARGE_NUM); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.maxprmfctr */
	"adc_x86_64.o"(.data.maxprmfctr); /* size 0x8 */
	. = ALIGN(0x10); /* align for .data.adcexp */
	"adc_x86_64.o"(.data.adcexp); /* size 0xa0 */
	. = ALIGN(0x10); /* align for .data.adcexpS */
	"adc_x86_64.o"(.data.adcexpS); /* size 0x28 */
	. = ALIGN(0x10); /* align for .data.adcexpW */
	"adc_x86_64.o"(.data.adcexpW); /* size 0x50 */
	. = ALIGN(0x10); /* align for .data.adcexpA */
	"adc_x86_64.o"(.data.adcexpA); /* size 0x78 */
	. = ALIGN(0x10); /* align for .data.adcexpB */
	"adc_x86_64.o"(.data.adcexpB); /* size 0xa0 */
	. = ALIGN(0x8); /* align for .data.UpPrimeLim */
	"adc_x86_64.o"(.data.UpPrimeLim); /* size 0x8 */
	. = ALIGN(0x10); /* align for .data.adc_c_adcKeyword */
	"adc_x86_64.o"(.data.adc_c_adcKeyword); /* size 0x38 */
	. = ALIGN(0x10); /* align for .data.adcgen */
	"adc_x86_64.o"(.data.adcgen); /* size 0xa0 */
	. = ALIGN(0x4); /* align for .data.adc_c_GetNextTuple_measbound */
	"adc_x86_64.o"(.data.adc_c_GetNextTuple_measbound); /* size 0x4 */
	. = ALIGN(0x8); /* align for .data.input_tuples */
	"dc_x86_64.o"(.data.input_tuples); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.attrnum */
	"dc_x86_64.o"(.data.attrnum); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumS */
	"dc_x86_64.o"(.data.checksumS); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumWlo */
	"dc_x86_64.o"(.data.checksumWlo); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumWhi */
	"dc_x86_64.o"(.data.checksumWhi); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumAlo */
	"dc_x86_64.o"(.data.checksumAlo); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumAhi */
	"dc_x86_64.o"(.data.checksumAhi); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumBlo */
	"dc_x86_64.o"(.data.checksumBlo); /* size 0x8 */
	. = ALIGN(0x8); /* align for .data.checksumBhi */
	"dc_x86_64.o"(.data.checksumBhi); /* size 0x8 */
	. = ALIGN(0x4); /* align for .data.extbuild_c_measbound */
	"extbuild_x86_64.o"(.data.extbuild_c_measbound); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.rbt_c_measbound */
	"rbt_x86_64.o"(.data.rbt_c_measbound); /* size 0x4 */
...
.bss	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x4); /* align for .bss.adc_c_GetNextTuple_tuplenum */
	"adc_x86_64.o"(.bss.adc_c_GetNextTuple_tuplenum); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.adc_c_GetNextTuple_seed */
	"adc_x86_64.o"(.bss.adc_c_GetNextTuple_seed); /* size 0xa0 */
