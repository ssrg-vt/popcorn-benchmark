...
.text	: ALIGN(0x100000)
{
	...
	"blts_x86_64.o"(.text.blts); /* size 0xfa1 */
	. = ALIGN(0x10); /* align for .text.buts */
	"buts_x86_64.o"(.text.buts); /* size 0x11f0 */
	...
	"domain_x86_64.o"(.text.domain); /* size 0x1a4 */
	. = . + 0x3c; /* padding after .text.domain */
	. = ALIGN(0x10); /* align for .text.erhs */
	"erhs_x86_64.o"(.text.erhs); /* size 0x3397 */
	. = ALIGN(0x10); /* align for .text.error */
	"error_x86_64.o"(.text.error); /* size 0x23d */
	. = . + 0x43; /* padding after .text.error */
	. = ALIGN(0x10); /* align for .text.exact */
	"exact_x86_64.o"(.text.exact); /* size 0x1b1 */
	. = . + 0x7; /* padding after .text.exact */
	. = ALIGN(0x10); /* align for .text.jacld */
	"jacld_x86_64.o"(.text.jacld); /* size 0x2eca */
	. = ALIGN(0x10); /* align for .text.jacu */
	"jacu_x86_64.o"(.text.jacu); /* size 0x2dde */
	. = ALIGN(0x10); /* align for .text.l2norm */
	"l2norm_x86_64.o"(.text.l2norm); /* size 0x274 */
	. = . + 0x34; /* padding after .text.l2norm */
	. = ALIGN(0x10); /* align for .text.main */
	"lu_x86_64.o"(.text.main); /* size 0x58f */
	. = ALIGN(0x10); /* align for .text.pintgr */
	"pintgr_x86_64.o"(.text.pintgr); /* size 0xc01 */
	...
	"read_input_x86_64.o"(.text.read_input); /* size 0x4fb */
	. = ALIGN(0x10); /* align for .text.rhs */
	"rhs_x86_64.o"(.text.rhs); /* size 0x33c8 */
	. = ALIGN(0x10); /* align for .text.setbv */
	"setbv_x86_64.o"(.text.setbv); /* size 0x3e3 */
	. = . + 0x65; /* padding after .text.setbv */
	. = ALIGN(0x10); /* align for .text.setcoeff */
	"setcoeff_x86_64.o"(.text.setcoeff); /* size 0x588 */
	. = ALIGN(0x10); /* align for .text.setiv */
	"setiv_x86_64.o"(.text.setiv); /* size 0x320 */
	. = . + 0x40; /* padding after .text.setiv */
	. = ALIGN(0x10); /* align for .text.ssor */
	"ssor_x86_64.o"(.text.ssor); /* size 0xc5e */
	. = . + 0x2; /* padding after .text.ssor */
	. = ALIGN(0x10); /* align for .text.verify */
	"verify_x86_64.o"(.text.verify); /* size 0xf0a */
...
.rodata	: ALIGN(0x100000)
{
	...
	"domain_x86_64.o"(.rodata.domain__str______SUBDO); /* size 0xb1 */
	. = ALIGN(0x4); /* align for .rodata.domain__str_1______SUBDO */
	"domain_x86_64.o"(.rodata.domain__str_1______SUBDO); /* size 0xd9 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"erhs_x86_64.o"(.rodata.cst8); /* size 0x60 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"jacld_x86_64.o"(.rodata.cst8); /* size 0x18 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"jacu_x86_64.o"(.rodata.cst8); /* size 0x30 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"lu_x86_64.o"(.rodata.cst8); /* size 0x40 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_timer_flag */
	"lu_x86_64.o"(.rodata.lu__str_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.lu__str_1_r_ */
	"lu_x86_64.o"(.rodata.lu__str_1_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_2_total_ */
	"lu_x86_64.o"(.rodata.lu__str_2_total_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_3_rhsx_ */
	"lu_x86_64.o"(.rodata.lu__str_3_rhsx_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_4_rhsy_ */
	"lu_x86_64.o"(.rodata.lu__str_4_rhsy_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_5_rhsz_ */
	"lu_x86_64.o"(.rodata.lu__str_5_rhsz_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_6_rhs_ */
	"lu_x86_64.o"(.rodata.lu__str_6_rhs_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_7_jacld_ */
	"lu_x86_64.o"(.rodata.lu__str_7_jacld_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_8_blts_ */
	"lu_x86_64.o"(.rodata.lu__str_8_blts_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_9_jacu_ */
	"lu_x86_64.o"(.rodata.lu__str_9_jacu_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_10_buts_ */
	"lu_x86_64.o"(.rodata.lu__str_10_buts_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_11_add_ */
	"lu_x86_64.o"(.rodata.lu__str_11_add_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_12_l2norm_ */
	"lu_x86_64.o"(.rodata.lu__str_12_l2norm_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_13_goin_to_mi */
	"lu_x86_64.o"(.rodata.lu__str_13_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_14___migrated */
	"lu_x86_64.o"(.rodata.lu__str_14___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_15_LU_ */
	"lu_x86_64.o"(.rodata.lu__str_15_LU_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_16___________ */
	"lu_x86_64.o"(.rodata.lu__str_16___________); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_17_3_3_1_ */
	"lu_x86_64.o"(.rodata.lu__str_17_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_18_03_Nov_201 */
	"lu_x86_64.o"(.rodata.lu__str_18_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.lu__str_19_gcc_ */
	"lu_x86_64.o"(.rodata.lu__str_19_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_20___CC__ */
	"lu_x86_64.o"(.rodata.lu__str_20___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_21__lm_ */
	"lu_x86_64.o"(.rodata.lu__str_21__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_22__I___commo */
	"lu_x86_64.o"(.rodata.lu__str_22__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.lu__str_23__g__Wall__ */
	"lu_x86_64.o"(.rodata.lu__str_23__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.lu__str_24__O3__mcmod */
	"lu_x86_64.o"(.rodata.lu__str_24__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_25__none__ */
	"lu_x86_64.o"(.rodata.lu__str_25__none__); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_26___SECTION_ */
	"lu_x86_64.o"(.rodata.lu__str_26___SECTION_); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.lu__str_27_____8s__9_ */
	"lu_x86_64.o"(.rodata.lu__str_27_____8s__9_); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_28___________ */
	"lu_x86_64.o"(.rodata.lu__str_28___________); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.lu__str_29_sub_rhs_ */
	"lu_x86_64.o"(.rodata.lu__str_29_sub_rhs_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.lu__str_30_rest_rhs_ */
	"lu_x86_64.o"(.rodata.lu__str_30_rest_rhs_); /* size 0x9 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"pintgr_x86_64.o"(.rodata.cst8); /* size 0x10 */
	...
	"read_input_x86_64.o"(.rodata.read_input__str____NAS_Par); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_1_inputlu_da */
	"read_input_x86_64.o"(.rodata.read_input__str_1_inputlu_da); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_2_r_ */
	"read_input_x86_64.o"(.rodata.read_input__str_2_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_3_Reading_fr */
	"read_input_x86_64.o"(.rodata.read_input__str_3_Reading_fr); /* size 0x26 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_4__d_d_ */
	"read_input_x86_64.o"(.rodata.read_input__str_4__d_d_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_5__d_ */
	"read_input_x86_64.o"(.rodata.read_input__str_5__d_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_6__lf_ */
	"read_input_x86_64.o"(.rodata.read_input__str_6__lf_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_7__lf_lf_lf_ */
	"read_input_x86_64.o"(.rodata.read_input__str_7__lf_lf_lf_); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_8__d_d_d_ */
	"read_input_x86_64.o"(.rodata.read_input__str_8__d_d_d_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_9______PROBL */
	"read_input_x86_64.o"(.rodata.read_input__str_9______PROBL); /* size 0x56 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_10______PROBL */
	"read_input_x86_64.o"(.rodata.read_input__str_10______PROBL); /* size 0x73 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_11__Size___4d */
	"read_input_x86_64.o"(.rodata.read_input__str_11__Size___4d); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_12__Iteration */
	"read_input_x86_64.o"(.rodata.read_input__str_12__Iteration); /* size 0x12 */
	. = ALIGN(0x4); /* align for .rodata.read_input__str_13___ */
	"read_input_x86_64.o"(.rodata.read_input__str_13___); /* size 0x2 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"rhs_x86_64.o"(.rodata.cst8); /* size 0x68 */
	. = ALIGN(0x4); /* align for .rodata.ssor__str__Time_step */
	"ssor_x86_64.o"(.rodata.ssor__str__Time_step); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.ssor__str_1____converg */
	"ssor_x86_64.o"(.rodata.ssor__str_1____converg); /* size 0x39 */
	. = ALIGN(0x4); /* align for .rodata.verify__str___Verifica */
	"verify_x86_64.o"(.rodata.verify__str___Verifica); /* size 0x2d */
	...
	"verify_x86_64.o"(.rodata.verify__str_6___________); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_7___________ */
	"verify_x86_64.o"(.rodata.verify__str_7___________); /* size 0x26 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_8__FAILURE__ */
	"verify_x86_64.o"(.rodata.verify__str_8__FAILURE__); /* size 0x26 */
	...
	"verify_x86_64.o"(.rodata.verify__str_11__Compariso); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_12__Surface_i */
	"verify_x86_64.o"(.rodata.verify__str_12__Surface_i); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_13___________ */
	"verify_x86_64.o"(.rodata.verify__str_13___________); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_14___________ */
	"verify_x86_64.o"(.rodata.verify__str_14___________); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_15__FAILURE__ */
	"verify_x86_64.o"(.rodata.verify__str_15__FAILURE__); /* size 0x25 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_16__No_refere */
	"verify_x86_64.o"(.rodata.verify__str_16__No_refere); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.verify__str_17_No_verific */
	"verify_x86_64.o"(.rodata.verify__str_17_No_verific); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.verify__str_18__Verificat */
	"verify_x86_64.o"(.rodata.verify__str_18__Verificat); /* size 0x1a */
	. = ALIGN(0x4); /* align for .rodata.verify__str_19__Verificat */
	"verify_x86_64.o"(.rodata.verify__str_19__Verificat); /* size 0x16 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"blts_x86_64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"buts_x86_64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"jacld_x86_64.o"(.rodata.cst16); /* size 0x10 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"jacu_x86_64.o"(.rodata.cst16); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"print_results_x86_64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"randdp_x86_64.o"(.rodata.cst8); /* size 0x28 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"rhs_x86_64.o"(.rodata.cst16); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"setcoeff_x86_64.o"(.rodata.cst8); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"setiv_x86_64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"ssor_x86_64.o"(.rodata.cst8); /* size 0x10 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
...
.bss	: ALIGN(0x100000)
{
	...
	"lu_x86_64.o"(.bss.timeron); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.itmax */
	"lu_x86_64.o"(.bss.itmax); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.rsdnm */
	"lu_x86_64.o"(.bss.rsdnm); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.errnm */
	"lu_x86_64.o"(.bss.errnm); /* size 0x28 */
	. = ALIGN(0x8); /* align for .bss.frc */
	"lu_x86_64.o"(.bss.frc); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.nx0 */
	"lu_x86_64.o"(.bss.nx0); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ny0 */
	"lu_x86_64.o"(.bss.ny0); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.nz0 */
	"lu_x86_64.o"(.bss.nz0); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.maxtime */
	"lu_x86_64.o"(.bss.maxtime); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dxi */
	"lu_x86_64.o"(.bss.dxi); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.deta */
	"lu_x86_64.o"(.bss.deta); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dzeta */
	"lu_x86_64.o"(.bss.dzeta); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tx1 */
	"lu_x86_64.o"(.bss.tx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tx2 */
	"lu_x86_64.o"(.bss.tx2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tx3 */
	"lu_x86_64.o"(.bss.tx3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.ty1 */
	"lu_x86_64.o"(.bss.ty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.ty2 */
	"lu_x86_64.o"(.bss.ty2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.ty3 */
	"lu_x86_64.o"(.bss.ty3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tz1 */
	"lu_x86_64.o"(.bss.tz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tz2 */
	"lu_x86_64.o"(.bss.tz2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tz3 */
	"lu_x86_64.o"(.bss.tz3); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.nx */
	"lu_x86_64.o"(.bss.nx); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ny */
	"lu_x86_64.o"(.bss.ny); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.nz */
	"lu_x86_64.o"(.bss.nz); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ist */
	"lu_x86_64.o"(.bss.ist); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.iend */
	"lu_x86_64.o"(.bss.iend); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.jst */
	"lu_x86_64.o"(.bss.jst); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.jend */
	"lu_x86_64.o"(.bss.jend); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ii1 */
	"lu_x86_64.o"(.bss.ii1); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ii2 */
	"lu_x86_64.o"(.bss.ii2); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ji1 */
	"lu_x86_64.o"(.bss.ji1); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ji2 */
	"lu_x86_64.o"(.bss.ji2); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ki1 */
	"lu_x86_64.o"(.bss.ki1); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.ki2 */
	"lu_x86_64.o"(.bss.ki2); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.dx1 */
	"lu_x86_64.o"(.bss.dx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx2 */
	"lu_x86_64.o"(.bss.dx2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx3 */
	"lu_x86_64.o"(.bss.dx3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx4 */
	"lu_x86_64.o"(.bss.dx4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx5 */
	"lu_x86_64.o"(.bss.dx5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy1 */
	"lu_x86_64.o"(.bss.dy1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy2 */
	"lu_x86_64.o"(.bss.dy2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy3 */
	"lu_x86_64.o"(.bss.dy3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy4 */
	"lu_x86_64.o"(.bss.dy4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy5 */
	"lu_x86_64.o"(.bss.dy5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz1 */
	"lu_x86_64.o"(.bss.dz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz2 */
	"lu_x86_64.o"(.bss.dz2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz3 */
	"lu_x86_64.o"(.bss.dz3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz4 */
	"lu_x86_64.o"(.bss.dz4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz5 */
	"lu_x86_64.o"(.bss.dz5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dssp */
	"lu_x86_64.o"(.bss.dssp); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.u */
	"lu_x86_64.o"(.bss.u); /* size 0xa50a00 */
	. = ALIGN(0x10); /* align for .bss.rsd */
	"lu_x86_64.o"(.bss.rsd); /* size 0xa50a00 */
	. = ALIGN(0x10); /* align for .bss.frct */
	"lu_x86_64.o"(.bss.frct); /* size 0xa50a00 */
	. = ALIGN(0x10); /* align for .bss.flux */
	"lu_x86_64.o"(.bss.flux); /* size 0xa00 */
	. = ALIGN(0x10); /* align for .bss.qs */
	"lu_x86_64.o"(.bss.qs); /* size 0x210200 */
	. = ALIGN(0x10); /* align for .bss.rho_i */
	"lu_x86_64.o"(.bss.rho_i); /* size 0x210200 */
	. = ALIGN(0x4); /* align for .bss.ipr */
	"lu_x86_64.o"(.bss.ipr); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.inorm */
	"lu_x86_64.o"(.bss.inorm); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.dt */
	"lu_x86_64.o"(.bss.dt); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.omega */
	"lu_x86_64.o"(.bss.omega); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.tolrsd */
	"lu_x86_64.o"(.bss.tolrsd); /* size 0x28 */
	. = ALIGN(0x8); /* align for .bss.ttotal */
	"lu_x86_64.o"(.bss.ttotal); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.invert */
	"lu_x86_64.o"(.bss.invert); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.a */
	"lu_x86_64.o"(.bss.a); /* size 0xcb200 */
	. = ALIGN(0x10); /* align for .bss.b */
	"lu_x86_64.o"(.bss.b); /* size 0xcb200 */
	. = ALIGN(0x10); /* align for .bss.c */
	"lu_x86_64.o"(.bss.c); /* size 0xcb200 */
	. = ALIGN(0x10); /* align for .bss.d */
	"lu_x86_64.o"(.bss.d); /* size 0xcb200 */
	. = ALIGN(0x10); /* align for .bss.ce */
	"lu_x86_64.o"(.bss.ce); /* size 0x208 */
