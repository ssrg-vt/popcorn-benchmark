...
.text	: ALIGN(0x100000)
{
	...
	"is_x86_64.o"(.text.randlc); /* size 0x2c6 */
	. = ALIGN(0x10); /* align for .text.create_seq */
	"is_x86_64.o"(.text.create_seq); /* size 0xfd */
	. = ALIGN(0x10); /* align for .text.full_verify */
	"is_x86_64.o"(.text.full_verify); /* size 0x121 */
	. = . + 0x17; /* padding after .text.full_verify */
	. = ALIGN(0x10); /* align for .text.rank */
	"is_x86_64.o"(.text.rank); /* size 0x448 */
	. = . + 0x54; /* padding after .text.rank */
	. = ALIGN(0x10); /* align for .text.main */
	"is_x86_64.o"(.text.main); /* size 0x4ec */
...
.rodata	: ALIGN(0x100000)
{
	...
	"is_x86_64.o"(.rodata.cst8); /* size 0x30 */
	. = ALIGN(0x4); /* align for .rodata.is__str_Full_verif */
	"is_x86_64.o"(.rodata.is__str_Full_verif); /* size 0x2e */
	. = ALIGN(0x4); /* align for .rodata.is__str_1_Failed_par */
	"is_x86_64.o"(.rodata.is__str_1_Failed_par); /* size 0x38 */
	. = ALIGN(0x4); /* align for .rodata.is__str_2_timer_flag */
	"is_x86_64.o"(.rodata.is__str_2_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.is__str_3_r_ */
	"is_x86_64.o"(.rodata.is__str_3_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.is__str_4____NAS_Par */
	"is_x86_64.o"(.rodata.is__str_4____NAS_Par); /* size 0x39 */
	. = ALIGN(0x4); /* align for .rodata.is__str_5__Size____l */
	"is_x86_64.o"(.rodata.is__str_5__Size____l); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.is__str_6__Iteration */
	"is_x86_64.o"(.rodata.is__str_6__Iteration); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.is__str_7_____iterat */
	"is_x86_64.o"(.rodata.is__str_7_____iterat); /* size 0xf */
	. = ALIGN(0x4); /* align for .rodata.is__str_8_goin_to_mi */
	"is_x86_64.o"(.rodata.is__str_8_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.is__str_9__________d */
	"is_x86_64.o"(.rodata.is__str_9__________d); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.is__str_10___migrated */
	"is_x86_64.o"(.rodata.is__str_10___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.is__str_11_IS_ */
	"is_x86_64.o"(.rodata.is__str_11_IS_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.is__str_12_keys_ranke */
	"is_x86_64.o"(.rodata.is__str_12_keys_ranke); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.is__str_13_3_3_1_ */
	"is_x86_64.o"(.rodata.is__str_13_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.is__str_14_03_Nov_201 */
	"is_x86_64.o"(.rodata.is__str_14_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.is__str_15_gcc_ */
	"is_x86_64.o"(.rodata.is__str_15_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.is__str_16___CC__ */
	"is_x86_64.o"(.rodata.is__str_16___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.is__str_17__lm_ */
	"is_x86_64.o"(.rodata.is__str_17__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.is__str_18__I___commo */
	"is_x86_64.o"(.rodata.is__str_18__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.is__str_19__g__Wall__ */
	"is_x86_64.o"(.rodata.is__str_19__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.is__str_20__O3__mcmod */
	"is_x86_64.o"(.rodata.is__str_20__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.is__str_21__Additiona */
	"is_x86_64.o"(.rodata.is__str_21__Additiona); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.is__str_22__Total_exe */
	"is_x86_64.o"(.rodata.is__str_22__Total_exe); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.is__str_23__Initializ */
	"is_x86_64.o"(.rodata.is__str_23__Initializ); /* size 0x23 */
	. = ALIGN(0x4); /* align for .rodata.is__str_24__Benchmark */
	"is_x86_64.o"(.rodata.is__str_24__Benchmark); /* size 0x23 */
	. = ALIGN(0x4); /* align for .rodata.is__str_25__Sorting__ */
	"is_x86_64.o"(.rodata.is__str_25__Sorting__); /* size 0x23 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:floatscan.o"(.rodata.cst8); /* size 0x20 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
...
.data	: ALIGN(0x100000)
{
	...
	"is_x86_64.o"(.data.S_test_index_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.S_test_rank_array */
	"is_x86_64.o"(.data.S_test_rank_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.W_test_index_array */
	"is_x86_64.o"(.data.W_test_index_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.W_test_rank_array */
	"is_x86_64.o"(.data.W_test_rank_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.A_test_index_array */
	"is_x86_64.o"(.data.A_test_index_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.A_test_rank_array */
	"is_x86_64.o"(.data.A_test_rank_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.B_test_index_array */
	"is_x86_64.o"(.data.B_test_index_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.B_test_rank_array */
	"is_x86_64.o"(.data.B_test_rank_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.C_test_index_array */
	"is_x86_64.o"(.data.C_test_index_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.C_test_rank_array */
	"is_x86_64.o"(.data.C_test_rank_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.D_test_index_array */
	"is_x86_64.o"(.data.D_test_index_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .data.D_test_rank_array */
	"is_x86_64.o"(.data.D_test_rank_array); /* size 0x14 */
...
.bss	: ALIGN(0x100000)
{
	...
	"is_x86_64.o"(.bss.is_c_randlc_KS); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.is_c_randlc_R23 */
	"is_x86_64.o"(.bss.is_c_randlc_R23); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.is_c_randlc_R46 */
	"is_x86_64.o"(.bss.is_c_randlc_R46); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.is_c_randlc_T23 */
	"is_x86_64.o"(.bss.is_c_randlc_T23); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.is_c_randlc_T46 */
	"is_x86_64.o"(.bss.is_c_randlc_T46); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.key_array */
	"is_x86_64.o"(.bss.key_array); /* size 0x2000000 */
	. = ALIGN(0x10); /* align for .bss.key_buff2 */
	"is_x86_64.o"(.bss.key_buff2); /* size 0x2000000 */
	. = ALIGN(0x8); /* align for .bss.key_buff_ptr_global */
	"is_x86_64.o"(.bss.key_buff_ptr_global); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.passed_verification */
	"is_x86_64.o"(.bss.passed_verification); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.test_index_array */
	"is_x86_64.o"(.bss.test_index_array); /* size 0x14 */
	. = ALIGN(0x10); /* align for .bss.partial_verify_vals */
	"is_x86_64.o"(.bss.partial_verify_vals); /* size 0x14 */
	. = ALIGN(0x10); /* align for .bss.bucket_size */
	"is_x86_64.o"(.bss.bucket_size); /* size 0x1000 */
	. = ALIGN(0x10); /* align for .bss.bucket_ptrs */
	"is_x86_64.o"(.bss.bucket_ptrs); /* size 0x1000 */
	. = ALIGN(0x10); /* align for .bss.key_buff1 */
	"is_x86_64.o"(.bss.key_buff1); /* size 0x200000 */
	. = ALIGN(0x10); /* align for .bss.test_rank_array */
	"is_x86_64.o"(.bss.test_rank_array); /* size 0x14 */
