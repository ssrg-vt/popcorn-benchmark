...
.text	: ALIGN(0x100000)
{
	...
	"add_aarch64.o"(.text.add); /* size 0x1b0 */
	. = ALIGN(0x10); /* align for .text.adi */
	"adi_aarch64.o"(.text.adi); /* size 0x30 */
	. = . + 0x2; /* padding after .text.adi */
	. = ALIGN(0x10); /* align for .text.main */
	"bt_aarch64.o"(.text.main); /* size 0x8d0 */
	. = . + 0x6c; /* padding after .text.main */
	...
	"error_aarch64.o"(.text.rhs_norm); /* size 0x270 */
	...
	"initialize_aarch64.o"(.text.initialize); /* size 0xcb8 */
	. = ALIGN(0x10); /* align for .text.lhsinit */
	"initialize_aarch64.o"(.text.lhsinit); /* size 0x1e8 */
	. = . + 0xc; /* padding after .text.lhsinit */
	...
	"rhs_aarch64.o"(.text.compute_rhs); /* size 0x2c90 */
	. = . + 0x400; /* padding after .text.compute_rhs */
	. = ALIGN(0x10); /* align for .text.set_constants */
	"set_constants_aarch64.o"(.text.set_constants); /* size 0x9c8 */
	. = . + 0x2ab; /* padding after .text.set_constants */
	. = ALIGN(0x10); /* align for .text.matvec_sub */
	"solve_subs_aarch64.o"(.text.matvec_sub); /* size 0x24c */
	. = . + 0x36; /* padding after .text.matvec_sub */
	. = ALIGN(0x10); /* align for .text.matmul_sub */
	"solve_subs_aarch64.o"(.text.matmul_sub); /* size 0xa1c */
	. = . + 0x24b; /* padding after .text.matmul_sub */
	. = ALIGN(0x10); /* align for .text.binvcrhs */
	"solve_subs_aarch64.o"(.text.binvcrhs); /* size 0x163c */
	. = . + 0x5a1; /* padding after .text.binvcrhs */
	. = ALIGN(0x10); /* align for .text.binvrhs */
	"solve_subs_aarch64.o"(.text.binvrhs); /* size 0x948 */
	. = . + 0x25f; /* padding after .text.binvrhs */
	...
	"x_solve_aarch64.o"(.text.x_solve); /* size 0x1eac */
	. = . + 0x76e; /* padding after .text.x_solve */
	. = ALIGN(0x10); /* align for .text.y_solve */
	"y_solve_aarch64.o"(.text.y_solve); /* size 0x1ec0 */
	. = . + 0x776; /* padding after .text.y_solve */
	. = ALIGN(0x10); /* align for .text.z_solve */
	"z_solve_aarch64.o"(.text.z_solve); /* size 0x1edc */
	. = . + 0x773; /* padding after .text.z_solve */
...
.rodata	: ALIGN(0x100000)
{
	...
	"bt_aarch64.o"(.rodata.cst8); /* size 0x20 */
	. = . + 0x10; /* padding after .rodata.cst8 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_timer_flag */
	"bt_aarch64.o"(.rodata.bt__str_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.bt__str_1_r_ */
	"bt_aarch64.o"(.rodata.bt__str_1_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_2_total_ */
	"bt_aarch64.o"(.rodata.bt__str_2_total_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_3_rhsx_ */
	"bt_aarch64.o"(.rodata.bt__str_3_rhsx_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_4_rhsy_ */
	"bt_aarch64.o"(.rodata.bt__str_4_rhsy_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_5_rhsz_ */
	"bt_aarch64.o"(.rodata.bt__str_5_rhsz_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_6_rhs_ */
	"bt_aarch64.o"(.rodata.bt__str_6_rhs_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_7_xsolve_ */
	"bt_aarch64.o"(.rodata.bt__str_7_xsolve_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_8_ysolve_ */
	"bt_aarch64.o"(.rodata.bt__str_8_ysolve_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_9_zsolve_ */
	"bt_aarch64.o"(.rodata.bt__str_9_zsolve_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_10_redist1_ */
	"bt_aarch64.o"(.rodata.bt__str_10_redist1_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_11_redist2_ */
	"bt_aarch64.o"(.rodata.bt__str_11_redist2_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_12_add_ */
	"bt_aarch64.o"(.rodata.bt__str_12_add_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_13____NAS_Par */
	"bt_aarch64.o"(.rodata.bt__str_13____NAS_Par); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.bt__str_14_inputbt_da */
	"bt_aarch64.o"(.rodata.bt__str_14_inputbt_da); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.bt__str_15__Reading_f */
	"bt_aarch64.o"(.rodata.bt__str_15__Reading_f); /* size 0x27 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_16__d_ */
	"bt_aarch64.o"(.rodata.bt__str_16__d_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_17__lf_ */
	"bt_aarch64.o"(.rodata.bt__str_17__lf_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_18__d_d_d__ */
	"bt_aarch64.o"(.rodata.bt__str_18__d_d_d__); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_19__No_input_ */
	"bt_aarch64.o"(.rodata.bt__str_19__No_input_); /* size 0x36 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_20__Size___4d */
	"bt_aarch64.o"(.rodata.bt__str_20__Size___4d); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_21__Iteration */
	"bt_aarch64.o"(.rodata.bt__str_21__Iteration); /* size 0x20 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_22___ */
	"bt_aarch64.o"(.rodata.bt__str_22___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_23___d___d___ */
	"bt_aarch64.o"(.rodata.bt__str_23___d___d___); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.bt__str_24__Problem_s */
	"bt_aarch64.o"(.rodata.bt__str_24__Problem_s); /* size 0x30 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_25_goin_to_mi */
	"bt_aarch64.o"(.rodata.bt__str_25_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_26__Time_step */
	"bt_aarch64.o"(.rodata.bt__str_26__Time_step); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_27___migrated */
	"bt_aarch64.o"(.rodata.bt__str_27___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_28_BT_ */
	"bt_aarch64.o"(.rodata.bt__str_28_BT_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_29___________ */
	"bt_aarch64.o"(.rodata.bt__str_29___________); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_30_3_3_1_ */
	"bt_aarch64.o"(.rodata.bt__str_30_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_31_03_Nov_201 */
	"bt_aarch64.o"(.rodata.bt__str_31_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.bt__str_32_gcc_ */
	"bt_aarch64.o"(.rodata.bt__str_32_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_33___CC__ */
	"bt_aarch64.o"(.rodata.bt__str_33___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_34__lm_ */
	"bt_aarch64.o"(.rodata.bt__str_34__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_35__I___commo */
	"bt_aarch64.o"(.rodata.bt__str_35__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.bt__str_36__g__Wall__ */
	"bt_aarch64.o"(.rodata.bt__str_36__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.bt__str_37__O3__mcmod */
	"bt_aarch64.o"(.rodata.bt__str_37__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_38__none__ */
	"bt_aarch64.o"(.rodata.bt__str_38__none__); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_39___SECTION_ */
	"bt_aarch64.o"(.rodata.bt__str_39___SECTION_); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_40_____8s__9_ */
	"bt_aarch64.o"(.rodata.bt__str_40_____8s__9_); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_41__________8 */
	"bt_aarch64.o"(.rodata.bt__str_41__________8); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.bt__str_42_sub_rhs_ */
	"bt_aarch64.o"(.rodata.bt__str_42_sub_rhs_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_43_rest_rhs_ */
	"bt_aarch64.o"(.rodata.bt__str_43_rest_rhs_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_44_sub_zsol_ */
	"bt_aarch64.o"(.rodata.bt__str_44_sub_zsol_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.bt__str_45_redist_ */
	"bt_aarch64.o"(.rodata.bt__str_45_redist_); /* size 0x7 */
...
.bss	: ALIGN(0x100000)
{
	...
	"bt_aarch64.o"(.bss.timeron); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.dt */
	"bt_aarch64.o"(.bss.dt); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.grid_points */
	"bt_aarch64.o"(.bss.grid_points); /* size 0xc */
	. = ALIGN(0x8); /* align for .bss.elapsed_time */
	"bt_aarch64.o"(.bss.elapsed_time); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tx1 */
	"bt_aarch64.o"(.bss.tx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tx2 */
	"bt_aarch64.o"(.bss.tx2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tx3 */
	"bt_aarch64.o"(.bss.tx3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.ty1 */
	"bt_aarch64.o"(.bss.ty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.ty2 */
	"bt_aarch64.o"(.bss.ty2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.ty3 */
	"bt_aarch64.o"(.bss.ty3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tz1 */
	"bt_aarch64.o"(.bss.tz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tz2 */
	"bt_aarch64.o"(.bss.tz2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tz3 */
	"bt_aarch64.o"(.bss.tz3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx1 */
	"bt_aarch64.o"(.bss.dx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx2 */
	"bt_aarch64.o"(.bss.dx2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx3 */
	"bt_aarch64.o"(.bss.dx3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx4 */
	"bt_aarch64.o"(.bss.dx4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx5 */
	"bt_aarch64.o"(.bss.dx5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy1 */
	"bt_aarch64.o"(.bss.dy1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy2 */
	"bt_aarch64.o"(.bss.dy2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy3 */
	"bt_aarch64.o"(.bss.dy3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy4 */
	"bt_aarch64.o"(.bss.dy4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy5 */
	"bt_aarch64.o"(.bss.dy5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz1 */
	"bt_aarch64.o"(.bss.dz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz2 */
	"bt_aarch64.o"(.bss.dz2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz3 */
	"bt_aarch64.o"(.bss.dz3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz4 */
	"bt_aarch64.o"(.bss.dz4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz5 */
	"bt_aarch64.o"(.bss.dz5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dssp */
	"bt_aarch64.o"(.bss.dssp); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.ce */
	"bt_aarch64.o"(.bss.ce); /* size 0x208 */
	. = ALIGN(0x8); /* align for .bss.dxmax */
	"bt_aarch64.o"(.bss.dxmax); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dymax */
	"bt_aarch64.o"(.bss.dymax); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dzmax */
	"bt_aarch64.o"(.bss.dzmax); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.xxcon1 */
	"bt_aarch64.o"(.bss.xxcon1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.xxcon2 */
	"bt_aarch64.o"(.bss.xxcon2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.xxcon3 */
	"bt_aarch64.o"(.bss.xxcon3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.xxcon4 */
	"bt_aarch64.o"(.bss.xxcon4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.xxcon5 */
	"bt_aarch64.o"(.bss.xxcon5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx1tx1 */
	"bt_aarch64.o"(.bss.dx1tx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx2tx1 */
	"bt_aarch64.o"(.bss.dx2tx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx3tx1 */
	"bt_aarch64.o"(.bss.dx3tx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx4tx1 */
	"bt_aarch64.o"(.bss.dx4tx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dx5tx1 */
	"bt_aarch64.o"(.bss.dx5tx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.yycon1 */
	"bt_aarch64.o"(.bss.yycon1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.yycon2 */
	"bt_aarch64.o"(.bss.yycon2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.yycon3 */
	"bt_aarch64.o"(.bss.yycon3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.yycon4 */
	"bt_aarch64.o"(.bss.yycon4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.yycon5 */
	"bt_aarch64.o"(.bss.yycon5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy1ty1 */
	"bt_aarch64.o"(.bss.dy1ty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy2ty1 */
	"bt_aarch64.o"(.bss.dy2ty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy3ty1 */
	"bt_aarch64.o"(.bss.dy3ty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy4ty1 */
	"bt_aarch64.o"(.bss.dy4ty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dy5ty1 */
	"bt_aarch64.o"(.bss.dy5ty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.zzcon1 */
	"bt_aarch64.o"(.bss.zzcon1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.zzcon2 */
	"bt_aarch64.o"(.bss.zzcon2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.zzcon3 */
	"bt_aarch64.o"(.bss.zzcon3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.zzcon4 */
	"bt_aarch64.o"(.bss.zzcon4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.zzcon5 */
	"bt_aarch64.o"(.bss.zzcon5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz1tz1 */
	"bt_aarch64.o"(.bss.dz1tz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz2tz1 */
	"bt_aarch64.o"(.bss.dz2tz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz3tz1 */
	"bt_aarch64.o"(.bss.dz3tz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz4tz1 */
	"bt_aarch64.o"(.bss.dz4tz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dz5tz1 */
	"bt_aarch64.o"(.bss.dz5tz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dnxm1 */
	"bt_aarch64.o"(.bss.dnxm1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dnym1 */
	"bt_aarch64.o"(.bss.dnym1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dnzm1 */
	"bt_aarch64.o"(.bss.dnzm1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c1c2 */
	"bt_aarch64.o"(.bss.c1c2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c1c5 */
	"bt_aarch64.o"(.bss.c1c5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c3c4 */
	"bt_aarch64.o"(.bss.c3c4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c1345 */
	"bt_aarch64.o"(.bss.c1345); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.conz1 */
	"bt_aarch64.o"(.bss.conz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c1 */
	"bt_aarch64.o"(.bss.c1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c2 */
	"bt_aarch64.o"(.bss.c2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c3 */
	"bt_aarch64.o"(.bss.c3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c4 */
	"bt_aarch64.o"(.bss.c4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c5 */
	"bt_aarch64.o"(.bss.c5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c4dssp */
	"bt_aarch64.o"(.bss.c4dssp); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c5dssp */
	"bt_aarch64.o"(.bss.c5dssp); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dtdssp */
	"bt_aarch64.o"(.bss.dtdssp); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dttx1 */
	"bt_aarch64.o"(.bss.dttx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dttx2 */
	"bt_aarch64.o"(.bss.dttx2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dtty1 */
	"bt_aarch64.o"(.bss.dtty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dtty2 */
	"bt_aarch64.o"(.bss.dtty2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dttz1 */
	"bt_aarch64.o"(.bss.dttz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dttz2 */
	"bt_aarch64.o"(.bss.dttz2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c2dttx1 */
	"bt_aarch64.o"(.bss.c2dttx1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c2dtty1 */
	"bt_aarch64.o"(.bss.c2dtty1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c2dttz1 */
	"bt_aarch64.o"(.bss.c2dttz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.comz1 */
	"bt_aarch64.o"(.bss.comz1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.comz4 */
	"bt_aarch64.o"(.bss.comz4); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.comz5 */
	"bt_aarch64.o"(.bss.comz5); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.comz6 */
	"bt_aarch64.o"(.bss.comz6); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c3c4tx3 */
	"bt_aarch64.o"(.bss.c3c4tx3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c3c4ty3 */
	"bt_aarch64.o"(.bss.c3c4ty3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c3c4tz3 */
	"bt_aarch64.o"(.bss.c3c4tz3); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.c2iv */
	"bt_aarch64.o"(.bss.c2iv); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.con43 */
	"bt_aarch64.o"(.bss.con43); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.con16 */
	"bt_aarch64.o"(.bss.con16); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.us */
	"bt_aarch64.o"(.bss.us); /* size 0x210200 */
	. = ALIGN(0x10); /* align for .bss.vs */
	"bt_aarch64.o"(.bss.vs); /* size 0x210200 */
	. = ALIGN(0x10); /* align for .bss.ws */
	"bt_aarch64.o"(.bss.ws); /* size 0x210200 */
	. = ALIGN(0x10); /* align for .bss.qs */
	"bt_aarch64.o"(.bss.qs); /* size 0x210200 */
	. = ALIGN(0x10); /* align for .bss.rho_i */
	"bt_aarch64.o"(.bss.rho_i); /* size 0x210200 */
	. = ALIGN(0x10); /* align for .bss.square */
	"bt_aarch64.o"(.bss.square); /* size 0x210200 */
	. = ALIGN(0x10); /* align for .bss.forcing */
	"bt_aarch64.o"(.bss.forcing); /* size 0xa50a00 */
	. = ALIGN(0x10); /* align for .bss.u */
	"bt_aarch64.o"(.bss.u); /* size 0xa50a00 */
	. = ALIGN(0x10); /* align for .bss.rhs */
	"bt_aarch64.o"(.bss.rhs); /* size 0xa50a00 */
	. = ALIGN(0x10); /* align for .bss.cuf */
	"bt_aarch64.o"(.bss.cuf); /* size 0x208 */
	. = ALIGN(0x10); /* align for .bss.q */
	"bt_aarch64.o"(.bss.q); /* size 0x208 */
	. = ALIGN(0x10); /* align for .bss.ue */
	"bt_aarch64.o"(.bss.ue); /* size 0xa28 */
	. = ALIGN(0x10); /* align for .bss.buf */
	"bt_aarch64.o"(.bss.buf); /* size 0xa28 */
	. = ALIGN(0x10); /* align for .bss.fjac */
	"bt_aarch64.o"(.bss.fjac); /* size 0x32c8 */
	. = ALIGN(0x10); /* align for .bss.njac */
	"bt_aarch64.o"(.bss.njac); /* size 0x32c8 */
	. = ALIGN(0x10); /* align for .bss.lhs */
	"bt_aarch64.o"(.bss.lhs); /* size 0x9858 */
	. = ALIGN(0x8); /* align for .bss.tmp1 */
	"bt_aarch64.o"(.bss.tmp1); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tmp2 */
	"bt_aarch64.o"(.bss.tmp2); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.tmp3 */
	"bt_aarch64.o"(.bss.tmp3); /* size 0x8 */
