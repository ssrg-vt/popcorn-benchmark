...
.text	: ALIGN(0x100000)
{
	...
	"appft_x86_64.o"(.text.appft); /* size 0x80d */
	. = ALIGN(0x10); /* align for .text.CompExp */
	"auxfnct_x86_64.o"(.text.CompExp); /* size 0x18c */
	. = . + 0x28; /* padding after .text.CompExp */
	. = ALIGN(0x10); /* align for .text.ilog2 */
	"auxfnct_x86_64.o"(.text.ilog2); /* size 0x90 */
	. = . + 0x20; /* padding after .text.ilog2 */
	. = ALIGN(0x10); /* align for .text.CalculateChecksum */
	"auxfnct_x86_64.o"(.text.CalculateChecksum); /* size 0x1bf */
	. = . + 0x25; /* padding after .text.CalculateChecksum */
	. = ALIGN(0x10); /* align for .text.compute_initial_conditions */
	"auxfnct_x86_64.o"(.text.compute_initial_conditions); /* size 0x2a4 */
	. = ALIGN(0x10); /* align for .text.ipow46 */
	"auxfnct_x86_64.o"(.text.ipow46); /* size 0x149 */
	. = ALIGN(0x10); /* align for .text.evolve */
	"auxfnct_x86_64.o"(.text.evolve); /* size 0x227 */
	...
	"fft3d_x86_64.o"(.text.fftXYZ); /* size 0x843 */
	. = ALIGN(0x10); /* align for .text.Swarztrauber */
	"fft3d_x86_64.o"(.text.Swarztrauber); /* size 0x9a2 */
	. = ALIGN(0x10); /* align for .text.main */
	"mainft_x86_64.o"(.text.main); /* size 0x23f */
	. = . + 0x15; /* padding after .text.main */
	. = ALIGN(0x10); /* align for .text.getclass */
	"mainft_x86_64.o"(.text.getclass); /* size 0x11 */
	. = . + 0xf; /* padding after .text.getclass */
	...
	"verify_x86_64.o"(.text.verify); /* size 0x1adf */
	. = ALIGN(0x10); /* align for .text.dcmplx_div */
	"verify_x86_64.o"(.text.dcmplx_div); /* size 0x145 */
	...
	"/usr/local/popcorn/x86_64/lib/libc.a:exp.o"(.text.exp); /* size 0x1a5 */
	. = . + 0x27; /* padding after .text.exp */
	...
	"/usr/local/popcorn/x86_64/lib/libc.a:sin.o"(.text.sin); /* size 0xd8 */
	. = . + 0x20; /* padding after .text.sin */
...
.rodata	: ALIGN(0x100000)
{
	...
	"appft_x86_64.o"(.rodata.appft__str_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.appft__str_1___migrated */
	"appft_x86_64.o"(.rodata.appft__str_1___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.appft__str_2__FT_subrou */
	"appft_x86_64.o"(.rodata.appft__str_2__FT_subrou); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.appft__str_3___26s___9_ */
	"appft_x86_64.o"(.rodata.appft__str_3___26s___9_); /* size 0xe */
	. = ALIGN(0x4); /* align for .rodata.appft__str_4_FT_total__ */
	"appft_x86_64.o"(.rodata.appft__str_4_FT_total__); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_5_WarmUp_tim */
	"appft_x86_64.o"(.rodata.appft__str_5_WarmUp_tim); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_6_fftXYZ_bod */
	"appft_x86_64.o"(.rodata.appft__str_6_fftXYZ_bod); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_7_Swarztraub */
	"appft_x86_64.o"(.rodata.appft__str_7_Swarztraub); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_8_X_time____ */
	"appft_x86_64.o"(.rodata.appft__str_8_X_time____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_9_Y_time____ */
	"appft_x86_64.o"(.rodata.appft__str_9_Y_time____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_10_Z_time____ */
	"appft_x86_64.o"(.rodata.appft__str_10_Z_time____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_11_CalculateC */
	"appft_x86_64.o"(.rodata.appft__str_11_CalculateC); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_12_evolve____ */
	"appft_x86_64.o"(.rodata.appft__str_12_evolve____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_13_compute_in */
	"appft_x86_64.o"(.rodata.appft__str_13_compute_in); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_14_twiddle___ */
	"appft_x86_64.o"(.rodata.appft__str_14_twiddle___); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_15_verify____ */
	"appft_x86_64.o"(.rodata.appft__str_15_verify____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_16_fftXYZ____ */
	"appft_x86_64.o"(.rodata.appft__str_16_fftXYZ____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_17_Benchmark_ */
	"appft_x86_64.o"(.rodata.appft__str_17_Benchmark_); /* size 0x1b */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"auxfnct_x86_64.o"(.rodata.cst8); /* size 0x10 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"mainft_x86_64.o"(.rodata.cst8); /* size 0x30 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_timer_flag */
	"mainft_x86_64.o"(.rodata.mainft__str_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_1_r_ */
	"mainft_x86_64.o"(.rodata.mainft__str_1_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_2____NAS_Par */
	"mainft_x86_64.o"(.rodata.mainft__str_2____NAS_Par); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_3__Size_____ */
	"mainft_x86_64.o"(.rodata.mainft__str_3__Size_____); /* size 0x24 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_4__Iteration */
	"mainft_x86_64.o"(.rodata.mainft__str_4__Iteration); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_5___ */
	"mainft_x86_64.o"(.rodata.mainft__str_5___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_6_FT_ */
	"mainft_x86_64.o"(.rodata.mainft__str_6_FT_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_7___________ */
	"mainft_x86_64.o"(.rodata.mainft__str_7___________); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_8_3_3_1_ */
	"mainft_x86_64.o"(.rodata.mainft__str_8_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_9_03_Nov_201 */
	"mainft_x86_64.o"(.rodata.mainft__str_9_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_10_gcc_ */
	"mainft_x86_64.o"(.rodata.mainft__str_10_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_11___CC__ */
	"mainft_x86_64.o"(.rodata.mainft__str_11___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_12__lm_ */
	"mainft_x86_64.o"(.rodata.mainft__str_12__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_13__I___commo */
	"mainft_x86_64.o"(.rodata.mainft__str_13__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_14__g__Wall__ */
	"mainft_x86_64.o"(.rodata.mainft__str_14__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_15__O3__mcmod */
	"mainft_x86_64.o"(.rodata.mainft__str_15__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_16_randdp_ */
	"mainft_x86_64.o"(.rodata.mainft__str_16_randdp_); /* size 0x7 */
	...
	"verify_x86_64.o"(.rodata.verify__str___Verifica); /* size 0x2a */
	. = ALIGN(0x4); /* align for .rodata.verify__str_1__Verificat */
	"verify_x86_64.o"(.rodata.verify__str_1__Verificat); /* size 0x26 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_2__Verificat */
	"verify_x86_64.o"(.rodata.verify__str_2__Verificat); /* size 0x22 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:exp.o"(.rodata.cst8); /* size 0x68 */
	. = ALIGN(0x10); /* align for .rodata.src_math_exp_c_half */
	"/usr/local/popcorn/x86_64/lib/libc.a:exp.o"(.rodata.src_math_exp_c_half); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:log.o"(.rodata.cst8); /* size 0x58 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:pow.o"(.rodata.cst8); /* size 0xd0 */
	...
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"fft3d_x86_64.o"(.rodata.cst16); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"print_results_x86_64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"randdp_x86_64.o"(.rodata.cst8); /* size 0x20 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"/usr/local/popcorn/x86_64/lib/libc.a:cos.o"(.rodata.cst16); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:cos.o"(.rodata.cst8); /* size 0x10 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"/usr/local/popcorn/x86_64/lib/libc.a:pow.o"(.rodata.cst16); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:scalbn.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"/usr/local/popcorn/x86_64/lib/libc.a:sin.o"(.rodata.cst16); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:sin.o"(.rodata.cst8); /* size 0x8 */
...
.bss	: ALIGN(0x100000)
{
	...
	"appft_x86_64.o"(.bss.appft_c_xnt); /* size 0x8080000 */
	. = ALIGN(0x10); /* align for .bss.appft_c_y */
	"appft_x86_64.o"(.bss.appft_c_y); /* size 0x8080000 */
	. = ALIGN(0x10); /* align for .bss.appft_c_twiddle */
	"appft_x86_64.o"(.bss.appft_c_twiddle); /* size 0x4040000 */
	. = ALIGN(0x10); /* align for .bss.appft_c_sums */
	"appft_x86_64.o"(.bss.appft_c_sums); /* size 0x70 */
	...
	"fft3d_x86_64.o"(.bss.fft3d_c_fftblock); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.fft3d_c_plane */
	"fft3d_x86_64.o"(.bss.fft3d_c_plane); /* size 0x21000 */
	. = ALIGN(0x10); /* align for .bss.fft3d_c_scr */
	"fft3d_x86_64.o"(.bss.fft3d_c_scr); /* size 0x21000 */
	. = ALIGN(0x4); /* align for .bss.timers_enabled */
	"mainft_x86_64.o"(.bss.timers_enabled); /* size 0x4 */
