...
.text	: ALIGN(0x100000)
{
	...
	. = ALIGN(0x10); /* align for .text.appft */
	"appft_aarch64.o"(.text.appft); /* size 0x78c */
	. = . + 0x81; /* padding after .text.appft */
	. = ALIGN(0x10); /* align for .text.CompExp */
	"auxfnct_aarch64.o"(.text.CompExp); /* size 0x1b4 */
	. = ALIGN(0x10); /* align for .text.ilog2 */
	"auxfnct_aarch64.o"(.text.ilog2); /* size 0xb0 */
	. = ALIGN(0x10); /* align for .text.CalculateChecksum */
	"auxfnct_aarch64.o"(.text.CalculateChecksum); /* size 0x1e4 */
	. = ALIGN(0x10); /* align for .text.compute_initial_conditions */
	"auxfnct_aarch64.o"(.text.compute_initial_conditions); /* size 0x248 */
	. = . + 0x5c; /* padding after .text.compute_initial_conditions */
	. = ALIGN(0x10); /* align for .text.ipow46 */
	"auxfnct_aarch64.o"(.text.ipow46); /* size 0x13c */
	. = . + 0xd; /* padding after .text.ipow46 */
	. = ALIGN(0x10); /* align for .text.evolve */
	"auxfnct_aarch64.o"(.text.evolve); /* size 0x1f8 */
	. = . + 0x2f; /* padding after .text.evolve */
	...
	. = ALIGN(0x10); /* align for .text.fftXYZ */
	"fft3d_aarch64.o"(.text.fftXYZ); /* size 0x838 */
	. = . + 0xb; /* padding after .text.fftXYZ */
	. = ALIGN(0x10); /* align for .text.Swarztrauber */
	"fft3d_aarch64.o"(.text.Swarztrauber); /* size 0x7c0 */
	. = . + 0x1e2; /* padding after .text.Swarztrauber */
	. = ALIGN(0x10); /* align for .text.main */
	"mainft_aarch64.o"(.text.main); /* size 0x254 */
	. = ALIGN(0x10); /* align for .text.getclass */
	"mainft_aarch64.o"(.text.getclass); /* size 0x20 */
	...
	"verify_aarch64.o"(.text.verify); /* size 0x1994 */
	. = . + 0x14b; /* padding after .text.verify */
	. = ALIGN(0x10); /* align for .text.dcmplx_div */
	"verify_aarch64.o"(.text.dcmplx_div); /* size 0x108 */
	. = . + 0x3d; /* padding after .text.dcmplx_div */
	...
	. = ALIGN(0x4); /* align for .text.exp */
	"/usr/local/popcorn/aarch64/lib/libc.a:exp.o"(.text.exp); /* size 0x1cc */
	...
	. = ALIGN(0x4); /* align for .text.sin */
	"/usr/local/popcorn/aarch64/lib/libc.a:sin.o"(.text.sin); /* size 0xf8 */
	...
	. = . + 0x7; /* padding before .text.alloc_rev */
...
.rodata	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x4); /* align for .rodata.appft__str_goin_to_mi */
	"appft_aarch64.o"(.rodata.appft__str_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.appft__str_1___migrated */
	"appft_aarch64.o"(.rodata.appft__str_1___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.appft__str_2__FT_subrou */
	"appft_aarch64.o"(.rodata.appft__str_2__FT_subrou); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.appft__str_3___26s___9_ */
	"appft_aarch64.o"(.rodata.appft__str_3___26s___9_); /* size 0xe */
	. = ALIGN(0x4); /* align for .rodata.appft__str_4_FT_total__ */
	"appft_aarch64.o"(.rodata.appft__str_4_FT_total__); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_5_WarmUp_tim */
	"appft_aarch64.o"(.rodata.appft__str_5_WarmUp_tim); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_6_fftXYZ_bod */
	"appft_aarch64.o"(.rodata.appft__str_6_fftXYZ_bod); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_7_Swarztraub */
	"appft_aarch64.o"(.rodata.appft__str_7_Swarztraub); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_8_X_time____ */
	"appft_aarch64.o"(.rodata.appft__str_8_X_time____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_9_Y_time____ */
	"appft_aarch64.o"(.rodata.appft__str_9_Y_time____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_10_Z_time____ */
	"appft_aarch64.o"(.rodata.appft__str_10_Z_time____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_11_CalculateC */
	"appft_aarch64.o"(.rodata.appft__str_11_CalculateC); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_12_evolve____ */
	"appft_aarch64.o"(.rodata.appft__str_12_evolve____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_13_compute_in */
	"appft_aarch64.o"(.rodata.appft__str_13_compute_in); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_14_twiddle___ */
	"appft_aarch64.o"(.rodata.appft__str_14_twiddle___); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_15_verify____ */
	"appft_aarch64.o"(.rodata.appft__str_15_verify____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_16_fftXYZ____ */
	"appft_aarch64.o"(.rodata.appft__str_16_fftXYZ____); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.appft__str_17_Benchmark_ */
	"appft_aarch64.o"(.rodata.appft__str_17_Benchmark_); /* size 0x1b */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"auxfnct_aarch64.o"(.rodata.cst8); /* size 0x10 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"mainft_aarch64.o"(.rodata.cst8); /* size 0x28 */
	. = . + 0x8; /* padding after .rodata.cst8 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_timer_flag */
	"mainft_aarch64.o"(.rodata.mainft__str_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_1_r_ */
	"mainft_aarch64.o"(.rodata.mainft__str_1_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_2____NAS_Par */
	"mainft_aarch64.o"(.rodata.mainft__str_2____NAS_Par); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_3__Size_____ */
	"mainft_aarch64.o"(.rodata.mainft__str_3__Size_____); /* size 0x24 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_4__Iteration */
	"mainft_aarch64.o"(.rodata.mainft__str_4__Iteration); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_5___ */
	"mainft_aarch64.o"(.rodata.mainft__str_5___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_6_FT_ */
	"mainft_aarch64.o"(.rodata.mainft__str_6_FT_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_7___________ */
	"mainft_aarch64.o"(.rodata.mainft__str_7___________); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_8_3_3_1_ */
	"mainft_aarch64.o"(.rodata.mainft__str_8_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_9_03_Nov_201 */
	"mainft_aarch64.o"(.rodata.mainft__str_9_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_10_gcc_ */
	"mainft_aarch64.o"(.rodata.mainft__str_10_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_11___CC__ */
	"mainft_aarch64.o"(.rodata.mainft__str_11___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_12__lm_ */
	"mainft_aarch64.o"(.rodata.mainft__str_12__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_13__I___commo */
	"mainft_aarch64.o"(.rodata.mainft__str_13__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_14__g__Wall__ */
	"mainft_aarch64.o"(.rodata.mainft__str_14__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_15__O3__mcmod */
	"mainft_aarch64.o"(.rodata.mainft__str_15__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.mainft__str_16_randdp_ */
	"mainft_aarch64.o"(.rodata.mainft__str_16_randdp_); /* size 0x7 */
	...
	"verify_aarch64.o"(.rodata.verify__str___Verifica); /* size 0x2a */
	. = ALIGN(0x4); /* align for .rodata.verify__str_1__Verificat */
	"verify_aarch64.o"(.rodata.verify__str_1__Verificat); /* size 0x26 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_2__Verificat */
	"verify_aarch64.o"(.rodata.verify__str_2__Verificat); /* size 0x22 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/aarch64/lib/libc.a:exp.o"(.rodata.cst8); /* size 0x58 */
	. = . + 0x10; /* padding after .rodata.cst8 */
	. = ALIGN(0x10); /* align for .rodata.src_math_exp_c_half */
	"/usr/local/popcorn/aarch64/lib/libc.a:exp.o"(.rodata.src_math_exp_c_half); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/aarch64/lib/libc.a:log.o"(.rodata.cst8); /* size 0x40 */
	. = . + 0x18; /* padding after .rodata.cst8 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/aarch64/lib/libc.a:pow.o"(.rodata.cst8); /* size 0x98 */
	...
	. = . + 0x4; /* padding before .rodata.cst16 */
	. = . + 0x10; /* padding after .rodata.cst16 */
	. = . + 0x8; /* padding after .rodata.cst8 */
...
.bss	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x10); /* align for .bss.appft_c_xnt */
	"appft_aarch64.o"(.bss.appft_c_xnt); /* size 0x8080000 */
	. = ALIGN(0x10); /* align for .bss.appft_c_y */
	"appft_aarch64.o"(.bss.appft_c_y); /* size 0x8080000 */
	. = ALIGN(0x10); /* align for .bss.appft_c_twiddle */
	"appft_aarch64.o"(.bss.appft_c_twiddle); /* size 0x4040000 */
	. = ALIGN(0x10); /* align for .bss.appft_c_sums */
	"appft_aarch64.o"(.bss.appft_c_sums); /* size 0x70 */
	...
	. = ALIGN(0x4); /* align for .bss.fft3d_c_fftblock */
	"fft3d_aarch64.o"(.bss.fft3d_c_fftblock); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.fft3d_c_plane */
	"fft3d_aarch64.o"(.bss.fft3d_c_plane); /* size 0x21000 */
	. = ALIGN(0x10); /* align for .bss.fft3d_c_scr */
	"fft3d_aarch64.o"(.bss.fft3d_c_scr); /* size 0x21000 */
	. = ALIGN(0x4); /* align for .bss.timers_enabled */
	"mainft_aarch64.o"(.bss.timers_enabled); /* size 0x4 */
