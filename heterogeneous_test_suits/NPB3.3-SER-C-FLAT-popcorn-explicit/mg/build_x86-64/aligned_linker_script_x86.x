...
.text	: ALIGN(0x100000)
{
	...
	"mg_x86_64.o"(.text.main); /* size 0x135c */
	. = ALIGN(0x10); /* align for .text.setup */
	"mg_x86_64.o"(.text.setup); /* size 0x512 */
	. = . + 0x7e; /* padding after .text.setup */
	. = ALIGN(0x10); /* align for .text.zero3 */
	"mg_x86_64.o"(.text.zero3); /* size 0x11d */
	. = . + 0xb; /* padding after .text.zero3 */
	. = ALIGN(0x10); /* align for .text.zran3 */
	"mg_x86_64.o"(.text.zran3); /* size 0xa88 */
	. = ALIGN(0x10); /* align for .text.norm2u3 */
	"mg_x86_64.o"(.text.norm2u3); /* size 0x28d */
	. = ALIGN(0x10); /* align for .text.resid */
	"mg_x86_64.o"(.text.resid); /* size 0x476 */
	. = . + 0x2; /* padding after .text.resid */
	. = ALIGN(0x10); /* align for .text.mg3P */
	"mg_x86_64.o"(.text.mg3P); /* size 0x497 */
	. = . + 0x61; /* padding after .text.mg3P */
	. = ALIGN(0x10); /* align for .text.rprj3 */
	"mg_x86_64.o"(.text.rprj3); /* size 0x62c */
	. = . + 0x2c; /* padding after .text.rprj3 */
	. = ALIGN(0x10); /* align for .text.psinv */
	"mg_x86_64.o"(.text.psinv); /* size 0x42c */
	. = . + 0x1c; /* padding after .text.psinv */
	. = ALIGN(0x10); /* align for .text.interp */
	"mg_x86_64.o"(.text.interp); /* size 0x111d */
	. = . + 0x13; /* padding after .text.interp */
	. = ALIGN(0x10); /* align for .text.comm3 */
	"mg_x86_64.o"(.text.comm3); /* size 0x31c */
	. = . + 0x20; /* padding after .text.comm3 */
	. = ALIGN(0x10); /* align for .text.rep_nrm */
	"mg_x86_64.o"(.text.rep_nrm); /* size 0xdf */
	. = . + 0x39; /* padding after .text.rep_nrm */
	. = ALIGN(0x10); /* align for .text.showall */
	"mg_x86_64.o"(.text.showall); /* size 0x1ce */
	. = . + 0xe; /* padding after .text.showall */
	. = ALIGN(0x10); /* align for .text.power */
	"mg_x86_64.o"(.text.power); /* size 0xe0 */
	. = . + 0x4; /* padding after .text.power */
	. = ALIGN(0x10); /* align for .text.bubble */
	"mg_x86_64.o"(.text.bubble); /* size 0x39c */
	. = . + 0x8c; /* padding after .text.bubble */
...
.rodata	: ALIGN(0x100000)
{
	...
	"mg_x86_64.o"(.rodata.cst8); /* size 0x50 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_timer_flag */
	"mg_x86_64.o"(.rodata.mg__str_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.mg__str_1_r_ */
	"mg_x86_64.o"(.rodata.mg__str_1_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_2_init_ */
	"mg_x86_64.o"(.rodata.mg__str_2_init_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_3_benchmk_ */
	"mg_x86_64.o"(.rodata.mg__str_3_benchmk_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_4_mg3P_ */
	"mg_x86_64.o"(.rodata.mg__str_4_mg3P_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_5_psinv_ */
	"mg_x86_64.o"(.rodata.mg__str_5_psinv_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_6_resid_ */
	"mg_x86_64.o"(.rodata.mg__str_6_resid_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_7_rprj3_ */
	"mg_x86_64.o"(.rodata.mg__str_7_rprj3_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_8_interp_ */
	"mg_x86_64.o"(.rodata.mg__str_8_interp_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_9_norm2_ */
	"mg_x86_64.o"(.rodata.mg__str_9_norm2_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_10_comm3_ */
	"mg_x86_64.o"(.rodata.mg__str_10_comm3_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_11____NAS_Par */
	"mg_x86_64.o"(.rodata.mg__str_11____NAS_Par); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.mg__str_12_mg_input_ */
	"mg_x86_64.o"(.rodata.mg__str_12_mg_input_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_13__Reading_f */
	"mg_x86_64.o"(.rodata.mg__str_13__Reading_f); /* size 0x23 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_14__d__ */
	"mg_x86_64.o"(.rodata.mg__str_14__d__); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_15__d_d_d_ */
	"mg_x86_64.o"(.rodata.mg__str_15__d_d_d_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_16__d_ */
	"mg_x86_64.o"(.rodata.mg__str_16__d_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_17__No_input_ */
	"mg_x86_64.o"(.rodata.mg__str_17__No_input_); /* size 0x2a */
	. = ALIGN(0x4); /* align for .rodata.mg__str_18__Size___4d */
	"mg_x86_64.o"(.rodata.mg__str_18__Size___4d); /* size 0x20 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_19__Iteration */
	"mg_x86_64.o"(.rodata.mg__str_19__Iteration); /* size 0x12 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_20___ */
	"mg_x86_64.o"(.rodata.mg__str_20___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_21__Initializ */
	"mg_x86_64.o"(.rodata.mg__str_21__Initializ); /* size 0x27 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_22_goin_to_mi */
	"mg_x86_64.o"(.rodata.mg__str_22_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_23___iter__3d */
	"mg_x86_64.o"(.rodata.mg__str_23___iter__3d); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.mg__str_24___migrated */
	"mg_x86_64.o"(.rodata.mg__str_24___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_25___Benchmar */
	"mg_x86_64.o"(.rodata.mg__str_25___Benchmar); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_26__VERIFICAT */
	"mg_x86_64.o"(.rodata.mg__str_26__VERIFICAT); /* size 0x1a */
	. = ALIGN(0x4); /* align for .rodata.mg__str_27__L2_Norm_i */
	"mg_x86_64.o"(.rodata.mg__str_27__L2_Norm_i); /* size 0x15 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_28__Error_is_ */
	"mg_x86_64.o"(.rodata.mg__str_28__Error_is_); /* size 0x15 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_29__VERIFICAT */
	"mg_x86_64.o"(.rodata.mg__str_29__VERIFICAT); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_30__L2_Norm_i */
	"mg_x86_64.o"(.rodata.mg__str_30__L2_Norm_i); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_31__The_corre */
	"mg_x86_64.o"(.rodata.mg__str_31__The_corre); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_32__Problem_s */
	"mg_x86_64.o"(.rodata.mg__str_32__Problem_s); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_33__NO_VERIFI */
	"mg_x86_64.o"(.rodata.mg__str_33__NO_VERIFI); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.mg__str_34_MG_ */
	"mg_x86_64.o"(.rodata.mg__str_34_MG_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_35___________ */
	"mg_x86_64.o"(.rodata.mg__str_35___________); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_36_3_3_1_ */
	"mg_x86_64.o"(.rodata.mg__str_36_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_37_03_Nov_201 */
	"mg_x86_64.o"(.rodata.mg__str_37_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.mg__str_38_gcc_ */
	"mg_x86_64.o"(.rodata.mg__str_38_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_39___CC__ */
	"mg_x86_64.o"(.rodata.mg__str_39___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_40__lm_ */
	"mg_x86_64.o"(.rodata.mg__str_40__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_41__I___commo */
	"mg_x86_64.o"(.rodata.mg__str_41__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.mg__str_42__g__Wall__ */
	"mg_x86_64.o"(.rodata.mg__str_42__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.mg__str_43__O3__mcmod */
	"mg_x86_64.o"(.rodata.mg__str_43__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_44_randdp_ */
	"mg_x86_64.o"(.rodata.mg__str_44_randdp_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_45___SECTION_ */
	"mg_x86_64.o"(.rodata.mg__str_45___SECTION_); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_46__________8 */
	"mg_x86_64.o"(.rodata.mg__str_46__________8); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.mg__str_47_mg_resid_ */
	"mg_x86_64.o"(.rodata.mg__str_47_mg_resid_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_48_____8s__9_ */
	"mg_x86_64.o"(.rodata.mg__str_48_____8s__9_); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_49__in_setup_ */
	"mg_x86_64.o"(.rodata.mg__str_49__in_setup_); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.mg__str_50__k__lt__nx */
	"mg_x86_64.o"(.rodata.mg__str_50__k__lt__nx); /* size 0x38 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_51__4d_4d_4d_ */
	"mg_x86_64.o"(.rodata.mg__str_51__4d_4d_4d_); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.mg__str_52____rprj3_ */
	"mg_x86_64.o"(.rodata.mg__str_52____rprj3_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_53__Level_2d_ */
	"mg_x86_64.o"(.rodata.mg__str_53__Level_2d_); /* size 0x29 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_54______ */
	"mg_x86_64.o"(.rodata.mg__str_54______); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_55__6_3f_ */
	"mg_x86_64.o"(.rodata.mg__str_55__6_3f_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_56___________ */
	"mg_x86_64.o"(.rodata.mg__str_56___________); /* size 0x12 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_57____psinv_ */
	"mg_x86_64.o"(.rodata.mg__str_57____psinv_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_58_z__inter_ */
	"mg_x86_64.o"(.rodata.mg__str_58_z__inter_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_59_u__inter_ */
	"mg_x86_64.o"(.rodata.mg__str_59_u__inter_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.mg__str_60____resid_ */
	"mg_x86_64.o"(.rodata.mg__str_60____resid_); /* size 0x9 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:pow.o"(.rodata.cst8); /* size 0x108 */
	...
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"mg_x86_64.o"(.rodata.cst16); /* size 0x10 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
...
.bss	: ALIGN(0x100000)
{
	...
	. = ALIGN(0x4); /* align for .bss.mg_c_timeron */
	"mg_x86_64.o"(.bss.mg_c_timeron); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.mg_c_lt */
	"mg_x86_64.o"(.bss.mg_c_lt); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.mg_c_nx */
	"mg_x86_64.o"(.bss.mg_c_nx); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.mg_c_ny */
	"mg_x86_64.o"(.bss.mg_c_ny); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.mg_c_nz */
	"mg_x86_64.o"(.bss.mg_c_nz); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.mg_c_debug_vec */
	"mg_x86_64.o"(.bss.mg_c_debug_vec); /* size 0x20 */
	. = ALIGN(0x4); /* align for .bss.mg_c_Class */
	"mg_x86_64.o"(.bss.mg_c_Class); /* size 0x1 */
	. = ALIGN(0x4); /* align for .bss.mg_c_lb */
	"mg_x86_64.o"(.bss.mg_c_lb); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.mg_c_u */
	"mg_x86_64.o"(.bss.mg_c_u); /* size 0x9655540 */
	. = ALIGN(0x10); /* align for .bss.mg_c_v */
	"mg_x86_64.o"(.bss.mg_c_v); /* size 0x9655540 */
	. = ALIGN(0x10); /* align for .bss.mg_c_r */
	"mg_x86_64.o"(.bss.mg_c_r); /* size 0x9655540 */
	. = ALIGN(0x10); /* align for .bss.mg_c_m1 */
	"mg_x86_64.o"(.bss.mg_c_m1); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.mg_c_m2 */
	"mg_x86_64.o"(.bss.mg_c_m2); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.mg_c_m3 */
	"mg_x86_64.o"(.bss.mg_c_m3); /* size 0x28 */
	. = ALIGN(0x4); /* align for .bss.mg_c_is1 */
	"mg_x86_64.o"(.bss.mg_c_is1); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.mg_c_ie1 */
	"mg_x86_64.o"(.bss.mg_c_ie1); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.mg_c_is2 */
	"mg_x86_64.o"(.bss.mg_c_is2); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.mg_c_ie2 */
	"mg_x86_64.o"(.bss.mg_c_ie2); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.mg_c_is3 */
	"mg_x86_64.o"(.bss.mg_c_is3); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.mg_c_ie3 */
	"mg_x86_64.o"(.bss.mg_c_ie3); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.mg_c_ir */
	"mg_x86_64.o"(.bss.mg_c_ir); /* size 0x28 */
