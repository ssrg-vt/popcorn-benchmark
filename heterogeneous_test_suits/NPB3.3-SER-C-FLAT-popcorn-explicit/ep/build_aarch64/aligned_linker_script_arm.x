...
.text	: ALIGN(0x100000)
{
	...
	"ep_aarch64.o"(.text.main); /* size 0x940 */
	. = . + 0x1e1; /* padding after .text.main */
...
.rodata	: ALIGN(0x100000)
{
	...
	"ep_aarch64.o"(.rodata.cst8); /* size 0x10 */
	. = . + 0x30; /* padding after .rodata.cst8 */
	. = ALIGN(0x10); /* align for .rodata.ep___const_main_dum_ */
	"ep_aarch64.o"(.rodata.ep___const_main_dum_); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_timer_flag */
	"ep_aarch64.o"(.rodata.ep__str_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.ep__str_1_r_ */
	"ep_aarch64.o"(.rodata.ep__str_1_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_2__15_0lf_ */
	"ep_aarch64.o"(.rodata.ep__str_2__15_0lf_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_3____NAS_Par */
	"ep_aarch64.o"(.rodata.ep__str_3____NAS_Par); /* size 0x3a */
	. = ALIGN(0x4); /* align for .rodata.ep__str_4___Number_o */
	"ep_aarch64.o"(.rodata.ep__str_4___Number_o); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.ep__str_5_goin_to_mi */
	"ep_aarch64.o"(.rodata.ep__str_5_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_6___migrated */
	"ep_aarch64.o"(.rodata.ep__str_6___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_7__EP_Benchm */
	"ep_aarch64.o"(.rodata.ep__str_7__EP_Benchm); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_8_CPU_Time__ */
	"ep_aarch64.o"(.rodata.ep__str_8_CPU_Time__); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_9_N___2__5d_ */
	"ep_aarch64.o"(.rodata.ep__str_9_N___2__5d_); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.ep__str_10_No__Gaussi */
	"ep_aarch64.o"(.rodata.ep__str_10_No__Gaussi); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.ep__str_11_Sums____25 */
	"ep_aarch64.o"(.rodata.ep__str_11_Sums____25); /* size 0x1a */
	. = ALIGN(0x4); /* align for .rodata.ep__str_12_Counts____ */
	"ep_aarch64.o"(.rodata.ep__str_12_Counts____); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.ep__str_13__3d_15_0lf */
	"ep_aarch64.o"(.rodata.ep__str_13__3d_15_0lf); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.ep__str_14_EP_ */
	"ep_aarch64.o"(.rodata.ep__str_14_EP_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_15_Random_num */
	"ep_aarch64.o"(.rodata.ep__str_15_Random_num); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_16_3_3_1_ */
	"ep_aarch64.o"(.rodata.ep__str_16_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_17_03_Nov_201 */
	"ep_aarch64.o"(.rodata.ep__str_17_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.ep__str_18_gcc_ */
	"ep_aarch64.o"(.rodata.ep__str_18_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_19___CC__ */
	"ep_aarch64.o"(.rodata.ep__str_19___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_20__lm_ */
	"ep_aarch64.o"(.rodata.ep__str_20__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_21__I___commo */
	"ep_aarch64.o"(.rodata.ep__str_21__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.ep__str_22__g__Wall__ */
	"ep_aarch64.o"(.rodata.ep__str_22__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.ep__str_23__O3__mcmod */
	"ep_aarch64.o"(.rodata.ep__str_23__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_24_randdp_ */
	"ep_aarch64.o"(.rodata.ep__str_24_randdp_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_25__Total_tim */
	"ep_aarch64.o"(.rodata.ep__str_25__Total_tim); /* size 0x22 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_26_Gaussian_p */
	"ep_aarch64.o"(.rodata.ep__str_26_Gaussian_p); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.ep__str_27_Random_num */
	"ep_aarch64.o"(.rodata.ep__str_27_Random_num); /* size 0x21 */
...
.bss	: ALIGN(0x100000)
{
	...
	. = ALIGN(0x10); /* align for .bss.ep_c_x */
	"ep_aarch64.o"(.bss.ep_c_x); /* size 0x100000 */
	. = ALIGN(0x10); /* align for .bss.ep_c_q */
	"ep_aarch64.o"(.bss.ep_c_q); /* size 0x50 */
