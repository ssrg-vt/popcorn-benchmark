...
.text	: ALIGN(0x100000)
{
	...
	"adapt_aarch64.o"(.text.adaptation); /* size 0x270 */
	. = . + 0x17; /* padding after .text.adaptation */
	. = ALIGN(0x10); /* align for .text.find_refine */
	"adapt_aarch64.o"(.text.find_refine); /* size 0xf8 */
	. = ALIGN(0x10); /* align for .text.check_refine */
	"adapt_aarch64.o"(.text.check_refine); /* size 0x3a0 */
	. = ALIGN(0x10); /* align for .text.do_refine */
	"adapt_aarch64.o"(.text.do_refine); /* size 0x1888 */
	. = . + 0x3dd; /* padding after .text.do_refine */
	. = ALIGN(0x10); /* align for .text.find_coarsen */
	"adapt_aarch64.o"(.text.find_coarsen); /* size 0x15c */
	. = ALIGN(0x10); /* align for .text.do_coarsen */
	"adapt_aarch64.o"(.text.do_coarsen); /* size 0x67c */
	. = ALIGN(0x10); /* align for .text.icheck */
	"adapt_aarch64.o"(.text.icheck); /* size 0x374 */
	. = ALIGN(0x10); /* align for .text.merging */
	"adapt_aarch64.o"(.text.merging); /* size 0x8dc */
	. = ALIGN(0x10); /* align for .text.remap2 */
	"adapt_aarch64.o"(.text.remap2); /* size 0x160 */
	. = . + 0x24; /* padding after .text.remap2 */
	. = ALIGN(0x10); /* align for .text.remapx */
	"adapt_aarch64.o"(.text.remapx); /* size 0x2a0 */
	. = ALIGN(0x10); /* align for .text.remapy */
	"adapt_aarch64.o"(.text.remapy); /* size 0x284 */
	. = ALIGN(0x10); /* align for .text.remapz */
	"adapt_aarch64.o"(.text.remapz); /* size 0x28c */
	. = ALIGN(0x10); /* align for .text.remap */
	"adapt_aarch64.o"(.text.remap); /* size 0x7e0 */
	. = . + 0x1bf; /* padding after .text.remap */
	. = ALIGN(0x10); /* align for .text.iftouch */
	"adapt_aarch64.o"(.text.iftouch); /* size 0x2a8 */
	. = ALIGN(0x10); /* align for .text.ifcor */
	"adapt_aarch64.o"(.text.ifcor); /* size 0x128 */
	. = ALIGN(0x10); /* align for .text.convect */
	"convect_aarch64.o"(.text.convect); /* size 0x1800 */
	. = . + 0x616; /* padding after .text.convect */
	...
	"diffuse_aarch64.o"(.text.diffusion); /* size 0xa6c */
	. = ALIGN(0x10); /* align for .text.laplacian */
	"diffuse_aarch64.o"(.text.laplacian); /* size 0x570 */
	. = ALIGN(0x10); /* align for .text.mortar */
	"mason_aarch64.o"(.text.mortar); /* size 0x75dc */
	. = ALIGN(0x10); /* align for .text.mortar_vertex */
	"mason_aarch64.o"(.text.mortar_vertex); /* size 0x1730 */
	. = . + 0x127; /* padding after .text.mortar_vertex */
	. = ALIGN(0x10); /* align for .text.mor_assign */
	"mason_aarch64.o"(.text.mor_assign); /* size 0x98 */
	. = ALIGN(0x10); /* align for .text.mor_edge */
	"mason_aarch64.o"(.text.mor_edge); /* size 0x2c0 */
	. = ALIGN(0x10); /* align for .text.mor_ne */
	"mason_aarch64.o"(.text.mor_ne); /* size 0x578 */
	. = ALIGN(0x10); /* align for .text.edgecopy_s */
	"mason_aarch64.o"(.text.edgecopy_s); /* size 0x844 */
	. = ALIGN(0x10); /* align for .text.ifsame */
	"mason_aarch64.o"(.text.ifsame); /* size 0x140 */
	. = . + 0x10; /* padding after .text.ifsame */
	. = ALIGN(0x10); /* align for .text.mor_s_e */
	"mason_aarch64.o"(.text.mor_s_e); /* size 0x448 */
	. = ALIGN(0x10); /* align for .text.get_emo */
	"mason_aarch64.o"(.text.get_emo); /* size 0x13c */
	. = ALIGN(0x10); /* align for .text.mor_s_e_nn */
	"mason_aarch64.o"(.text.mor_s_e_nn); /* size 0x498 */
	. = ALIGN(0x10); /* align for .text.move */
	"move_aarch64.o"(.text.move); /* size 0x758 */
	. = ALIGN(0x10); /* align for .text.setuppc */
	"precond_aarch64.o"(.text.setuppc); /* size 0x3a0 */
	. = . + 0x88; /* padding after .text.setuppc */
	. = ALIGN(0x10); /* align for .text.setpcmo_pre */
	"precond_aarch64.o"(.text.setpcmo_pre); /* size 0x1950 */
	. = . + 0x1a1; /* padding after .text.setpcmo_pre */
	. = ALIGN(0x10); /* align for .text.setpcmo */
	"precond_aarch64.o"(.text.setpcmo); /* size 0xcb8 */
	. = ALIGN(0x10); /* align for .text.pc_corner */
	"precond_aarch64.o"(.text.pc_corner); /* size 0x330 */
	. = ALIGN(0x10); /* align for .text.com_dpc */
	"precond_aarch64.o"(.text.com_dpc); /* size 0x824 */
	...
	"setup_aarch64.o"(.text.create_initial_grid); /* size 0x198 */
	. = . + 0x12; /* padding after .text.create_initial_grid */
	. = ALIGN(0x10); /* align for .text.coef */
	"setup_aarch64.o"(.text.coef); /* size 0x8a8 */
	. = . + 0x72; /* padding after .text.coef */
	. = ALIGN(0x10); /* align for .text.geom1 */
	"setup_aarch64.o"(.text.geom1); /* size 0x5dc */
	. = ALIGN(0x10); /* align for .text.setdef */
	"setup_aarch64.o"(.text.setdef); /* size 0x130 */
	. = ALIGN(0x10); /* align for .text.prepwork */
	"setup_aarch64.o"(.text.prepwork); /* size 0xa00 */
	. = ALIGN(0x10); /* align for .text.top_constants */
	"setup_aarch64.o"(.text.top_constants); /* size 0x9a8 */
	. = . + 0xbba; /* padding after .text.top_constants */
	. = ALIGN(0x10); /* align for .text.transf */
	"transfer_aarch64.o"(.text.transf); /* size 0x1464 */
	. = . + 0x1c7; /* padding after .text.transf */
	. = ALIGN(0x10); /* align for .text.transfb */
	"transfer_aarch64.o"(.text.transfb); /* size 0x1694 */
	. = . + 0x203; /* padding after .text.transfb */
	. = ALIGN(0x10); /* align for .text.transfb_cor_e */
	"transfer_aarch64.o"(.text.transfb_cor_e); /* size 0x1bc */
	. = ALIGN(0x10); /* align for .text.transfb_cor_f */
	"transfer_aarch64.o"(.text.transfb_cor_f); /* size 0x464 */
	. = ALIGN(0x10); /* align for .text.transf_nc */
	"transfer_aarch64.o"(.text.transf_nc); /* size 0x290 */
	. = . + 0x58; /* padding after .text.transf_nc */
	. = ALIGN(0x10); /* align for .text.transfb_nc0 */
	"transfer_aarch64.o"(.text.transfb_nc0); /* size 0xfc */
	. = ALIGN(0x10); /* align for .text.transfb_nc2 */
	"transfer_aarch64.o"(.text.transfb_nc2); /* size 0x3f8 */
	. = . + 0x82; /* padding after .text.transfb_nc2 */
	. = ALIGN(0x10); /* align for .text.transfb_nc1 */
	"transfer_aarch64.o"(.text.transfb_nc1); /* size 0x410 */
	. = . + 0x80; /* padding after .text.transfb_nc1 */
	. = ALIGN(0x10); /* align for .text.transfb_c */
	"transfer_aarch64.o"(.text.transfb_c); /* size 0x7f8 */
	. = ALIGN(0x10); /* align for .text.transfb_c_2 */
	"transfer_aarch64.o"(.text.transfb_c_2); /* size 0x8f8 */
	. = ALIGN(0x10); /* align for .text.main */
	"ua_aarch64.o"(.text.main); /* size 0xbec */
	. = . + 0x20; /* padding after .text.main */
	. = ALIGN(0x10); /* align for .text.reciprocal */
	"utils_aarch64.o"(.text.reciprocal); /* size 0x94 */
	. = ALIGN(0x10); /* align for .text.r_init */
	"utils_aarch64.o"(.text.r_init); /* size 0x98 */
	. = ALIGN(0x10); /* align for .text.nr_init */
	"utils_aarch64.o"(.text.nr_init); /* size 0x98 */
	. = ALIGN(0x10); /* align for .text.l_init */
	"utils_aarch64.o"(.text.l_init); /* size 0x98 */
	. = ALIGN(0x10); /* align for .text.ncopy */
	"utils_aarch64.o"(.text.ncopy); /* size 0xa0 */
	. = ALIGN(0x10); /* align for .text.copy */
	"utils_aarch64.o"(.text.copy); /* size 0xa0 */
	. = ALIGN(0x10); /* align for .text.adds2m1 */
	"utils_aarch64.o"(.text.adds2m1); /* size 0xc0 */
	. = ALIGN(0x10); /* align for .text.adds1m1 */
	"utils_aarch64.o"(.text.adds1m1); /* size 0xc0 */
	. = ALIGN(0x10); /* align for .text.col2 */
	"utils_aarch64.o"(.text.col2); /* size 0xa8 */
	. = ALIGN(0x10); /* align for .text.nrzero */
	"utils_aarch64.o"(.text.nrzero); /* size 0x84 */
	. = ALIGN(0x10); /* align for .text.add2 */
	"utils_aarch64.o"(.text.add2); /* size 0xa8 */
	. = ALIGN(0x10); /* align for .text.calc_norm */
	"utils_aarch64.o"(.text.calc_norm); /* size 0x1b0 */
	. = ALIGN(0x10); /* align for .text.parallel_add */
	"utils_aarch64.o"(.text.parallel_add); /* size 0x27c */
	. = ALIGN(0x10); /* align for .text.dssum */
	"utils_aarch64.o"(.text.dssum); /* size 0x4c */
	. = ALIGN(0x10); /* align for .text.facev */
	"utils_aarch64.o"(.text.facev); /* size 0x1f4 */
	. = ALIGN(0x10); /* align for .text.verify */
	"verify_aarch64.o"(.text.verify); /* size 0x368 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:acos.o"(.text.acos); /* size 0x31c */
	. = ALIGN(0x4); /* align for .text.cos */
	"/usr/local/popcorn/aarch64/lib/libc.a:cos.o"(.text.cos); /* size 0xe8 */
	. = ALIGN(0x4); /* align for .text.log */
	"/usr/local/popcorn/aarch64/lib/libc.a:log.o"(.text.log); /* size 0x18c */
	. = . + 0x6; /* padding after .text.log */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:__cos.o"(.text.__cos); /* size 0x98 */
	. = . + 0x9; /* padding after .text.__cos */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:__rem_pio2.o"(.text.__rem_pio2); /* size 0x364 */
	. = . + 0xff; /* padding after .text.__rem_pio2 */
	. = ALIGN(0x4); /* align for .text.__rem_pio2_large */
	"/usr/local/popcorn/aarch64/lib/libc.a:__rem_pio2_large.o"(.text.__rem_pio2_large); /* size 0x780 */
	. = . + 0x19; /* padding after .text.__rem_pio2_large */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:__sin.o"(.text.__sin); /* size 0xa8 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:floor.o"(.text.floor); /* size 0x8 */
	. = . + 0x76; /* padding after .text.floor */
...
.rodata	: ALIGN(0x100000)
{
	...
	"adapt_aarch64.o"(.rodata.cst8); /* size 0x10 */
	. = . + 0x10; /* padding after .rodata.cst8 */
	. = ALIGN(0x4); /* align for .rodata.adapt__str_Step__4d__ */
	"adapt_aarch64.o"(.rodata.adapt__str_Step__4d__); /* size 0x37 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"convect_aarch64.o"(.rodata.cst8); /* size 0x10 */
	. = . + 0x10; /* padding after .rodata.cst8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"diffuse_aarch64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"precond_aarch64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.precond__str_0_ */
	"precond_aarch64.o"(.rodata.precond__str_0_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.precond__str_1_precond_c_ */
	"precond_aarch64.o"(.rodata.precond__str_1_precond_c_); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.precond___func___com_dpc_com_dpc_ */
	"precond_aarch64.o"(.rodata.precond___func___com_dpc_com_dpc_); /* size 0x8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"setup_aarch64.o"(.rodata.cst8); /* size 0x8 */
	. = . + 0x8; /* padding after .rodata.cst8 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"ua_aarch64.o"(.rodata.cst8); /* size 0x8 */
	. = . + 0x18; /* padding after .rodata.cst8 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_timer_flag */
	"ua_aarch64.o"(.rodata.ua__str_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.ua__str_1_r_ */
	"ua_aarch64.o"(.rodata.ua__str_1_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_2_total_ */
	"ua_aarch64.o"(.rodata.ua__str_2_total_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_3_init_ */
	"ua_aarch64.o"(.rodata.ua__str_3_init_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_4_convect_ */
	"ua_aarch64.o"(.rodata.ua__str_4_convect_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_5_transfb_c_ */
	"ua_aarch64.o"(.rodata.ua__str_5_transfb_c_); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.ua__str_6_diffusion_ */
	"ua_aarch64.o"(.rodata.ua__str_6_diffusion_); /* size 0xa */
	. = ALIGN(0x4); /* align for .rodata.ua__str_7_transf_ */
	"ua_aarch64.o"(.rodata.ua__str_7_transf_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_8_transfb_ */
	"ua_aarch64.o"(.rodata.ua__str_8_transfb_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_9_adaptation */
	"ua_aarch64.o"(.rodata.ua__str_9_adaptation); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.ua__str_10_transf_b_ */
	"ua_aarch64.o"(.rodata.ua__str_10_transf_b_); /* size 0x9 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_11_add2_ */
	"ua_aarch64.o"(.rodata.ua__str_11_add2_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_12____NAS_Par */
	"ua_aarch64.o"(.rodata.ua__str_12____NAS_Par); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.ua__str_13_inputua_da */
	"ua_aarch64.o"(.rodata.ua__str_13_inputua_da); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.ua__str_14__Reading_f */
	"ua_aarch64.o"(.rodata.ua__str_14__Reading_f); /* size 0x27 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_15__d_ */
	"ua_aarch64.o"(.rodata.ua__str_15__d_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_16__lf_ */
	"ua_aarch64.o"(.rodata.ua__str_16__lf_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_17__No_input_ */
	"ua_aarch64.o"(.rodata.ua__str_17__No_input_); /* size 0x36 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_18__Levels_of */
	"ua_aarch64.o"(.rodata.ua__str_18__Levels_of); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.ua__str_19__Adaptatio */
	"ua_aarch64.o"(.rodata.ua__str_19__Adaptatio); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.ua__str_20__Time_step */
	"ua_aarch64.o"(.rodata.ua__str_20__Time_step); /* size 0x2a */
	. = ALIGN(0x4); /* align for .rodata.ua__str_21__CG_iterat */
	"ua_aarch64.o"(.rodata.ua__str_21__CG_iterat); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.ua__str_22__Heat_sour */
	"ua_aarch64.o"(.rodata.ua__str_22__Heat_sour); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.ua__str_23_goin_to_mi */
	"ua_aarch64.o"(.rodata.ua__str_23_goin_to_mi); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.ua__str_24___migrated */
	"ua_aarch64.o"(.rodata.ua__str_24___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_25_UA_ */
	"ua_aarch64.o"(.rodata.ua__str_25_UA_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_26_____coll__ */
	"ua_aarch64.o"(.rodata.ua__str_26_____coll__); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_27_3_3_1_ */
	"ua_aarch64.o"(.rodata.ua__str_27_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_28_03_Nov_201 */
	"ua_aarch64.o"(.rodata.ua__str_28_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.ua__str_29_gcc_ */
	"ua_aarch64.o"(.rodata.ua__str_29_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_30___CC__ */
	"ua_aarch64.o"(.rodata.ua__str_30___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_31__lm_ */
	"ua_aarch64.o"(.rodata.ua__str_31__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_32__I___commo */
	"ua_aarch64.o"(.rodata.ua__str_32__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.ua__str_33__g__Wall__ */
	"ua_aarch64.o"(.rodata.ua__str_33__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.ua__str_34__O3__mcmod */
	"ua_aarch64.o"(.rodata.ua__str_34__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_35__none__ */
	"ua_aarch64.o"(.rodata.ua__str_35__none__); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.ua__str_36___SECTION_ */
	"ua_aarch64.o"(.rodata.ua__str_36___SECTION_); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.ua__str_37_____10s__9 */
	"ua_aarch64.o"(.rodata.ua__str_37_____10s__9); /* size 0x1a */
	. = ALIGN(0x4); /* align for .rodata.ua__str_38__________1 */
	"ua_aarch64.o"(.rodata.ua__str_38__________1); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.ua__str_39_sub_convec */
	"ua_aarch64.o"(.rodata.ua__str_39_sub_convec); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.ua__str_40_sub_diffus */
	"ua_aarch64.o"(.rodata.ua__str_40_sub_diffus); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.verify__str___ */
	"verify_aarch64.o"(.rodata.verify__str___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_1__Verificat */
	"verify_aarch64.o"(.rodata.verify__str_1__Verificat); /* size 0x2c */
	. = ALIGN(0x4); /* align for .rodata.verify__str_2__accuracy_ */
	"verify_aarch64.o"(.rodata.verify__str_2__accuracy_); /* size 0x29 */
	...
	"verify_aarch64.o"(.rodata.verify__str_5__Temperatu); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_6___________ */
	"verify_aarch64.o"(.rodata.verify__str_6___________); /* size 0x13 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_7___________ */
	"verify_aarch64.o"(.rodata.verify__str_7___________); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_8__FAILURE__ */
	"verify_aarch64.o"(.rodata.verify__str_8__FAILURE__); /* size 0x21 */
	. = ALIGN(0x4); /* align for .rodata.verify__str_9__No_refere */
	"verify_aarch64.o"(.rodata.verify__str_9__No_refere); /* size 0x1f */
	. = ALIGN(0x4); /* align for .rodata.verify__str_10__No_verifi */
	"verify_aarch64.o"(.rodata.verify__str_10__No_verifi); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.verify__str_11__Verificat */
	"verify_aarch64.o"(.rodata.verify__str_11__Verificat); /* size 0x1a */
	. = ALIGN(0x4); /* align for .rodata.verify__str_12__Verificat */
	"verify_aarch64.o"(.rodata.verify__str_12__Verificat); /* size 0x16 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/aarch64/lib/libc.a:acos.o"(.rodata.cst8); /* size 0x70 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/aarch64/lib/libc.a:log.o"(.rodata.cst8); /* size 0x48 */
	. = . + 0x8; /* padding after .rodata.cst8 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/aarch64/lib/libc.a:__cos.o"(.rodata.cst8); /* size 0x30 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/aarch64/lib/libc.a:__rem_pio2.o"(.rodata.cst8); /* size 0xa8 */
	. = . + 0x18; /* padding after .rodata.cst8 */
	. = ALIGN(0x10); /* align for .rodata.src_math___rem_pio2_large_c_init_jk */
	"/usr/local/popcorn/aarch64/lib/libc.a:__rem_pio2_large.o"(.rodata.src_math___rem_pio2_large_c_init_jk); /* size 0x10 */
	. = ALIGN(0x10); /* align for .rodata.src_math___rem_pio2_large_c_ipio2 */
	"/usr/local/popcorn/aarch64/lib/libc.a:__rem_pio2_large.o"(.rodata.src_math___rem_pio2_large_c_ipio2); /* size 0xac8 */
	. = ALIGN(0x10); /* align for .rodata.src_math___rem_pio2_large_c_PIo2 */
	"/usr/local/popcorn/aarch64/lib/libc.a:__rem_pio2_large.o"(.rodata.src_math___rem_pio2_large_c_PIo2); /* size 0x40 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/aarch64/lib/libc.a:__sin.o"(.rodata.cst8); /* size 0x38 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
...
.bss	: ALIGN(0x100000)
{
	...
	"ua_aarch64.o"(.bss.timeron); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.fre */
	"ua_aarch64.o"(.bss.fre); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.niter */
	"ua_aarch64.o"(.bss.niter); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.nmxh */
	"ua_aarch64.o"(.bss.nmxh); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.alpha */
	"ua_aarch64.o"(.bss.alpha); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dlmin */
	"ua_aarch64.o"(.bss.dlmin); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.dtime */
	"ua_aarch64.o"(.bss.dtime); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.ta1 */
	"ua_aarch64.o"(.bss.ta1); /* size 0x249f00 */
	. = ALIGN(0x4); /* align for .bss.ntot */
	"ua_aarch64.o"(.bss.ntot); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.sje */
	"ua_aarch64.o"(.bss.sje); /* size 0x38400 */
	. = ALIGN(0x4); /* align for .bss.nelt */
	"ua_aarch64.o"(.bss.nelt); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.time */
	"ua_aarch64.o"(.bss.time); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.tmort */
	"ua_aarch64.o"(.bss.tmort); /* size 0xb50e0 */
	. = ALIGN(0x10); /* align for .bss.ta2 */
	"ua_aarch64.o"(.bss.ta2); /* size 0x249f00 */
	. = ALIGN(0x10); /* align for .bss.size_e */
	"ua_aarch64.o"(.bss.size_e); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.trhs */
	"ua_aarch64.o"(.bss.trhs); /* size 0x249f00 */
	. = ALIGN(0x10); /* align for .bss.rmor */
	"ua_aarch64.o"(.bss.rmor); /* size 0xb50e0 */
	. = ALIGN(0x10); /* align for .bss.cbc */
	"ua_aarch64.o"(.bss.cbc); /* size 0xe100 */
	. = ALIGN(0x10); /* align for .bss.tmmor */
	"ua_aarch64.o"(.bss.tmmor); /* size 0xb50e0 */
	. = ALIGN(0x4); /* align for .bss.nmor */
	"ua_aarch64.o"(.bss.nmor); /* size 0x4 */
	. = ALIGN(0x10); /* align for .bss.t */
	"ua_aarch64.o"(.bss.t); /* size 0x249f00 */
	. = ALIGN(0x4); /* align for .bss.nvertex */
	"ua_aarch64.o"(.bss.nvertex); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.x0 */
	"ua_aarch64.o"(.bss.x0); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss._y0 */
	"ua_aarch64.o"(.bss._y0); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.z0 */
	"ua_aarch64.o"(.bss.z0); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.tmult */
	"ua_aarch64.o"(.bss.tmult); /* size 0x249f00 */
	. = ALIGN(0x10); /* align for .bss.dpcelm */
	"ua_aarch64.o"(.bss.dpcelm); /* size 0x249f00 */
	. = ALIGN(0x10); /* align for .bss.pdiff */
	"ua_aarch64.o"(.bss.pdiff); /* size 0x249f00 */
	. = ALIGN(0x10); /* align for .bss.pdiffp */
	"ua_aarch64.o"(.bss.pdiffp); /* size 0x249f00 */
	. = ALIGN(0x10); /* align for .bss.umor */
	"ua_aarch64.o"(.bss.umor); /* size 0xb50e0 */
	. = ALIGN(0x10); /* align for .bss.mormult */
	"ua_aarch64.o"(.bss.mormult); /* size 0xb50e0 */
	. = ALIGN(0x10); /* align for .bss.dpcmor */
	"ua_aarch64.o"(.bss.dpcmor); /* size 0xb50e0 */
	. = ALIGN(0x10); /* align for .bss.pmorx */
	"ua_aarch64.o"(.bss.pmorx); /* size 0xb50e0 */
	. = ALIGN(0x10); /* align for .bss.ppmor */
	"ua_aarch64.o"(.bss.ppmor); /* size 0xb50e0 */
	. = ALIGN(0x10); /* align for .bss.idmo */
	"ua_aarch64.o"(.bss.idmo); /* size 0x57e400 */
	. = ALIGN(0x10); /* align for .bss.idel */
	"ua_aarch64.o"(.bss.idel); /* size 0x15f900 */
	. = ALIGN(0x10); /* align for .bss.sje_new */
	"ua_aarch64.o"(.bss.sje_new); /* size 0x38400 */
	. = ALIGN(0x10); /* align for .bss.ijel */
	"ua_aarch64.o"(.bss.ijel); /* size 0x1c200 */
	. = ALIGN(0x10); /* align for .bss.ijel_new */
	"ua_aarch64.o"(.bss.ijel_new); /* size 0x1c200 */
	. = ALIGN(0x10); /* align for .bss.cbc_new */
	"ua_aarch64.o"(.bss.cbc_new); /* size 0xe100 */
	. = ALIGN(0x10); /* align for .bss.vassign */
	"ua_aarch64.o"(.bss.vassign); /* size 0x12c00 */
	. = ALIGN(0x10); /* align for .bss.emo */
	"ua_aarch64.o"(.bss.emo); /* size 0x12c000 */
	. = ALIGN(0x10); /* align for .bss.nemo */
	"ua_aarch64.o"(.bss.nemo); /* size 0x12c00 */
	. = ALIGN(0x10); /* align for .bss.diagn */
	"ua_aarch64.o"(.bss.diagn); /* size 0x38400 */
	. = ALIGN(0x10); /* align for .bss.tree */
	"ua_aarch64.o"(.bss.tree); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.treenew */
	"ua_aarch64.o"(.bss.treenew); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.mt_to_id */
	"ua_aarch64.o"(.bss.mt_to_id); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.mt_to_id_old */
	"ua_aarch64.o"(.bss.mt_to_id_old); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.id_to_mt */
	"ua_aarch64.o"(.bss.id_to_mt); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.newc */
	"ua_aarch64.o"(.bss.newc); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.newi */
	"ua_aarch64.o"(.bss.newi); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.newe */
	"ua_aarch64.o"(.bss.newe); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.ref_front_id */
	"ua_aarch64.o"(.bss.ref_front_id); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.ich */
	"ua_aarch64.o"(.bss.ich); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.front */
	"ua_aarch64.o"(.bss.front); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.action */
	"ua_aarch64.o"(.bss.action); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.ifpcmor */
	"ua_aarch64.o"(.bss.ifpcmor); /* size 0x12c00 */
	. = ALIGN(0x10); /* align for .bss.eassign */
	"ua_aarch64.o"(.bss.eassign); /* size 0x1c200 */
	. = ALIGN(0x10); /* align for .bss.ncon_edge */
	"ua_aarch64.o"(.bss.ncon_edge); /* size 0x1c200 */
	. = ALIGN(0x10); /* align for .bss.if_1_edge */
	"ua_aarch64.o"(.bss.if_1_edge); /* size 0x1c200 */
	. = ALIGN(0x10); /* align for .bss.skip */
	"ua_aarch64.o"(.bss.skip); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.ifcoa */
	"ua_aarch64.o"(.bss.ifcoa); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.ifcoa_id */
	"ua_aarch64.o"(.bss.ifcoa_id); /* size 0x2580 */
	. = ALIGN(0x10); /* align for .bss.fassign */
	"ua_aarch64.o"(.bss.fassign); /* size 0xe100 */
	. = ALIGN(0x10); /* align for .bss.edgevis */
	"ua_aarch64.o"(.bss.edgevis); /* size 0x38400 */
	. = ALIGN(0x10); /* align for .bss.qbnew */
	"ua_aarch64.o"(.bss.qbnew); /* size 0xf0 */
	. = ALIGN(0x10); /* align for .bss.bqnew */
	"ua_aarch64.o"(.bss.bqnew); /* size 0x90 */
	. = ALIGN(0x10); /* align for .bss.pcmor_nc1 */
	"ua_aarch64.o"(.bss.pcmor_nc1); /* size 0x12c0 */
	. = ALIGN(0x10); /* align for .bss.pcmor_nc2 */
	"ua_aarch64.o"(.bss.pcmor_nc2); /* size 0x12c0 */
	. = ALIGN(0x10); /* align for .bss.pcmor_nc0 */
	"ua_aarch64.o"(.bss.pcmor_nc0); /* size 0x12c0 */
	. = ALIGN(0x10); /* align for .bss.pcmor_c */
	"ua_aarch64.o"(.bss.pcmor_c); /* size 0x4b0 */
	. = ALIGN(0x10); /* align for .bss.tcpre */
	"ua_aarch64.o"(.bss.tcpre); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .bss.pcmor_cor */
	"ua_aarch64.o"(.bss.pcmor_cor); /* size 0x180 */
	. = ALIGN(0x10); /* align for .bss.zgm1 */
	"ua_aarch64.o"(.bss.zgm1); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.wxm1 */
	"ua_aarch64.o"(.bss.wxm1); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.w3m1 */
	"ua_aarch64.o"(.bss.w3m1); /* size 0x3e8 */
	. = ALIGN(0x10); /* align for .bss.xc */
	"ua_aarch64.o"(.bss.xc); /* size 0x25800 */
	. = ALIGN(0x10); /* align for .bss.yc */
	"ua_aarch64.o"(.bss.yc); /* size 0x25800 */
	. = ALIGN(0x10); /* align for .bss.zc */
	"ua_aarch64.o"(.bss.zc); /* size 0x25800 */
	. = ALIGN(0x10); /* align for .bss.xc_new */
	"ua_aarch64.o"(.bss.xc_new); /* size 0x25800 */
	. = ALIGN(0x10); /* align for .bss.yc_new */
	"ua_aarch64.o"(.bss.yc_new); /* size 0x25800 */
	. = ALIGN(0x10); /* align for .bss.zc_new */
	"ua_aarch64.o"(.bss.zc_new); /* size 0x25800 */
	. = ALIGN(0x10); /* align for .bss.jacm1_s */
	"ua_aarch64.o"(.bss.jacm1_s); /* size 0x1770 */
	. = ALIGN(0x10); /* align for .bss.rxm1_s */
	"ua_aarch64.o"(.bss.rxm1_s); /* size 0x1770 */
	. = ALIGN(0x10); /* align for .bss.xrm1_s */
	"ua_aarch64.o"(.bss.xrm1_s); /* size 0x1770 */
	. = ALIGN(0x10); /* align for .bss.bm1_s */
	"ua_aarch64.o"(.bss.bm1_s); /* size 0x1770 */
	. = ALIGN(0x10); /* align for .bss.dxm1 */
	"ua_aarch64.o"(.bss.dxm1); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .bss.dxtm1 */
	"ua_aarch64.o"(.bss.dxtm1); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .bss.wdtdr */
	"ua_aarch64.o"(.bss.wdtdr); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .bss.ixm31 */
	"ua_aarch64.o"(.bss.ixm31); /* size 0x168 */
	. = ALIGN(0x10); /* align for .bss.ixtm31 */
	"ua_aarch64.o"(.bss.ixtm31); /* size 0x168 */
	. = ALIGN(0x10); /* align for .bss.ixmc1 */
	"ua_aarch64.o"(.bss.ixmc1); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .bss.ixtmc1 */
	"ua_aarch64.o"(.bss.ixtmc1); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .bss.ixmc2 */
	"ua_aarch64.o"(.bss.ixmc2); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .bss.ixtmc2 */
	"ua_aarch64.o"(.bss.ixtmc2); /* size 0xc8 */
	. = ALIGN(0x10); /* align for .bss.map2 */
	"ua_aarch64.o"(.bss.map2); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.map4 */
	"ua_aarch64.o"(.bss.map4); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.xfrac */
	"ua_aarch64.o"(.bss.xfrac); /* size 0x28 */
	. = ALIGN(0x10); /* align for .bss.g1m1_s */
	"ua_aarch64.o"(.bss.g1m1_s); /* size 0x1770 */
	. = ALIGN(0x10); /* align for .bss.g4m1_s */
	"ua_aarch64.o"(.bss.g4m1_s); /* size 0x1770 */
	. = ALIGN(0x10); /* align for .bss.g5m1_s */
	"ua_aarch64.o"(.bss.g5m1_s); /* size 0x1770 */
	. = ALIGN(0x10); /* align for .bss.g6m1_s */
	"ua_aarch64.o"(.bss.g6m1_s); /* size 0x1770 */
	. = ALIGN(0x10); /* align for .bss.f_e_ef */
	"ua_aarch64.o"(.bss.f_e_ef); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.e_c */
	"ua_aarch64.o"(.bss.e_c); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.local_corner */
	"ua_aarch64.o"(.bss.local_corner); /* size 0xc0 */
	. = ALIGN(0x10); /* align for .bss.cal_nnb */
	"ua_aarch64.o"(.bss.cal_nnb); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.oplc */
	"ua_aarch64.o"(.bss.oplc); /* size 0x10 */
	. = ALIGN(0x10); /* align for .bss.cal_iijj */
	"ua_aarch64.o"(.bss.cal_iijj); /* size 0x20 */
	. = ALIGN(0x10); /* align for .bss.cal_intempx */
	"ua_aarch64.o"(.bss.cal_intempx); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.c_f */
	"ua_aarch64.o"(.bss.c_f); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.le_arr */
	"ua_aarch64.o"(.bss.le_arr); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.jjface */
	"ua_aarch64.o"(.bss.jjface); /* size 0x18 */
	. = ALIGN(0x10); /* align for .bss.e_face2 */
	"ua_aarch64.o"(.bss.e_face2); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.op */
	"ua_aarch64.o"(.bss.op); /* size 0x10 */
	. = ALIGN(0x10); /* align for .bss.localedgenumber */
	"ua_aarch64.o"(.bss.localedgenumber); /* size 0x120 */
	. = ALIGN(0x10); /* align for .bss.edgenumber */
	"ua_aarch64.o"(.bss.edgenumber); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.f_c */
	"ua_aarch64.o"(.bss.f_c); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.e1v1 */
	"ua_aarch64.o"(.bss.e1v1); /* size 0x90 */
	. = ALIGN(0x10); /* align for .bss.e2v1 */
	"ua_aarch64.o"(.bss.e2v1); /* size 0x90 */
	. = ALIGN(0x10); /* align for .bss.e1v2 */
	"ua_aarch64.o"(.bss.e1v2); /* size 0x90 */
	. = ALIGN(0x10); /* align for .bss.e2v2 */
	"ua_aarch64.o"(.bss.e2v2); /* size 0x90 */
	. = ALIGN(0x10); /* align for .bss.children */
	"ua_aarch64.o"(.bss.children); /* size 0x60 */
	. = ALIGN(0x10); /* align for .bss.iijj */
	"ua_aarch64.o"(.bss.iijj); /* size 0x20 */
	. = ALIGN(0x4); /* align for .bss.v_end */
	"ua_aarch64.o"(.bss.v_end); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.face_l1 */
	"ua_aarch64.o"(.bss.face_l1); /* size 0xc */
	. = ALIGN(0x4); /* align for .bss.face_l2 */
	"ua_aarch64.o"(.bss.face_l2); /* size 0xc */
	. = ALIGN(0x4); /* align for .bss.face_ld */
	"ua_aarch64.o"(.bss.face_ld); /* size 0xc */
