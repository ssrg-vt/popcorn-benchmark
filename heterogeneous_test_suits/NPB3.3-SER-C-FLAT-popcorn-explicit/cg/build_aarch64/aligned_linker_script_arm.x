...
.text	: ALIGN(0x100000)
{
	...
	"cg_aarch64.o"(.text.main); /* size 0xb9c */
	. = . + 0x6b; /* padding after .text.main */
	. = ALIGN(0x10); /* align for .text.makea */
	"cg_aarch64.o"(.text.makea); /* size 0x26c */
	. = . + 0x19; /* padding after .text.makea */
	. = ALIGN(0x10); /* align for .text.conj_grad */
	"cg_aarch64.o"(.text.conj_grad); /* size 0x5e8 */
	. = . + 0xe; /* padding after .text.conj_grad */
	. = ALIGN(0x10); /* align for .text.sprnvc */
	"cg_aarch64.o"(.text.sprnvc); /* size 0x198 */
	. = ALIGN(0x10); /* align for .text.vecset */
	"cg_aarch64.o"(.text.vecset); /* size 0x138 */
	. = ALIGN(0x10); /* align for .text.sparse */
	"cg_aarch64.o"(.text.sparse); /* size 0x87c */
	. = . + 0x30; /* padding after .text.sparse */
	. = ALIGN(0x10); /* align for .text.icnvrt */
	"cg_aarch64.o"(.text.icnvrt); /* size 0x6c */
...
.rodata	: ALIGN(0x100000)
{
	...
	"cg_aarch64.o"(.rodata.cst8); /* size 0x10 */
	. = . + 0x28; /* padding after .rodata.cst8 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_timer_flag */
	"cg_aarch64.o"(.rodata.cg__str_timer_flag); /* size 0xb */
	. = ALIGN(0x4); /* align for .rodata.cg__str_1_r_ */
	"cg_aarch64.o"(.rodata.cg__str_1_r_); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_2_init_ */
	"cg_aarch64.o"(.rodata.cg__str_2_init_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_3_benchmk_ */
	"cg_aarch64.o"(.rodata.cg__str_3_benchmk_); /* size 0x8 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_4_conjgd_ */
	"cg_aarch64.o"(.rodata.cg__str_4_conjgd_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_5____NAS_Par */
	"cg_aarch64.o"(.rodata.cg__str_5____NAS_Par); /* size 0x3b */
	. = ALIGN(0x4); /* align for .rodata.cg__str_6__Size___11 */
	"cg_aarch64.o"(.rodata.cg__str_6__Size___11); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.cg__str_7__Iteration */
	"cg_aarch64.o"(.rodata.cg__str_7__Iteration); /* size 0x12 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_8___ */
	"cg_aarch64.o"(.rodata.cg__str_8___); /* size 0x2 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_9__Initializ */
	"cg_aarch64.o"(.rodata.cg__str_9__Initializ); /* size 0x27 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_10_goin_to_mi */
	"cg_aarch64.o"(.rodata.cg__str_10_goin_to_mi); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_11_____iterat */
	"cg_aarch64.o"(.rodata.cg__str_11_____iterat); /* size 0x34 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_12______5d___ */
	"cg_aarch64.o"(.rodata.cg__str_12______5d___); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.cg__str_13___migrated */
	"cg_aarch64.o"(.rodata.cg__str_13___migrated); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_14__Benchmark */
	"cg_aarch64.o"(.rodata.cg__str_14__Benchmark); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_15__VERIFICAT */
	"cg_aarch64.o"(.rodata.cg__str_15__VERIFICAT); /* size 0x1a */
	. = ALIGN(0x4); /* align for .rodata.cg__str_16__Zeta_is__ */
	"cg_aarch64.o"(.rodata.cg__str_16__Zeta_is__); /* size 0x15 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_17__Error_is_ */
	"cg_aarch64.o"(.rodata.cg__str_17__Error_is_); /* size 0x15 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_18__VERIFICAT */
	"cg_aarch64.o"(.rodata.cg__str_18__VERIFICAT); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_19__Zeta_____ */
	"cg_aarch64.o"(.rodata.cg__str_19__Zeta_____); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.cg__str_20__The_corre */
	"cg_aarch64.o"(.rodata.cg__str_20__The_corre); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.cg__str_21__Problem_s */
	"cg_aarch64.o"(.rodata.cg__str_21__Problem_s); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_22__NO_VERIFI */
	"cg_aarch64.o"(.rodata.cg__str_22__NO_VERIFI); /* size 0x1c */
	. = ALIGN(0x4); /* align for .rodata.cg__str_23_CG_ */
	"cg_aarch64.o"(.rodata.cg__str_23_CG_); /* size 0x3 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_24___________ */
	"cg_aarch64.o"(.rodata.cg__str_24___________); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_25_3_3_1_ */
	"cg_aarch64.o"(.rodata.cg__str_25_3_3_1_); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_26_03_Nov_201 */
	"cg_aarch64.o"(.rodata.cg__str_26_03_Nov_201); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.cg__str_27_gcc_ */
	"cg_aarch64.o"(.rodata.cg__str_27_gcc_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_28___CC__ */
	"cg_aarch64.o"(.rodata.cg__str_28___CC__); /* size 0x6 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_29__lm_ */
	"cg_aarch64.o"(.rodata.cg__str_29__lm_); /* size 0x4 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_30__I___commo */
	"cg_aarch64.o"(.rodata.cg__str_30__I___commo); /* size 0xc */
	. = ALIGN(0x4); /* align for .rodata.cg__str_31__g__Wall__ */
	"cg_aarch64.o"(.rodata.cg__str_31__g__Wall__); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.cg__str_32__O3__mcmod */
	"cg_aarch64.o"(.rodata.cg__str_32__O3__mcmod); /* size 0x14 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_33_randdp_ */
	"cg_aarch64.o"(.rodata.cg__str_33_randdp_); /* size 0x7 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_34___SECTION_ */
	"cg_aarch64.o"(.rodata.cg__str_34___SECTION_); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_35____8s__9_3 */
	"cg_aarch64.o"(.rodata.cg__str_35____8s__9_3); /* size 0xd */
	. = ALIGN(0x4); /* align for .rodata.cg__str_36____8s__9_3 */
	"cg_aarch64.o"(.rodata.cg__str_36____8s__9_3); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_37__________8 */
	"cg_aarch64.o"(.rodata.cg__str_37__________8); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.cg__str_38_rest_ */
	"cg_aarch64.o"(.rodata.cg__str_38_rest_); /* size 0x5 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_39_Space_for_ */
	"cg_aarch64.o"(.rodata.cg__str_39_Space_for_); /* size 0x2e */
	. = ALIGN(0x4); /* align for .rodata.cg__str_40_nza__nzmax */
	"cg_aarch64.o"(.rodata.cg__str_40_nza__nzmax); /* size 0x15 */
	. = ALIGN(0x4); /* align for .rodata.cg__str_41_internal_e */
	"cg_aarch64.o"(.rodata.cg__str_41_internal_e); /* size 0x20 */
...
.bss	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x4); /* align for .bss.cg_c_timeron */
	"cg_aarch64.o"(.bss.cg_c_timeron); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.cg_c_firstrow */
	"cg_aarch64.o"(.bss.cg_c_firstrow); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.cg_c_lastrow */
	"cg_aarch64.o"(.bss.cg_c_lastrow); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.cg_c_firstcol */
	"cg_aarch64.o"(.bss.cg_c_firstcol); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.cg_c_lastcol */
	"cg_aarch64.o"(.bss.cg_c_lastcol); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.cg_c_naa */
	"cg_aarch64.o"(.bss.cg_c_naa); /* size 0x4 */
	. = ALIGN(0x4); /* align for .bss.cg_c_nzz */
	"cg_aarch64.o"(.bss.cg_c_nzz); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.cg_c_tran */
	"cg_aarch64.o"(.bss.cg_c_tran); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.cg_c_amult */
	"cg_aarch64.o"(.bss.cg_c_amult); /* size 0x8 */
	. = ALIGN(0x10); /* align for .bss.cg_c_a */
	"cg_aarch64.o"(.bss.cg_c_a); /* size 0xf61800 */
	. = ALIGN(0x10); /* align for .bss.cg_c_colidx */
	"cg_aarch64.o"(.bss.cg_c_colidx); /* size 0x7b0c00 */
	. = ALIGN(0x10); /* align for .bss.cg_c_rowstr */
	"cg_aarch64.o"(.bss.cg_c_rowstr); /* size 0xdac4 */
	. = ALIGN(0x10); /* align for .bss.cg_c_arow */
	"cg_aarch64.o"(.bss.cg_c_arow); /* size 0xdac0 */
	. = ALIGN(0x10); /* align for .bss.cg_c_acol */
	"cg_aarch64.o"(.bss.cg_c_acol); /* size 0xa4100 */
	. = ALIGN(0x10); /* align for .bss.cg_c_aelt */
	"cg_aarch64.o"(.bss.cg_c_aelt); /* size 0x148200 */
	. = ALIGN(0x10); /* align for .bss.cg_c_iv */
	"cg_aarch64.o"(.bss.cg_c_iv); /* size 0xdac0 */
	. = ALIGN(0x10); /* align for .bss.cg_c_x */
	"cg_aarch64.o"(.bss.cg_c_x); /* size 0x1b590 */
	. = ALIGN(0x10); /* align for .bss.cg_c_q */
	"cg_aarch64.o"(.bss.cg_c_q); /* size 0x1b590 */
	. = ALIGN(0x10); /* align for .bss.cg_c_z */
	"cg_aarch64.o"(.bss.cg_c_z); /* size 0x1b590 */
	. = ALIGN(0x10); /* align for .bss.cg_c_r */
	"cg_aarch64.o"(.bss.cg_c_r); /* size 0x1b590 */
	. = ALIGN(0x10); /* align for .bss.cg_c_p */
	"cg_aarch64.o"(.bss.cg_c_p); /* size 0x1b590 */
