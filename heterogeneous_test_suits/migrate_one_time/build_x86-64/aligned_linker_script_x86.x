...
.text	: ALIGN(0x100000)
{
	...
	"migrate_x86_64.o"(.text.main); /* size 0x76 */
...
.rodata	: ALIGN(0x100000)
{
	...
	"migrate_x86_64.o"(.rodata.migrate__str__test1__mi); /* size 0x31 */
	. = ALIGN(0x4); /* align for .rodata.migrate__str_1__test1__Mi */
	"migrate_x86_64.o"(.rodata.migrate__str_1__test1__Mi); /* size 0x25 */
