...
.text	: ALIGN(0x100000)
{
	...
	"migrate_aarch64.o"(.text.func2); /* size 0x84 */
	. = ALIGN(0x10); /* align for .text.func1 */
	"migrate_aarch64.o"(.text.func1); /* size 0x90 */
	. = ALIGN(0x10); /* align for .text.main */
	"migrate_aarch64.o"(.text.main); /* size 0x134 */
...
.rodata	: ALIGN(0x100000)
{
	...
	"migrate_aarch64.o"(.rodata.migrate__str__test1__mi); /* size 0x1b */
	. = ALIGN(0x4); /* align for .rodata.migrate__str_1__test1__Do */
	"migrate_aarch64.o"(.rodata.migrate__str_1__test1__Do); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.migrate__str_2__test2__Th */
	"migrate_aarch64.o"(.rodata.migrate__str_2__test2__Th); /* size 0x68 */
	. = ALIGN(0x4); /* align for .rodata.migrate__str_3__test2__Mi */
	"migrate_aarch64.o"(.rodata.migrate__str_3__test2__Mi); /* size 0x41 */
...
.bss	: ALIGN(0x100000)
{
	...
	"migrate_aarch64.o"(.bss.ret); /* size 0x8 */
	. = ALIGN(0x4); /* align for .bss.tid_main */
	"migrate_aarch64.o"(.bss.tid_main); /* size 0x4 */
