...
.text	: ALIGN(0x100000)
{
	...
	. = ALIGN(0x10); /* align for .text.stopwatch_elapsed */
	"kmeans_x86_64.o"(.text.stopwatch_elapsed); /* size 0x7c */
	. = . + 0x24; /* padding after .text.stopwatch_elapsed */
	. = ALIGN(0x10); /* align for .text.dump_points */
	"kmeans_x86_64.o"(.text.dump_points); /* size 0x9b */
	. = . + 0x11; /* padding after .text.dump_points */
	. = ALIGN(0x10); /* align for .text.parse_args */
	"kmeans_x86_64.o"(.text.parse_args); /* size 0x2cc */
	. = ALIGN(0x10); /* align for .text.generate_points */
	"kmeans_x86_64.o"(.text.generate_points); /* size 0xc4 */
	. = . + 0x20; /* padding after .text.generate_points */
	. = ALIGN(0x10); /* align for .text.add_to_sum */
	"kmeans_x86_64.o"(.text.add_to_sum); /* size 0x80 */
	. = . + 0x1c; /* padding after .text.add_to_sum */
	. = ALIGN(0x10); /* align for .text.find_clusters */
	"kmeans_x86_64.o"(.text.find_clusters); /* size 0x17d */
	. = . + 0x37; /* padding after .text.find_clusters */
	. = ALIGN(0x10); /* align for .text.get_sq_dist */
	"kmeans_x86_64.o"(.text.get_sq_dist); /* size 0x94 */
	. = . + 0x20; /* padding after .text.get_sq_dist */
	. = ALIGN(0x10); /* align for .text.calc_means */
	"kmeans_x86_64.o"(.text.calc_means); /* size 0x18f */
	. = . + 0x25; /* padding after .text.calc_means */
	. = ALIGN(0x10); /* align for .text.main */
	"kmeans_x86_64.o"(.text.main); /* size 0x4a0 */
	. = . + 0x3c; /* padding after .text.main */
	. = ALIGN(0x10); /* align for .text.thread_loop */
	"kmeans_x86_64.o"(.text.thread_loop); /* size 0x105 */
	. = . + 0x33; /* padding after .text.thread_loop */
	...
	. = ALIGN(0x4); /* align for .text.__getopt_msg */
	"/usr/local/popcorn/x86_64/lib/libc.a:getopt.o"(.text.__getopt_msg); /* size 0x91 */
	. = . + 0x1b; /* padding after .text.__getopt_msg */
	. = ALIGN(0x4); /* align for .text.getopt */
	"/usr/local/popcorn/x86_64/lib/libc.a:getopt.o"(.text.getopt); /* size 0x271 */
	. = . + 0x4b; /* padding after .text.getopt */
	...
	"/usr/local/popcorn/x86_64/lib/libc.a:mbtowc.o"(.text.mbtowc); /* size 0x109 */
	. = . + 0x33; /* padding after .text.mbtowc */
	. = ALIGN(0x4); /* align for .text.srand */
	"/usr/local/popcorn/x86_64/lib/libc.a:rand.o"(.text.srand); /* size 0xa */
	. = . + 0x6; /* padding after .text.srand */
	. = ALIGN(0x4); /* align for .text.rand */
	"/usr/local/popcorn/x86_64/lib/libc.a:rand.o"(.text.rand); /* size 0x21 */
	. = . + 0xb; /* padding after .text.rand */
	. = ALIGN(0x4); /* align for .text.flockfile */
	"/usr/local/popcorn/x86_64/lib/libc.a:flockfile.o"(.text.flockfile); /* size 0x47 */
	. = . + 0x11; /* padding after .text.flockfile */
	. = ALIGN(0x4); /* align for .text.fprintf */
	"/usr/local/popcorn/x86_64/lib/libc.a:fprintf.o"(.text.fprintf); /* size 0x81 */
	. = ALIGN(0x4); /* align for .text.fputs */
	"/usr/local/popcorn/x86_64/lib/libc.a:fputs.o"(.text.fputs); /* size 0x38 */
	. = . + 0x14; /* padding after .text.fputs */
	. = ALIGN(0x4); /* align for .text.__do_orphaned_stdio_locks */
	"/usr/local/popcorn/x86_64/lib/libc.a:ftrylockfile.o"(.text.__do_orphaned_stdio_locks); /* size 0x32 */
	. = ALIGN(0x4); /* align for .text.__unlist_locked_file */
	"/usr/local/popcorn/x86_64/lib/libc.a:ftrylockfile.o"(.text.__unlist_locked_file); /* size 0x4d */
	. = ALIGN(0x4); /* align for .text.ftrylockfile */
	"/usr/local/popcorn/x86_64/lib/libc.a:ftrylockfile.o"(.text.ftrylockfile); /* size 0xa8 */
	. = ALIGN(0x4); /* align for .text.funlockfile */
	"/usr/local/popcorn/x86_64/lib/libc.a:funlockfile.o"(.text.funlockfile); /* size 0x3f */
	. = . + 0x9; /* padding after .text.funlockfile */
	...
	. = ALIGN(0x4); /* align for .text.putc */
	"/usr/local/popcorn/x86_64/lib/libc.a:putc.o"(.text.putc); /* size 0x9c */
	. = . + 0x38; /* padding after .text.putc */
	...
	. = ALIGN(0x4); /* align for .text.pthread_attr_init */
	"/usr/local/popcorn/x86_64/lib/libc.a:pthread_attr_init.o"(.text.pthread_attr_init); /* size 0x4b */
	. = ALIGN(0x4); /* align for .text.pthread_attr_setscope */
	"/usr/local/popcorn/x86_64/lib/libc.a:pthread_attr_setscope.o"(.text.pthread_attr_setscope); /* size 0x16 */
	. = . + 0x6; /* padding after .text.pthread_attr_setscope */
	. = ALIGN(0x4); /* align for .text.pthread_barrier_init */
	"/usr/local/popcorn/x86_64/lib/libc.a:pthread_barrier_init.o"(.text.pthread_barrier_init); /* size 0x58 */
	. = . + 0x20; /* padding after .text.pthread_barrier_init */
	. = ALIGN(0x4); /* align for .text.pthread_barrier_wait */
	"/usr/local/popcorn/x86_64/lib/libc.a:pthread_barrier_wait.o"(.text.pthread_barrier_wait); /* size 0x468 */
	. = . + 0x6c; /* padding after .text.pthread_barrier_wait */
	...
	. = ALIGN(0x4); /* align for .text.__cleartid_exit_nostack */
...
.rodata	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_d_c_p_s_n_ */
	"kmeans_x86_64.o"(.rodata.kmeans__str_d_c_p_s_n_); /* size 0xf */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_1_Usage___s_ */
	"kmeans_x86_64.o"(.rodata.kmeans__str_1_Usage___s_); /* size 0x77 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_2_Illegal_ar */
	"kmeans_x86_64.o"(.rodata.kmeans__str_2_Illegal_ar); /* size 0x47 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_3_Dimension_ */
	"kmeans_x86_64.o"(.rodata.kmeans__str_3_Dimension_); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_4_Number_of_ */
	"kmeans_x86_64.o"(.rodata.kmeans__str_4_Number_of_); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_5_Number_of_ */
	"kmeans_x86_64.o"(.rodata.kmeans__str_5_Number_of_); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_6_Size_of_ea */
	"kmeans_x86_64.o"(.rodata.kmeans__str_6_Size_of_ea); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_7_Number_of_ */
	"kmeans_x86_64.o"(.rodata.kmeans__str_7_Number_of_); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_8_Threads_pe */
	"kmeans_x86_64.o"(.rodata.kmeans__str_8_Threads_pe); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_9_Starting_i */
	"kmeans_x86_64.o"(.rodata.kmeans__str_9_Starting_i); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_10_kmeans__Co */
	"kmeans_x86_64.o"(.rodata.kmeans__str_10_kmeans__Co); /* size 0x1a */
	...
	. = ALIGN(0x4); /* align for .rodata.src_misc_getopt__str___unrecogn */
	"/usr/local/popcorn/x86_64/lib/libc.a:getopt.o"(.rodata.src_misc_getopt__str___unrecogn); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.src_misc_getopt__str_1___option_r */
	"/usr/local/popcorn/x86_64/lib/libc.a:getopt.o"(.rodata.src_misc_getopt__str_1___option_r); /* size 0x20 */
	...
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"/usr/local/popcorn/x86_64/lib/libc.a:pthread_attr_init.o"(.rodata.cst16); /* size 0x10 */
	...
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"/usr/local/popcorn/x86_64/lib/libc.a:__timedwait.o"(.rodata.cst16); /* size 0x10 */
	...
	"kmeans_x86_64.o"(.rodata.cst8); /* size 0x8 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	...
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:floatscan.o"(.rodata.cst8); /* size 0x28 */
	. = ALIGN(0x8); /* align for .rodata.cst8 */
	"/usr/local/popcorn/x86_64/lib/libc.a:scalbn.o"(.rodata.cst8); /* size 0x10 */
	. = . + 0xd8; /* padding after .rodata.parse_args */
...
.data	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x4); /* align for .data.num_points */
	"kmeans_x86_64.o"(.data.num_points); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.num_means */
	"kmeans_x86_64.o"(.data.num_means); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.dim */
	"kmeans_x86_64.o"(.data.dim); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.grid_size */
	"kmeans_x86_64.o"(.data.grid_size); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.num_nodes */
	"kmeans_x86_64.o"(.data.num_nodes); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.threads_per_node */
	"kmeans_x86_64.o"(.data.threads_per_node); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.modified */
	"kmeans_x86_64.o"(.data.modified); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.optind */
	"/usr/local/popcorn/x86_64/lib/libc.a:getopt.o"(.data.optind); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.opterr */
	"/usr/local/popcorn/x86_64/lib/libc.a:getopt.o"(.data.opterr); /* size 0x4 */
...
.bss	: ALIGN(0x100000)
{
	. = . + 1;
	. = ALIGN(0x1000);
	. = ALIGN(0x8); /* align for .bss.points */
	"kmeans_x86_64.o"(.bss.points); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.means */
	"kmeans_x86_64.o"(.bss.means); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.clusters */
	"kmeans_x86_64.o"(.bss.clusters); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.barr */
	"kmeans_x86_64.o"(.bss.barr); /* size 0x20 */
	...
	. = ALIGN(0x4); /* align for .bss.__optreset */
	"/usr/local/popcorn/x86_64/lib/libc.a:getopt.o"(.bss.__optreset); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.src_prng_rand_c_seed */
	"/usr/local/popcorn/x86_64/lib/libc.a:rand.o"(.bss.src_prng_rand_c_seed); /* size 0x8 */
