...
.text	: ALIGN(0x100000)
{
	...
	"kmeans_aarch64.o"(.text.stopwatch_elapsed); /* size 0xa0 */
	. = ALIGN(0x10); /* align for .text.dump_points */
	"kmeans_aarch64.o"(.text.dump_points); /* size 0xac */
	. = ALIGN(0x10); /* align for .text.parse_args */
	"kmeans_aarch64.o"(.text.parse_args); /* size 0x2b0 */
	. = . + 0x1c; /* padding after .text.parse_args */
	. = ALIGN(0x10); /* align for .text.generate_points */
	"kmeans_aarch64.o"(.text.generate_points); /* size 0xe4 */
	. = ALIGN(0x10); /* align for .text.add_to_sum */
	"kmeans_aarch64.o"(.text.add_to_sum); /* size 0x9c */
	. = ALIGN(0x10); /* align for .text.find_clusters */
	"kmeans_aarch64.o"(.text.find_clusters); /* size 0x1b4 */
	. = ALIGN(0x10); /* align for .text.get_sq_dist */
	"kmeans_aarch64.o"(.text.get_sq_dist); /* size 0xb4 */
	. = ALIGN(0x10); /* align for .text.calc_means */
	"kmeans_aarch64.o"(.text.calc_means); /* size 0x1b4 */
	. = ALIGN(0x10); /* align for .text.main */
	"kmeans_aarch64.o"(.text.main); /* size 0x4dc */
	. = ALIGN(0x10); /* align for .text.thread_loop */
	"kmeans_aarch64.o"(.text.thread_loop); /* size 0x138 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:getopt.o"(.text.__getopt_msg); /* size 0xac */
	. = ALIGN(0x4); /* align for .text.getopt */
	"/usr/local/popcorn/aarch64/lib/libc.a:getopt.o"(.text.getopt); /* size 0x2bc */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:mbtowc.o"(.text.mbtowc); /* size 0x13c */
	. = ALIGN(0x4); /* align for .text.srand */
	"/usr/local/popcorn/aarch64/lib/libc.a:rand.o"(.text.srand); /* size 0x10 */
	. = ALIGN(0x4); /* align for .text.rand */
	"/usr/local/popcorn/aarch64/lib/libc.a:rand.o"(.text.rand); /* size 0x2c */
	. = ALIGN(0x4); /* align for .text.flockfile */
	"/usr/local/popcorn/aarch64/lib/libc.a:flockfile.o"(.text.flockfile); /* size 0x58 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:fputs.o"(.text.fputs); /* size 0x4c */
	. = ALIGN(0x4); /* align for .text.__do_orphaned_stdio_locks */
	"/usr/local/popcorn/aarch64/lib/libc.a:ftrylockfile.o"(.text.__do_orphaned_stdio_locks); /* size 0x28 */
	. = . + 0xa; /* padding after .text.__do_orphaned_stdio_locks */
	. = ALIGN(0x4); /* align for .text.__unlist_locked_file */
	"/usr/local/popcorn/aarch64/lib/libc.a:ftrylockfile.o"(.text.__unlist_locked_file); /* size 0x38 */
	. = . + 0x15; /* padding after .text.__unlist_locked_file */
	. = ALIGN(0x4); /* align for .text.ftrylockfile */
	"/usr/local/popcorn/aarch64/lib/libc.a:ftrylockfile.o"(.text.ftrylockfile); /* size 0x98 */
	. = . + 0x10; /* padding after .text.ftrylockfile */
	. = ALIGN(0x4); /* align for .text.funlockfile */
	"/usr/local/popcorn/aarch64/lib/libc.a:funlockfile.o"(.text.funlockfile); /* size 0x48 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:putc.o"(.text.putc); /* size 0xd4 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:pthread_attr_init.o"(.text.pthread_attr_init); /* size 0x48 */
	. = . + 0x3; /* padding after .text.pthread_attr_init */
	. = ALIGN(0x4); /* align for .text.pthread_attr_setscope */
	"/usr/local/popcorn/aarch64/lib/libc.a:pthread_attr_setscope.o"(.text.pthread_attr_setscope); /* size 0x1c */
	. = ALIGN(0x4); /* align for .text.pthread_barrier_init */
	"/usr/local/popcorn/aarch64/lib/libc.a:pthread_barrier_init.o"(.text.pthread_barrier_init); /* size 0x78 */
	. = ALIGN(0x4); /* align for .text.pthread_barrier_wait */
	"/usr/local/popcorn/aarch64/lib/libc.a:pthread_barrier_wait.o"(.text.pthread_barrier_wait); /* size 0x4d4 */
	...
	. = . + 0xf; /* padding before .text.alloc_rev */
...
.rodata	: ALIGN(0x100000)
{
	...
	"kmeans_aarch64.o"(.rodata.kmeans__str_d_c_p_s_n_); /* size 0xf */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_1_Usage___s_ */
	"kmeans_aarch64.o"(.rodata.kmeans__str_1_Usage___s_); /* size 0x77 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_2_Illegal_ar */
	"kmeans_aarch64.o"(.rodata.kmeans__str_2_Illegal_ar); /* size 0x47 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_3_Dimension_ */
	"kmeans_aarch64.o"(.rodata.kmeans__str_3_Dimension_); /* size 0x10 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_4_Number_of_ */
	"kmeans_aarch64.o"(.rodata.kmeans__str_4_Number_of_); /* size 0x19 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_5_Number_of_ */
	"kmeans_aarch64.o"(.rodata.kmeans__str_5_Number_of_); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_6_Size_of_ea */
	"kmeans_aarch64.o"(.rodata.kmeans__str_6_Size_of_ea); /* size 0x1d */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_7_Number_of_ */
	"kmeans_aarch64.o"(.rodata.kmeans__str_7_Number_of_); /* size 0x16 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_8_Threads_pe */
	"kmeans_aarch64.o"(.rodata.kmeans__str_8_Threads_pe); /* size 0x17 */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_9_Starting_i */
	"kmeans_aarch64.o"(.rodata.kmeans__str_9_Starting_i); /* size 0x1e */
	. = ALIGN(0x4); /* align for .rodata.kmeans__str_10_kmeans__Co */
	"kmeans_aarch64.o"(.rodata.kmeans__str_10_kmeans__Co); /* size 0x1a */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:getopt.o"(.rodata.src_misc_getopt__str___unrecogn); /* size 0x18 */
	. = ALIGN(0x4); /* align for .rodata.src_misc_getopt__str_1___option_r */
	"/usr/local/popcorn/aarch64/lib/libc.a:getopt.o"(.rodata.src_misc_getopt__str_1___option_r); /* size 0x20 */
	...
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"/usr/local/popcorn/aarch64/lib/libc.a:pthread_attr_init.o"(.rodata.cst16); /* size 0x10 */
	...
	. = ALIGN(0x10); /* align for .rodata.cst16 */
	"/usr/local/popcorn/aarch64/lib/libc.a:__timedwait.o"(.rodata.cst16); /* size 0x10 */
	...
	. = ALIGN(0x4); /* align for .rodata.parse_args */
	"kmeans_aarch64.o"(.rodata.parse_args); /* size 0xd8 */
	. = ALIGN(0x10); /* align for .rodata.cst16 */
...
.data	: ALIGN(0x100000)
{
	...
	"kmeans_aarch64.o"(.data.num_points); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.num_means */
	"kmeans_aarch64.o"(.data.num_means); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.dim */
	"kmeans_aarch64.o"(.data.dim); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.grid_size */
	"kmeans_aarch64.o"(.data.grid_size); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.num_nodes */
	"kmeans_aarch64.o"(.data.num_nodes); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.threads_per_node */
	"kmeans_aarch64.o"(.data.threads_per_node); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.modified */
	"kmeans_aarch64.o"(.data.modified); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.optind */
	"/usr/local/popcorn/aarch64/lib/libc.a:getopt.o"(.data.optind); /* size 0x4 */
	. = ALIGN(0x4); /* align for .data.opterr */
	"/usr/local/popcorn/aarch64/lib/libc.a:getopt.o"(.data.opterr); /* size 0x4 */
...
.bss	: ALIGN(0x100000)
{
	...
	"kmeans_aarch64.o"(.bss.points); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.means */
	"kmeans_aarch64.o"(.bss.means); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.clusters */
	"kmeans_aarch64.o"(.bss.clusters); /* size 0x8 */
	. = ALIGN(0x8); /* align for .bss.barr */
	"kmeans_aarch64.o"(.bss.barr); /* size 0x20 */
	...
	"/usr/local/popcorn/aarch64/lib/libc.a:getopt.o"(.bss.__optreset); /* size 0x4 */
	. = ALIGN(0x8); /* align for .bss.src_prng_rand_c_seed */
	"/usr/local/popcorn/aarch64/lib/libc.a:rand.o"(.bss.src_prng_rand_c_seed); /* size 0x8 */
